...
namespace Allors
{
    ...
    public class Extent<T> : IList, IList<T> where T : IObject // Extent<T> must also implement IList to be a DataSource during DataBinding.
    {
        ...
        /// The extent.
        /// </param>
        private Extent(Extent extent) => this.extent = extent;
        ...
        /// </returns>
        public int Count => this.extent.Count;

        /// <summary>
        /// Gets the non generic extent.
        /// </summary>
        /// <value>The non generic extent.</value>
        public Extent BaseExtent => this.extent;
        ...
        public ICompositePredicate Filter => this.extent.Filter;
        ...
        public T First => (T)this.extent.First;
        ...
        public bool IsFixedSize => this.extent.IsFixedSize;
        ...
        /// </returns>
        public bool IsReadOnly => this.extent.IsReadOnly;
        ...
        public bool IsSynchronized => this.extent.IsSynchronized;

        /// <summary>
        /// Gets the type.
        /// </summary>
        /// <value>The type of the Extent.</value>
        public IObjectType ObjectType => this.extent.ObjectType;
        ...
        public object SyncRoot => this.extent.SyncRoot;
        ...
        public int Add(object value) => this.extent.Add(value);
        ...
        public void Add(T item) => this.extent.Add(item);
        ...
        /// </summary>
        /// <exception cref="T:System.NotSupportedException">The <see cref="T:System.Collections.Generic.ICollection`1"></see> is read-only. </exception>
        public void Clear() => this.extent.Clear();
        ...
        /// </returns>
        public bool Contains(object value) => this.extent.Contains(value);
        ...
        public bool Contains(T item) => this.extent.Contains(item);
        ...
        public void CopyTo(Array array, int index) => this.extent.CopyTo(array, index);
        ...
        public void CopyTo(T[] array, int arrayIndex) => this.extent.CopyTo(array, arrayIndex);
        ...
        public IEnumerator GetEnumerator() => this.extent.GetEnumerator();
        ...
        /// </returns>
        public int IndexOf(object value) => this.extent.IndexOf(value);
        ...
        public int IndexOf(T item) => this.extent.IndexOf(item);
        ...
        public void Insert(int index, object value) => this.extent.Insert(index, value);
        ...
        /// <exception cref="T:System.ArgumentOutOfRangeException">index is not a valid index in the <see cref="T:System.Collections.Generic.IList`1"></see>.</exception>
        public void Insert(int index, T item) => this.extent.Insert(index, item);
        ...
        /// <exception cref="T:System.NotSupportedException">The <see cref="T:System.Collections.IList"/> is read-only.-or- The <see cref="T:System.Collections.IList"/> has a fixed size. </exception>
        public void Remove(object value) => this.extent.Remove(value);
        ...
        /// <exception cref="T:System.NotSupportedException">The <see cref="T:System.Collections.Generic.IList`1"></see> is read-only.</exception>
        /// <exception cref="T:System.ArgumentOutOfRangeException">index is not a valid index in the <see cref="T:System.Collections.Generic.IList`1"></see>.</exception>
        public void RemoveAt(int index) => this.extent.RemoveAt(index);
        ...
        /// <returns>The array.</returns>
        public IObject[] ToArray(Type type) => this.extent.ToArray(type);
