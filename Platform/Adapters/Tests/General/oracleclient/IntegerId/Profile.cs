...
namespace Tests.Repositories.General.OracleClient.Connected.IntegerId
{
    ...
    public class Profile : General.Profile
    {
        ...
        {
            this.repository = AllorsConfiguration.CreateRepository("OracleClientIntegerId");
            this.repository.Init();

            this.population2 = AllorsConfiguration.CreateRepository("OracleClientIntegerId2");
