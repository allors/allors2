...
namespace Tests.Repositories.General.MySqlClient.Connected.LongId
{
    ...
    public class Profile : General.Profile
    {
        ...
        {
            this.repository = AllorsConfiguration.CreateRepository("MySqlClientLongId");
            this.repository.Init();

            this.population2 = AllorsConfiguration.CreateRepository("MySqlClientLongId2");
