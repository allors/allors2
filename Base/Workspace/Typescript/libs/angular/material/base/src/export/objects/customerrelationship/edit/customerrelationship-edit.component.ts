...
import { Organisation, Good, Part, PriceComponent, InternalOrganisation, NonUnifiedGood, Catalogue, Singleton, ProductCategory, CatScope, CustomerRelationship, Party } from '@allors/domain/generated';
