...
import { WorkTaskOverviewSummaryComponent } from './worktask-overview-summary.component';
export { WorkTaskOverviewSummaryComponent } from './worktask-overview-summary.component';
...
export class WorkTaskOverviewSummaryModule { }
