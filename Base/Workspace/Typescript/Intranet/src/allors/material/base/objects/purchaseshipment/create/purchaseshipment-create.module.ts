...
import { PurchaseShipmentCreateComponent } from './purchaseshipment-create.component';
export { PurchaseShipmentCreateComponent } from './purchaseshipment-create.component';
...
export class PurchaseShipmentCreateModule { }
