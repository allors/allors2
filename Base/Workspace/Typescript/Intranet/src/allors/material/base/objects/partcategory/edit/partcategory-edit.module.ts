...
import { PartCategoryEditComponent } from './partcategory-edit.component';
export { PartCategoryEditComponent } from './partcategory-edit.component';
...
export class PartCategoryEditModule { }
