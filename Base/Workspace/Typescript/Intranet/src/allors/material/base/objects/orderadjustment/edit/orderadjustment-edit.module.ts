...
import { OrderAdjustmentEditComponent } from './orderadjustment-edit.component';
export { OrderAdjustmentEditComponent } from './orderadjustment-edit.component';
...
export class OrderAdjustmentEditModule { }
