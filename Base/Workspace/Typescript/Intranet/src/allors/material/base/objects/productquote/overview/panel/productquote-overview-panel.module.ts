...
import { ProductQuoteOverviewPanelComponent } from './productquote-overview-panel.component';
export { ProductQuoteOverviewPanelComponent } from './productquote-overview-panel.component';
...
export class ProductQuoteOverviewPanelModule { }
