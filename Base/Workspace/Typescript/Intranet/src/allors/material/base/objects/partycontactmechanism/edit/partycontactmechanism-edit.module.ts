...
import { PartyContactmechanismEditComponent } from './partycontactmechanism-edit.component';
export { PartyContactmechanismEditComponent } from './partycontactmechanism-edit.component';
...
export class PartyContactmechanismEditModule { }
