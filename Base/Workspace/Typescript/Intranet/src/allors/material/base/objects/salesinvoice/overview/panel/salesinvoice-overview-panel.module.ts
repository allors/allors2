...
import { SalesInvoiceOverviewPanelComponent } from './salesinvoice-overview-panel.component';
export { SalesInvoiceOverviewPanelComponent } from './salesinvoice-overview-panel.component';
...
export class SalesInvoiceOverviewPanelModule { }
