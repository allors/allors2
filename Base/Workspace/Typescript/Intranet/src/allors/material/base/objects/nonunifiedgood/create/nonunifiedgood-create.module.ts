...
import { NonUnifiedGoodCreateComponent } from './nonunifiedgood-create.component';
export { NonUnifiedGoodCreateComponent } from './nonunifiedgood-create.component';
...
export class NonUnifiedGoodCreateModule { }
