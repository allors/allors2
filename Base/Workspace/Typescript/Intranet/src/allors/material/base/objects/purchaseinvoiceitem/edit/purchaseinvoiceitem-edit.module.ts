...
import { PurchaseInvoiceItemEditComponent } from './purchaseinvoiceitem-edit.component';
export { PurchaseInvoiceItemEditComponent } from './purchaseinvoiceitem-edit.component';
...
export class PurchaseInvoiceItemEditModule { }
