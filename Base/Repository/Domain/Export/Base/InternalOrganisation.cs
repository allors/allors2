...
namespace Allors.Repository
{
    ...
    public partial interface InternalOrganisation : Party
    {
        ...
        [AssociationId("DDEE0080-B59E-43DC-BE07-B1CD68309154")]
        [RoleId("23A46D4B-45DB-4927-892A-0BD2FB59AE43")]
        [Indexed]
        #endregion
        [Multiplicity(Multiplicity.ManyToMany)]
        [Workspace]
        ...
        [AssociationId("F6209FD5-10BB-471E-8931-130A96D9A376")]
        [RoleId("897C3802-02DF-4FB4-BB7C-CE16BDB99160")]
        #endregion
        [Multiplicity(Multiplicity.OneToOne)]
        [Indexed]
        [Derived]
        ...
        [AssociationId("4C50A467-CDD9-4413-9A08-2006DE37C88F")]
        [RoleId("7C33AC4F-3B27-440E-AD5B-75E88E9262C7")]
        #endregion
        [Multiplicity(Multiplicity.OneToOne)]
        [Indexed]
        [Derived]
        ...
        [AssociationId("E8CBBA20-3BEE-4058-A5D0-441F15617D8E")]
        [RoleId("8596BE47-1203-4E5A-8777-9D107B3CDA6C")]
        #endregion
        [Multiplicity(Multiplicity.OneToOne)]
        [Derived]
        [Indexed]
        ...
        [AssociationId("07082144-6C1D-41D5-B857-C6959FCB2E38")]
        [RoleId("196DD6E5-0CF4-40CB-B80A-A7F513CEB88C")]
        [Indexed]
        #endregion
        [Multiplicity(Multiplicity.ManyToMany)]
        [Workspace]
        ...
        [AssociationId("F59FB11B-5647-4D5E-995F-C76A5AA85144")]
        [RoleId("7B38F58F-BAB4-4C4A-B0B1-B242834CA7F9")]
        #endregion
        [Multiplicity(Multiplicity.OneToOne)]
        [Indexed]
        [Derived]
        ...
        [AssociationId("B04A2937-5BC4-41C2-A8B0-D65F17888235")]
        [RoleId("A81909A8-7088-4112-9537-1C6D764C327F")]
        #endregion
        [Multiplicity(Multiplicity.OneToOne)]
        [Indexed]
        [Derived]
        AccessControl PurchaseInvoiceApproverAccessControl { get; set; }

        #region Allors
        [Id("A86793A1-4607-451F-B9D3-61287A7341CB")]
        [AssociationId("BA20137C-DBD5-4AD1-8224-B4440D94319B")]
        [RoleId("B8BB7A3E-981C-4C9A-AF97-4C4D656A5871")]
        #endregion
        [Multiplicity(Multiplicity.OneToOne)]
        [Derived]
        [Indexed]
