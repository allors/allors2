...
namespace Allors.Domain.TestPopulation
{
    ...
    {
        public static SalesOrderItemBuilder WithSerializedDefaults(this SalesOrderItemBuilder @this, Organisation internalOrganisation)
        {
            ...
            /*
             * TODO:
            @this.WithAssociations().Build();
            @this.WithSalesTerms().Build();
            @this.WithCorrespondingPurchaseOrder().Build();
            @this.WithBudgetItem().Build();
            @this.WithProductFeature().Build();
            @this.WithInvoiceItemType().Build();*/
