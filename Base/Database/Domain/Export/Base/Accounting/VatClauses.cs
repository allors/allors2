...
namespace Allors.Domain
{
    ...
    public partial class VatClauses
    {
        ...
        private static readonly Guid BeArt15Par2Part2Id = new Guid("103F00B9-C6F9-4717-992B-26ADA4894912");
        ...
        public VatClause BeArt39Par1Part1 => this.Cache[BeArt39Par1Part1Id];

        public VatClause BeArt15Par2 => this.Cache[BeArt15Par2Id];

        public VatClause BeArt15Par2Part2 => this.Cache[BeArt15Par2Part2Id];
        ...
        protected override void BaseSetup(Setup setup)
        {
            ...
            new VatClauseBuilder(this.Session)
                ...
                .WithLocalisedClause(new LocalisedTextBuilder(this.Session)
                    ...
                    .WithLocale(dutchLocale)
                    .Build())
                .WithUniqueId(BeArt39Par1Part1Id)
                .WithIsActive(true)
                .Build();
            ...
            new VatClauseBuilder(this.Session)
                ...
                .WithLocalisedClause(new LocalisedTextBuilder(this.Session)
                    ...
                    .WithLocale(dutchLocale)
                    .Build())
                .WithUniqueId(BeArt15Par2Part2Id)
                .WithIsActive(true)
                .Build();
