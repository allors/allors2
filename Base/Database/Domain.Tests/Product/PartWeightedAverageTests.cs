...
namespace Allors.Domain
{
    ...
    {
        [Fact]
        public void GivenPart_WhenPurchased_ThenAverageCostIsCalculated()
        {
            ...
            var purchaseItem1 = new PurchaseOrderItemBuilder(this.Session).WithPart(part).WithQuantityOrdered(150).WithAssignedUnitPrice(8M).Build();
            purchaseOrder.AddPurchaseOrderItem(purchaseItem1);
            ...
            var purchaseItem2 = new PurchaseOrderItemBuilder(this.Session).WithPart(part).WithQuantityOrdered(75).WithAssignedUnitPrice(8.1M).Build();
            purchaseOrder.AddPurchaseOrderItem(purchaseItem2);
            ...
            var purchaseItem3 = new PurchaseOrderItemBuilder(this.Session).WithPart(part).WithQuantityOrdered(50).WithAssignedUnitPrice(8.25M).Build();
            purchaseOrder.AddPurchaseOrderItem(purchaseItem3);
            ...
            var purchaseItem = new PurchaseOrderItemBuilder(this.Session).WithPart(part).WithQuantityOrdered(90).WithAssignedUnitPrice(8.35M).Build();
            ...
            outgoingItem = new ShipmentItemBuilder(this.Session).WithGood(part).WithQuantity(350).Build();
            outgoingShipment.AddShipmentItem(outgoingItem);
            ...
            purchaseItem1 = new PurchaseOrderItemBuilder(this.Session).WithPart(part).WithQuantityOrdered(150).WithAssignedUnitPrice(8M).Build();
            purchaseOrder.AddPurchaseOrderItem(purchaseItem1);
