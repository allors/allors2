// <copyright file="FeeCreateTests.cs" company="Allors bvba">
...
namespace Tests.OrderAdjustmentTests
{
    ...
    public class FeeCreateTests : Test
    {
        ...
        public void CreateAmountForProductQuote()
        {
            ...
            feeCreate.SAVE.Click();

            this.Driver.WaitForAngular();
            this.Session.Rollback();

            var after = new Fees(this.Session).Extent().ToArray();
        ...
        public void CreatePercentageForProductQuote()
        {
            ...
            var expected = new FeeBuilder(this.Session).WithPercentageDefaults().Build();
            quote.AddOrderAdjustment(expected);
