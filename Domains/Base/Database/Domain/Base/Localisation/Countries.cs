...
namespace Allors.Domain
{
    ...
    public partial class Countries
    {
        ...
        protected override void BaseSetup(Setup config)
        {
            ...
            var countries = this.Session.Create(this.Meta.ObjectType, data.Length);
            for (var i = 0; i < data.Length; i++)
            {
                var country = (Country)countries[i];
                country.Name = data[i, 0];
                country.IsoCode = data[i, 1];
                country.Abbreviation = data[i, 2]; // Abbreviation shoud be IsCode3Chars
                // TODO: Country number
            }
        }
