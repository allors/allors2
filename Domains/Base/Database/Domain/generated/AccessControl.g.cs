...
namespace Allors.Domain
{
	public partial class AccessControl : Allors.IObject , Cachable, Deletable, AccessControlledObject
	{
		...
		virtual public Singleton SingletonWhereSalesAccessControl
		{ 
			get
			{
				return (Singleton) Strategy.GetCompositeAssociation(Meta.SingletonWhereSalesAccessControl.RelationType);
			}
		} 

		virtual public bool ExistSingletonWhereSalesAccessControl
		{
			get
			{
				return Strategy.ExistCompositeAssociation(Meta.SingletonWhereSalesAccessControl.RelationType);
			}
		}


		virtual public Singleton SingletonWhereOperationsAccessControl
		{ 
			get
			{
				return (Singleton) Strategy.GetCompositeAssociation(Meta.SingletonWhereOperationsAccessControl.RelationType);
			}
		} 

		virtual public bool ExistSingletonWhereOperationsAccessControl
		{
			get
			{
				return Strategy.ExistCompositeAssociation(Meta.SingletonWhereOperationsAccessControl.RelationType);
			}
		}


		virtual public Singleton SingletonWhereProcurementAccessControl
		{ 
			get
			{
				return (Singleton) Strategy.GetCompositeAssociation(Meta.SingletonWhereProcurementAccessControl.RelationType);
			}
		} 

		virtual public bool ExistSingletonWhereProcurementAccessControl
		{
			get
			{
				return Strategy.ExistCompositeAssociation(Meta.SingletonWhereProcurementAccessControl.RelationType);
			}
		}
