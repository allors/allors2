...
{
	public partial class PaymentState : Allors.IObject , ObjectState
	{
		private readonly IStrategy strategy;

		public PaymentState(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaPaymentState Meta
		{
			get
			{
				return Allors.Meta.MetaPaymentState.Instance;
			}
		}
		...
		public static PaymentState Instantiate (Allors.ISession allorsSession, string allorsObjectId)
		{
			return (PaymentState) allorsSession.Instantiate(allorsObjectId);		
		}
		...
		virtual public global::Allors.Extent<Order> OrdersWherePreviousPaymentState
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.OrdersWherePreviousPaymentState.RelationType);
			}
		}

		virtual public bool ExistOrdersWherePreviousPaymentState
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.OrdersWherePreviousPaymentState.RelationType);
			}
		}


		virtual public global::Allors.Extent<Order> OrdersWhereLastPaymentState
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.OrdersWhereLastPaymentState.RelationType);
			}
		}

		virtual public bool ExistOrdersWhereLastPaymentState
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.OrdersWhereLastPaymentState.RelationType);
			}
		}


		virtual public global::Allors.Extent<Order> OrdersWherePaymentState
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.OrdersWherePaymentState.RelationType);
			}
		}

		virtual public bool ExistOrdersWherePaymentState
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.OrdersWherePaymentState.RelationType);
			}
		}
		...
		{ 
			var method = new PaymentStateOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new PaymentStateOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new PaymentStateOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new PaymentStateOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new PaymentStateOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	public partial class PaymentStateBuilder : Allors.ObjectBuilder<PaymentState> , ObjectStateBuilder, global::System.IDisposable
	{		
		public PaymentStateBuilder(Allors.ISession session) : base(session)
	    {
	    }

		protected override void OnBuild(PaymentState instance)
		{
			...
			if(this.DeniedPermissions!=null)
			{
				...
				/// <exclude/>
				public PaymentStateBuilder WithDeniedPermission(Permission value)
		        {
					if(this.DeniedPermissions == null)
					{
				...
				/// <exclude/>
				public PaymentStateBuilder WithName(global::System.String value)
		        {
				...
				/// <exclude/>
				public PaymentStateBuilder WithUniqueId(global::System.Guid? value)
		        {
	...
	public partial class PaymentStates : global::Allors.ObjectsBase<PaymentState>
	{
		public PaymentStates(Allors.ISession session) : base(session)
		{
		}
