...
let SliderComponent = class SliderComponent extends base_angular_1.Field {
    constructor() {
        super(...arguments);
        this.color = "accent";
    }
...
], SliderComponent.prototype, "tickInterval", void 0);
__decorate([
    core_1.Input(),
    __metadata("design:type", Boolean)
...
], SliderComponent.prototype, "color", void 0);
