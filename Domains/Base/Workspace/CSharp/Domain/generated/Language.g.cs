...
{
	public partial class Language : SessionObject 
	{
		...
		public Allors.Workspace.Meta.MetaLanguage Meta
		{
			get
			{
				return Allors.Workspace.Meta.MetaLanguage.Instance;
			}
		}

		public static Language Instantiate (Session allorsSession, long allorsObjectId)
		{
			return (Language) allorsSession.Get(allorsObjectId);		
		}
		...
		public bool CanReadNativeName 
		{
			get
			{
				return this.CanRead(this.Meta.NativeName);
			}
		}

		public bool CanWriteNativeName 
		{
			get
			{
				return this.CanWrite(this.Meta.NativeName);
			}
		}
		...
		virtual public global::System.String NativeName 
		{
			get
			{
				return (global::System.String) this.Get(Meta.NativeName);
			}
			set
			{
				this.Set(Meta.NativeName, value);
			}
		}
		...
		virtual public bool ExistNativeName{
			get
			{
				return this.Exist(Meta.NativeName);
			}
		}

		virtual public void RemoveNativeName()
		{
			this.Set(Meta.NativeName, null);
		}
