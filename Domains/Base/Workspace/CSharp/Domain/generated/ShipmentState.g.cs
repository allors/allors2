...
{
	public partial class ShipmentState : SessionObject , ObjectState
	{
		public ShipmentState(Session session)
		: base(session)
		{
		}

		public Allors.Workspace.Meta.MetaShipmentState Meta
		{
			get
			{
				return Allors.Workspace.Meta.MetaShipmentState.Instance;
			}
		}

		public static ShipmentState Instantiate (Session allorsSession, long allorsObjectId)
		{
			return (ShipmentState) allorsSession.Get(allorsObjectId);		
		}
