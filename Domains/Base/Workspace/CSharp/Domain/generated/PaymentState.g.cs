...
{
	public partial class PaymentState : SessionObject , ObjectState
	{
		public PaymentState(Session session)
		: base(session)
		{
		}

		public Allors.Workspace.Meta.MetaPaymentState Meta
		{
			get
			{
				return Allors.Workspace.Meta.MetaPaymentState.Instance;
			}
		}

		public static PaymentState Instantiate (Session allorsSession, long allorsObjectId)
		{
			return (PaymentState) allorsSession.Get(allorsObjectId);		
		}
