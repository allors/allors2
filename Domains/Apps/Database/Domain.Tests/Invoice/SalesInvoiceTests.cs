...
namespace Allors.Domain
{
    ...
    public class SalesInvoiceTests : DomainTest
    {
        ...
        public void GivenSalesInvoice_WhenDeriving_ThenRequiredRelationsMustExist()
        {
            ...
            builder.WithBillToEndCustomerContactMechanism(billToContactMechanism);
        ...
        public void GivenSalesInvoiceBuilderWithBillToCustomerWithPreferredCurrency_WhenBuilding_ThenDerivedCurrencyIsCustomersPreferredCurrency()
        {
            ...
            var invoice = new SalesInvoiceBuilder(this.Session)
                .WithBillToCustomer(customer)
                .WithBillToEndCustomerContactMechanism(billToContactMechanismMechelen)
                .Build();
        ...
        public void GivenSalesInvoiceWithShipToCustomerWithShippingAddress_WhenDeriving_ThenShipToAddressMustExist()
        {
            ...
            var invoice = new SalesInvoiceBuilder(this.Session)
                ...
                .WithBillToEndCustomerContactMechanism(shipToContactMechanism)
                .Build();
        ...
        public void GivenSalesInvoice_WhenDeriving_ThenLocaleMustExist()
        {
            ...
            var invoice1 = new SalesInvoiceBuilder(this.Session).WithBillToCustomer(customer).WithBillToEndCustomerContactMechanism(contactMechanism).Build();
            ...
            var invoice2 = new SalesInvoiceBuilder(this.Session).WithBillToCustomer(customer).WithBillToEndCustomerContactMechanism(contactMechanism).Build();
        ...
        public void GivenSalesInvoice_WhenDeriving_ThenTotalAmountMustBeDerived()
        {
            ...
            var invoice = new SalesInvoiceBuilder(this.Session).WithBillToCustomer(customer).WithBillToEndCustomerContactMechanism(contactMechanism).Build();
        ...
        public void GivenSalesInvoice_WhenWrittenOff_ThenRevenueIsUpdated()
        {
            ...
            var item2 = new SalesInvoiceItemBuilder(this.Session).WithProduct(good).WithQuantity(1).WithActualUnitPrice(15).WithInvoiceItemType(new InvoiceItemTypes(this.Session).ProductItem).Build();
