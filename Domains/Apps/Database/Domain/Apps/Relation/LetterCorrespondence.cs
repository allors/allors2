    ...
    public partial class LetterCorrespondence
    {
        ...
        public void AppsOnPostDerive(ObjectOnPostDerive method)
        {
            ...
            var isNewStateVersion =
                ...
                !object.Equals(this.PostalAddresses, this.CurrentVersion.PostalAddresses) ||
                !object.Equals(this.Originators, this.CurrentVersion.Originators) ||
                !object.Equals(this.Receivers, this.CurrentVersion.Receivers) ||
                !object.Equals(this.IncomingLetter, this.CurrentVersion.IncomingLetter) ||
