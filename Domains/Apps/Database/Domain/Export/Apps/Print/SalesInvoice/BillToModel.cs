...
namespace Allors.Domain.SalesInvoicePrint
{
    ...
    {
        public BillToModel(SalesInvoice salesInvoice)
        {
            var billTo = salesInvoice.BillToCustomer;
            ...
            if (salesInvoice.BillToContactMechanism is ElectronicAddress electronicAddress)
            {
