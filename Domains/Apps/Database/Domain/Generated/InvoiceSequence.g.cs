...
{
	public partial class InvoiceSequence : Allors.IObject , Enumeration
	{
		private readonly IStrategy strategy;

		public InvoiceSequence(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaInvoiceSequence Meta
		{
			get
			{
				return Allors.Meta.MetaInvoiceSequence.Instance;
			}
		}
		...
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.InternalOrganisationsWhereInvoiceSequence.RelationType);
			}
		}
		...
		virtual public bool ExistInternalOrganisationsWhereInvoiceSequence
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.InternalOrganisationsWhereInvoiceSequence.RelationType);
			}
		}
		...
		{ 
			var method = new InvoiceSequenceOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new InvoiceSequenceOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new InvoiceSequenceOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new InvoiceSequenceOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new InvoiceSequenceOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	{		
		...
		protected override void OnBuild(InvoiceSequence instance)
		{
