...
{
	public partial class PositionStatus : Allors.IObject , Enumeration
	{
		private readonly IStrategy strategy;

		public PositionStatus(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaPositionStatus Meta
		{
			get
			{
				return Allors.Meta.MetaPositionStatus.Instance;
			}
		}
		...
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.PositionsWherePositionStatus.RelationType);
			}
		}
		...
		virtual public bool ExistPositionsWherePositionStatus
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.PositionsWherePositionStatus.RelationType);
			}
		}
		...
		{ 
			var method = new PositionStatusOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new PositionStatusOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new PositionStatusOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new PositionStatusOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new PositionStatusOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	{		
		...
		protected override void OnBuild(PositionStatus instance)
		{
