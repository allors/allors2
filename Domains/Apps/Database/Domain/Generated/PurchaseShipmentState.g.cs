...
{
	public partial class PurchaseShipmentState : Allors.IObject , ObjectState
	{
		private readonly IStrategy strategy;

		public PurchaseShipmentState(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaPurchaseShipmentState Meta
		{
			get
			{
				return Allors.Meta.MetaPurchaseShipmentState.Instance;
			}
		}
		...
		public static PurchaseShipmentState Instantiate (Allors.ISession allorsSession, string allorsObjectId)
		{
			return (PurchaseShipmentState) allorsSession.Instantiate(allorsObjectId);		
		}
		...
		virtual public global::Allors.Extent<PurchaseShipmentVersion> PurchaseShipmentVersionsWherePurchaseShipmentState
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.PurchaseShipmentVersionsWherePurchaseShipmentState.RelationType);
			}
		}

		virtual public bool ExistPurchaseShipmentVersionsWherePurchaseShipmentState
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.PurchaseShipmentVersionsWherePurchaseShipmentState.RelationType);
			}
		}


		virtual public global::Allors.Extent<PurchaseShipment> PurchaseShipmentsWherePreviousPurchaseShipmentState
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.PurchaseShipmentsWherePreviousPurchaseShipmentState.RelationType);
			}
		}

		virtual public bool ExistPurchaseShipmentsWherePreviousPurchaseShipmentState
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.PurchaseShipmentsWherePreviousPurchaseShipmentState.RelationType);
			}
		}


		virtual public global::Allors.Extent<PurchaseShipment> PurchaseShipmentsWhereLastPurchaseShipmentState
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.PurchaseShipmentsWhereLastPurchaseShipmentState.RelationType);
			}
		}

		virtual public bool ExistPurchaseShipmentsWhereLastPurchaseShipmentState
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.PurchaseShipmentsWhereLastPurchaseShipmentState.RelationType);
			}
		}


		virtual public global::Allors.Extent<PurchaseShipment> PurchaseShipmentsWherePurchaseShipmentState
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.PurchaseShipmentsWherePurchaseShipmentState.RelationType);
			}
		}

		virtual public bool ExistPurchaseShipmentsWherePurchaseShipmentState
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.PurchaseShipmentsWherePurchaseShipmentState.RelationType);
			}
		}
		...
		{ 
			var method = new PurchaseShipmentStateOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new PurchaseShipmentStateOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new PurchaseShipmentStateOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new PurchaseShipmentStateOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new PurchaseShipmentStateOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	public partial class PurchaseShipmentStateBuilder : Allors.ObjectBuilder<PurchaseShipmentState> , ObjectStateBuilder, global::System.IDisposable
	{		
		public PurchaseShipmentStateBuilder(Allors.ISession session) : base(session)
	    {
	    }

		protected override void OnBuild(PurchaseShipmentState instance)
		{
			...
			if(this.DeniedPermissions!=null)
			{
				...
				/// <exclude/>
				public PurchaseShipmentStateBuilder WithDeniedPermission(Permission value)
		        {
					if(this.DeniedPermissions == null)
					{
				...
				/// <exclude/>
				public PurchaseShipmentStateBuilder WithName(global::System.String value)
		        {
				...
				/// <exclude/>
				public PurchaseShipmentStateBuilder WithUniqueId(global::System.Guid? value)
		        {
	...
	public partial class PurchaseShipmentStates : global::Allors.ObjectsBase<PurchaseShipmentState>
	{
		public PurchaseShipmentStates(Allors.ISession session) : base(session)
		{
		}
