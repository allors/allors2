...
{
	public partial class VatRatePurchaseKind : Allors.IObject , Enumeration
	{
		private readonly IStrategy strategy;

		public VatRatePurchaseKind(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaVatRatePurchaseKind Meta
		{
			get
			{
				return Allors.Meta.MetaVatRatePurchaseKind.Instance;
			}
		}
		...
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.VatRatesWhereVatRatePurchaseKind.RelationType);
			}
		}
		...
		virtual public bool ExistVatRatesWhereVatRatePurchaseKind
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.VatRatesWhereVatRatePurchaseKind.RelationType);
			}
		}
		...
		{ 
			var method = new VatRatePurchaseKindOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new VatRatePurchaseKindOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new VatRatePurchaseKindOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new VatRatePurchaseKindOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new VatRatePurchaseKindOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	{		
		...
		protected override void OnBuild(VatRatePurchaseKind instance)
		{
