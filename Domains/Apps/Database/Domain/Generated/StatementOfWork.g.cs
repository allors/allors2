...
{
	public partial class StatementOfWork : Allors.IObject , Quote, Versioned
	{
		private readonly IStrategy strategy;

		public StatementOfWork(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaStatementOfWork Meta
		{
			get
			{
				return Allors.Meta.MetaStatementOfWork.Instance;
			}
		}
		...
		virtual public StatementOfWorkVersion CurrentVersion
		{ 
			get
			{
				return (StatementOfWorkVersion) Strategy.GetCompositeRole(Meta.CurrentVersion.RelationType);
			}
			set
			{
		...
		virtual public global::Allors.Extent<StatementOfWorkVersion> AllVersions
		{ 
			get
			{
		...
		virtual public void AddAllVersion (StatementOfWorkVersion value)
		{
			Strategy.AddCompositeRole(Meta.AllVersions.RelationType, value);
		}

		virtual public void RemoveAllVersion (StatementOfWorkVersion value)
		{
		...
		{ 
			var method = new StatementOfWorkApprove(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new StatementOfWorkReject(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new StatementOfWorkOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new StatementOfWorkOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new StatementOfWorkOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new StatementOfWorkOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new StatementOfWorkOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	public partial class StatementOfWorkBuilder : Allors.ObjectBuilder<StatementOfWork> , QuoteBuilder, VersionedBuilder, global::System.IDisposable
	{		
		public StatementOfWorkBuilder(Allors.ISession session) : base(session)
	    {
	    }

		protected override void OnBuild(StatementOfWork instance)
		{
			...
			instance.LastModifiedBy = this.LastModifiedBy;
				...
				/// <exclude/>
				public StatementOfWorkBuilder WithCurrentVersion(StatementOfWorkVersion value)
		        {
				...
				public global::System.Collections.Generic.List<StatementOfWorkVersion> AllVersions {get; set;}	

				/// <exclude/>
				public StatementOfWorkBuilder WithAllVersion(StatementOfWorkVersion value)
		        {
					if(this.AllVersions == null)
					{
						this.AllVersions = new global::System.Collections.Generic.List<StatementOfWorkVersion>(); 
					}
				...
				/// <exclude/>
				public StatementOfWorkBuilder WithQuoteState(QuoteState value)
		        {
				...
				/// <exclude/>
				public StatementOfWorkBuilder WithInternalComment(global::System.String value)
		        {
				...
				/// <exclude/>
				public StatementOfWorkBuilder WithRequiredResponseDate(global::System.DateTime? value)
		        {
				...
				/// <exclude/>
				public StatementOfWorkBuilder WithFullfillContactMechanism(ContactMechanism value)
		        {
				...
				/// <exclude/>
				public StatementOfWorkBuilder WithCurrency(Currency value)
		        {
				...
				/// <exclude/>
				public StatementOfWorkBuilder WithRequest(Request value)
		        {
				...
				/// <exclude/>
				public StatementOfWorkBuilder WithContactPerson(Person value)
		        {
				...
				/// <exclude/>
				public StatementOfWorkBuilder WithPrintContent(global::System.String value)
		        {
				...
				/// <exclude/>
				public StatementOfWorkBuilder WithCreatedBy(User value)
		        {
				...
				/// <exclude/>
				public StatementOfWorkBuilder WithLastModifiedBy(User value)
		        {
				...
				/// <exclude/>
				public StatementOfWorkBuilder WithCreationDate(global::System.DateTime? value)
		        {
				...
				/// <exclude/>
				public StatementOfWorkBuilder WithLastModifiedDate(global::System.DateTime? value)
		        {
				...
				/// <exclude/>
				public StatementOfWorkBuilder WithComment(global::System.String value)
		        {
