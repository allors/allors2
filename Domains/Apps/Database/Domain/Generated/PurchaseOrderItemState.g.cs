...
{
	public partial class PurchaseOrderItemState : Allors.IObject , ObjectState
	{
		private readonly IStrategy strategy;

		public PurchaseOrderItemState(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaPurchaseOrderItemState Meta
		{
			get
			{
				return Allors.Meta.MetaPurchaseOrderItemState.Instance;
			}
		}
		...
		public static PurchaseOrderItemState Instantiate (Allors.ISession allorsSession, string allorsObjectId)
		{
			return (PurchaseOrderItemState) allorsSession.Instantiate(allorsObjectId);		
		}
		...
		virtual public global::Allors.Extent<PurchaseOrderItemVersion> PurchaseOrderItemVersionsWherePurchaseOrderItemState
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.PurchaseOrderItemVersionsWherePurchaseOrderItemState.RelationType);
			}
		}

		virtual public bool ExistPurchaseOrderItemVersionsWherePurchaseOrderItemState
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.PurchaseOrderItemVersionsWherePurchaseOrderItemState.RelationType);
			}
		}


		virtual public global::Allors.Extent<PurchaseOrderItem> PurchaseOrderItemsWherePreviousPurchaseOrderItemState
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.PurchaseOrderItemsWherePreviousPurchaseOrderItemState.RelationType);
			}
		}

		virtual public bool ExistPurchaseOrderItemsWherePreviousPurchaseOrderItemState
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.PurchaseOrderItemsWherePreviousPurchaseOrderItemState.RelationType);
			}
		}


		virtual public global::Allors.Extent<PurchaseOrderItem> PurchaseOrderItemsWhereLastPurchaseOrderItemState
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.PurchaseOrderItemsWhereLastPurchaseOrderItemState.RelationType);
			}
		}

		virtual public bool ExistPurchaseOrderItemsWhereLastPurchaseOrderItemState
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.PurchaseOrderItemsWhereLastPurchaseOrderItemState.RelationType);
			}
		}


		virtual public global::Allors.Extent<PurchaseOrderItem> PurchaseOrderItemsWherePurchaseOrderItemState
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.PurchaseOrderItemsWherePurchaseOrderItemState.RelationType);
			}
		}

		virtual public bool ExistPurchaseOrderItemsWherePurchaseOrderItemState
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.PurchaseOrderItemsWherePurchaseOrderItemState.RelationType);
			}
		}
		...
		{ 
			var method = new PurchaseOrderItemStateOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new PurchaseOrderItemStateOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new PurchaseOrderItemStateOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new PurchaseOrderItemStateOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new PurchaseOrderItemStateOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	public partial class PurchaseOrderItemStateBuilder : Allors.ObjectBuilder<PurchaseOrderItemState> , ObjectStateBuilder, global::System.IDisposable
	{		
		public PurchaseOrderItemStateBuilder(Allors.ISession session) : base(session)
	    {
	    }

		protected override void OnBuild(PurchaseOrderItemState instance)
		{
			...
			if(this.DeniedPermissions!=null)
			{
				...
				/// <exclude/>
				public PurchaseOrderItemStateBuilder WithDeniedPermission(Permission value)
		        {
					if(this.DeniedPermissions == null)
					{
				...
				/// <exclude/>
				public PurchaseOrderItemStateBuilder WithName(global::System.String value)
		        {
				...
				/// <exclude/>
				public PurchaseOrderItemStateBuilder WithUniqueId(global::System.Guid? value)
		        {
	...
	public partial class PurchaseOrderItemStates : global::Allors.ObjectsBase<PurchaseOrderItemState>
	{
		public PurchaseOrderItemStates(Allors.ISession session) : base(session)
		{
		}
