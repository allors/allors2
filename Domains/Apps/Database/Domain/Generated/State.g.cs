...
{
	public partial class State : Allors.IObject , CityBound, GeographicBoundary, CountryBound
	{
		private readonly IStrategy strategy;

		public State(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaState Meta
		{
			get
			{
				return Allors.Meta.MetaState.Instance;
			}
		}
		...
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.CitiesWhereState.RelationType);
			}
		}
		...
		virtual public bool ExistCitiesWhereState
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.CitiesWhereState.RelationType);
			}
		}
		...
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.CountiesWhereState.RelationType);
			}
		}
		...
		virtual public bool ExistCountiesWhereState
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.CountiesWhereState.RelationType);
			}
		}
		...
		{ 
			var method = new StateOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new StateOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new StateOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new StateOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new StateOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	public partial class StateBuilder : Allors.ObjectBuilder<State> , CityBoundBuilder, GeographicBoundaryBuilder, CountryBoundBuilder, global::System.IDisposable
	{		
		public StateBuilder(Allors.ISession session) : base(session)
	    {
	    }

		protected override void OnBuild(State instance)
		{
