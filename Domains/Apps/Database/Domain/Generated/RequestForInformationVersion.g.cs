...
{
	public partial class RequestForInformationVersion : Allors.IObject , RequestVersion
	{
		private readonly IStrategy strategy;

		public RequestForInformationVersion(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaRequestForInformationVersion Meta
		{
			get
			{
				return Allors.Meta.MetaRequestForInformationVersion.Instance;
			}
		}
		...
		public static RequestForInformationVersion Instantiate (Allors.ISession allorsSession, string allorsObjectId)
		{
			return (RequestForInformationVersion) allorsSession.Instantiate(allorsObjectId);		
		}
		...
		virtual public RequestForInformation RequestForInformationWhereCurrentVersion
		{ 
			get
			{
				return (RequestForInformation) Strategy.GetCompositeAssociation(Meta.RequestForInformationWhereCurrentVersion.RelationType);
			}
		} 

		virtual public bool ExistRequestForInformationWhereCurrentVersion
		{
			get
			{
				return Strategy.ExistCompositeAssociation(Meta.RequestForInformationWhereCurrentVersion.RelationType);
			}
		}


		virtual public RequestForInformation RequestForInformationWhereAllVersion
		{ 
			get
			{
				return (RequestForInformation) Strategy.GetCompositeAssociation(Meta.RequestForInformationWhereAllVersion.RelationType);
			}
		} 

		virtual public bool ExistRequestForInformationWhereAllVersion
		{
			get
			{
				return Strategy.ExistCompositeAssociation(Meta.RequestForInformationWhereAllVersion.RelationType);
			}
		}
		...
		{ 
			var method = new RequestForInformationVersionOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new RequestForInformationVersionOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new RequestForInformationVersionOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new RequestForInformationVersionOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new RequestForInformationVersionOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	public partial class RequestForInformationVersionBuilder : Allors.ObjectBuilder<RequestForInformationVersion> , RequestVersionBuilder, global::System.IDisposable
	{		
		public RequestForInformationVersionBuilder(Allors.ISession session) : base(session)
	    {
	    }

		protected override void OnBuild(RequestForInformationVersion instance)
		{
			...
			if(this.SecurityTokens!=null)
			{
				...
				/// <exclude/>
				public RequestForInformationVersionBuilder WithRequestState(RequestState value)
		        {
				...
				/// <exclude/>
				public RequestForInformationVersionBuilder WithInternalComment(global::System.String value)
		        {
				...
				/// <exclude/>
				public RequestForInformationVersionBuilder WithDescription(global::System.String value)
		        {
				...
				/// <exclude/>
				public RequestForInformationVersionBuilder WithRequestDate(global::System.DateTime? value)
		        {
				...
				/// <exclude/>
				public RequestForInformationVersionBuilder WithRequiredResponseDate(global::System.DateTime? value)
		        {
				...
				/// <exclude/>
				public RequestForInformationVersionBuilder WithRequestItem(RequestItem value)
		        {
					if(this.RequestItems == null)
					{
				...
				/// <exclude/>
				public RequestForInformationVersionBuilder WithRequestNumber(global::System.String value)
		        {
				...
				/// <exclude/>
				public RequestForInformationVersionBuilder WithRespondingParty(RespondingParty value)
		        {
					if(this.RespondingParties == null)
					{
				...
				/// <exclude/>
				public RequestForInformationVersionBuilder WithOriginator(Party value)
		        {
				...
				/// <exclude/>
				public RequestForInformationVersionBuilder WithCurrency(Currency value)
		        {
				...
				/// <exclude/>
				public RequestForInformationVersionBuilder WithFullfillContactMechanism(ContactMechanism value)
		        {
				...
				/// <exclude/>
				public RequestForInformationVersionBuilder WithEmailAddress(global::System.String value)
		        {
				...
				/// <exclude/>
				public RequestForInformationVersionBuilder WithTelephoneNumber(global::System.String value)
		        {
				...
				/// <exclude/>
				public RequestForInformationVersionBuilder WithTelephoneCountryCode(global::System.String value)
		        {
				...
				/// <exclude/>
				public RequestForInformationVersionBuilder WithDerivationId(global::System.Guid? value)
		        {
				...
				/// <exclude/>
				public RequestForInformationVersionBuilder WithDerivationTimeStamp(global::System.DateTime? value)
		        {
				...
				/// <exclude/>
				public RequestForInformationVersionBuilder WithDeniedPermission(Permission value)
		        {
					if(this.DeniedPermissions == null)
					{
				...
				/// <exclude/>
				public RequestForInformationVersionBuilder WithSecurityToken(SecurityToken value)
		        {
					if(this.SecurityTokens == null)
					{
	...
	public partial class RequestForInformationVersions : global::Allors.ObjectsBase<RequestForInformationVersion>
	{
		public RequestForInformationVersions(Allors.ISession session) : base(session)
		{
		}
