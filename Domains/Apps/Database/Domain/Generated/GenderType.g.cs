...
{
	public partial class GenderType : Allors.IObject , Enumeration
	{
		private readonly IStrategy strategy;

		public GenderType(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaGenderType Meta
		{
			get
			{
				return Allors.Meta.MetaGenderType.Instance;
			}
		}
		...
		virtual public global::Allors.Extent<Person> PeopleWhereGender
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.PeopleWhereGender.RelationType);
			}
		}

		virtual public bool ExistPeopleWhereGender
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.PeopleWhereGender.RelationType);
			}
		}


		virtual public global::Allors.Extent<PersonVersion> PersonVersionsWhereGender
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.PersonVersionsWhereGender.RelationType);
			}
		}

		virtual public bool ExistPersonVersionsWhereGender
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.PersonVersionsWhereGender.RelationType);
			}
		}
		...
		public GenderTypeDelete Delete()
		{ 
			var method = new GenderTypeDelete(this);
            method.Execute();
            return method;
		}

		public GenderTypeDelete Delete(System.Action<GenderTypeDelete> action)
		{ 
			var method = new GenderTypeDelete(this);
            action(method);
            method.Execute();
		...
		{ 
			var method = new GenderTypeOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new GenderTypeOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new GenderTypeOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new GenderTypeOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new GenderTypeOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	{		
		...
		protected override void OnBuild(GenderType instance)
		{
