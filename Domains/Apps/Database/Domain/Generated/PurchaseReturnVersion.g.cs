...
{
	public partial class PurchaseReturnVersion : Allors.IObject , ShipmentVersion
	{
		private readonly IStrategy strategy;

		public PurchaseReturnVersion(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaPurchaseReturnVersion Meta
		{
			get
			{
				return Allors.Meta.MetaPurchaseReturnVersion.Instance;
			}
		}
		...
		public static PurchaseReturnVersion Instantiate (Allors.ISession allorsSession, string allorsObjectId)
		{
			return (PurchaseReturnVersion) allorsSession.Instantiate(allorsObjectId);		
		}
		...
		virtual public PurchaseReturn PurchaseReturnWhereCurrentVersion
		{ 
			get
			{
				return (PurchaseReturn) Strategy.GetCompositeAssociation(Meta.PurchaseReturnWhereCurrentVersion.RelationType);
			}
		} 

		virtual public bool ExistPurchaseReturnWhereCurrentVersion
		{
			get
			{
				return Strategy.ExistCompositeAssociation(Meta.PurchaseReturnWhereCurrentVersion.RelationType);
			}
		}


		virtual public PurchaseReturn PurchaseReturnWhereAllVersion
		{ 
			get
			{
				return (PurchaseReturn) Strategy.GetCompositeAssociation(Meta.PurchaseReturnWhereAllVersion.RelationType);
			}
		} 

		virtual public bool ExistPurchaseReturnWhereAllVersion
		{
			get
			{
				return Strategy.ExistCompositeAssociation(Meta.PurchaseReturnWhereAllVersion.RelationType);
			}
		}
		...
		{ 
			var method = new PurchaseReturnVersionOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new PurchaseReturnVersionOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new PurchaseReturnVersionOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new PurchaseReturnVersionOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new PurchaseReturnVersionOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	public partial class PurchaseReturnVersionBuilder : Allors.ObjectBuilder<PurchaseReturnVersion> , ShipmentVersionBuilder, global::System.IDisposable
	{		
		public PurchaseReturnVersionBuilder(Allors.ISession session) : base(session)
	    {
	    }

		protected override void OnBuild(PurchaseReturnVersion instance)
		{
			...
			if(this.SecurityTokens!=null)
			{
				...
				/// <exclude/>
				public PurchaseReturnVersionBuilder WithPurchaseReturnState(PurchaseReturnState value)
		        {
				...
				/// <exclude/>
				public PurchaseReturnVersionBuilder WithShipmentMethod(ShipmentMethod value)
		        {
				...
				/// <exclude/>
				public PurchaseReturnVersionBuilder WithBillToContactMechanism(ContactMechanism value)
		        {
				...
				/// <exclude/>
				public PurchaseReturnVersionBuilder WithShipmentPackage(ShipmentPackage value)
		        {
					if(this.ShipmentPackages == null)
					{
				...
				/// <exclude/>
				public PurchaseReturnVersionBuilder WithShipmentNumber(global::System.String value)
		        {
				...
				/// <exclude/>
				public PurchaseReturnVersionBuilder WithDocument(Document value)
		        {
					if(this.Documents == null)
					{
				...
				/// <exclude/>
				public PurchaseReturnVersionBuilder WithBillToParty(Party value)
		        {
				...
				/// <exclude/>
				public PurchaseReturnVersionBuilder WithShipToParty(Party value)
		        {
				...
				/// <exclude/>
				public PurchaseReturnVersionBuilder WithShipmentItem(ShipmentItem value)
		        {
					if(this.ShipmentItems == null)
					{
				...
				/// <exclude/>
				public PurchaseReturnVersionBuilder WithReceiverContactMechanism(ContactMechanism value)
		        {
				...
				/// <exclude/>
				public PurchaseReturnVersionBuilder WithShipToAddress(PostalAddress value)
		        {
				...
				/// <exclude/>
				public PurchaseReturnVersionBuilder WithEstimatedShipCost(global::System.Decimal? value)
		        {
				...
				/// <exclude/>
				public PurchaseReturnVersionBuilder WithEstimatedShipDate(global::System.DateTime? value)
		        {
				...
				/// <exclude/>
				public PurchaseReturnVersionBuilder WithLatestCancelDate(global::System.DateTime? value)
		        {
				...
				/// <exclude/>
				public PurchaseReturnVersionBuilder WithCarrier(Carrier value)
		        {
				...
				/// <exclude/>
				public PurchaseReturnVersionBuilder WithInquireAboutContactMechanism(ContactMechanism value)
		        {
				...
				/// <exclude/>
				public PurchaseReturnVersionBuilder WithEstimatedReadyDate(global::System.DateTime? value)
		        {
				...
				/// <exclude/>
				public PurchaseReturnVersionBuilder WithShipFromAddress(PostalAddress value)
		        {
				...
				/// <exclude/>
				public PurchaseReturnVersionBuilder WithHandlingInstruction(global::System.String value)
		        {
				...
				/// <exclude/>
				public PurchaseReturnVersionBuilder WithStore(Store value)
		        {
				...
				/// <exclude/>
				public PurchaseReturnVersionBuilder WithShipFromParty(Party value)
		        {
				...
				/// <exclude/>
				public PurchaseReturnVersionBuilder WithShipmentRouteSegment(ShipmentRouteSegment value)
		        {
					if(this.ShipmentRouteSegments == null)
					{
				...
				/// <exclude/>
				public PurchaseReturnVersionBuilder WithEstimatedArrivalDate(global::System.DateTime? value)
		        {
				...
				/// <exclude/>
				public PurchaseReturnVersionBuilder WithDerivationId(global::System.Guid? value)
		        {
				...
				/// <exclude/>
				public PurchaseReturnVersionBuilder WithDerivationTimeStamp(global::System.DateTime? value)
		        {
				...
				/// <exclude/>
				public PurchaseReturnVersionBuilder WithDeniedPermission(Permission value)
		        {
					if(this.DeniedPermissions == null)
					{
				...
				/// <exclude/>
				public PurchaseReturnVersionBuilder WithSecurityToken(SecurityToken value)
		        {
					if(this.SecurityTokens == null)
					{
	...
	public partial class PurchaseReturnVersions : global::Allors.ObjectsBase<PurchaseReturnVersion>
	{
		public PurchaseReturnVersions(Allors.ISession session) : base(session)
		{
		}
