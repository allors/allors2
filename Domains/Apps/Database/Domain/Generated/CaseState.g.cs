...
{
	public partial class CaseState : Allors.IObject , ObjectState
	{
		private readonly IStrategy strategy;

		public CaseState(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaCaseState Meta
		{
			get
			{
				return Allors.Meta.MetaCaseState.Instance;
			}
		}
		...
		public static CaseState Instantiate (Allors.ISession allorsSession, string allorsObjectId)
		{
			return (CaseState) allorsSession.Instantiate(allorsObjectId);		
		}
		...
		virtual public global::Allors.Extent<CaseVersion> CaseVersionsWhereCaseState
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.CaseVersionsWhereCaseState.RelationType);
			}
		}

		virtual public bool ExistCaseVersionsWhereCaseState
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.CaseVersionsWhereCaseState.RelationType);
			}
		}


		virtual public global::Allors.Extent<Case> CasesWherePreviousCaseState
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.CasesWherePreviousCaseState.RelationType);
			}
		}

		virtual public bool ExistCasesWherePreviousCaseState
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.CasesWherePreviousCaseState.RelationType);
			}
		}


		virtual public global::Allors.Extent<Case> CasesWhereLastCaseState
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.CasesWhereLastCaseState.RelationType);
			}
		}

		virtual public bool ExistCasesWhereLastCaseState
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.CasesWhereLastCaseState.RelationType);
			}
		}


		virtual public global::Allors.Extent<Case> CasesWhereCaseState
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.CasesWhereCaseState.RelationType);
			}
		}

		virtual public bool ExistCasesWhereCaseState
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.CasesWhereCaseState.RelationType);
			}
		}
		...
		{ 
			var method = new CaseStateOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new CaseStateOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new CaseStateOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new CaseStateOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new CaseStateOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	public partial class CaseStateBuilder : Allors.ObjectBuilder<CaseState> , ObjectStateBuilder, global::System.IDisposable
	{		
		public CaseStateBuilder(Allors.ISession session) : base(session)
	    {
	    }

		protected override void OnBuild(CaseState instance)
		{
			...
			if(this.DeniedPermissions!=null)
			{
				...
				/// <exclude/>
				public CaseStateBuilder WithDeniedPermission(Permission value)
		        {
					if(this.DeniedPermissions == null)
					{
				...
				/// <exclude/>
				public CaseStateBuilder WithName(global::System.String value)
		        {
				...
				/// <exclude/>
				public CaseStateBuilder WithUniqueId(global::System.Guid? value)
		        {
	...
	public partial class CaseStates : global::Allors.ObjectsBase<CaseState>
	{
		public CaseStates(Allors.ISession session) : base(session)
		{
		}
