...
{
	public partial class EngineeringDocument : Allors.IObject , Document
	{
		private readonly IStrategy strategy;

		public EngineeringDocument(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaEngineeringDocument Meta
		{
			get
			{
				return Allors.Meta.MetaEngineeringDocument.Instance;
			}
		}
		...
		{ 
			var method = new EngineeringDocumentOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new EngineeringDocumentOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new EngineeringDocumentOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new EngineeringDocumentOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new EngineeringDocumentOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	{		
		...
		protected override void OnBuild(EngineeringDocument instance)
		{
