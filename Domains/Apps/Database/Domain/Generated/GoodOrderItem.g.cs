...
{
	public partial class GoodOrderItem : Allors.IObject , EngagementItem
	{
		private readonly IStrategy strategy;

		public GoodOrderItem(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaGoodOrderItem Meta
		{
			get
			{
				return Allors.Meta.MetaGoodOrderItem.Instance;
			}
		}
		...
		{ 
			var method = new GoodOrderItemOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new GoodOrderItemOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new GoodOrderItemOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new GoodOrderItemOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new GoodOrderItemOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	{		
		...
		protected override void OnBuild(GoodOrderItem instance)
		{
