...
{
	public partial class CreditLine : Allors.IObject , ExternalAccountingTransaction
	{
		private readonly IStrategy strategy;

		public CreditLine(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaCreditLine Meta
		{
			get
			{
				return Allors.Meta.MetaCreditLine.Instance;
			}
		}
		...
		{ 
			var method = new CreditLineOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new CreditLineOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new CreditLineOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new CreditLineOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new CreditLineOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	{		
		...
		protected override void OnBuild(CreditLine instance)
		{
