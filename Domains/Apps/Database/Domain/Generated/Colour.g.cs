...
{
	public partial class Colour : Allors.IObject , Enumeration, ProductFeature
	{
		private readonly IStrategy strategy;

		public Colour(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaColour Meta
		{
			get
			{
				return Allors.Meta.MetaColour.Instance;
			}
		}
		...
		{ 
			var method = new ColourOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new ColourOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new ColourOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new ColourOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new ColourOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	{		
		...
		protected override void OnBuild(Colour instance)
		{
