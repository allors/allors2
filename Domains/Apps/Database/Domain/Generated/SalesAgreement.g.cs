...
{
	public partial class SalesAgreement : Allors.IObject , Agreement
	{
		private readonly IStrategy strategy;

		public SalesAgreement(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaSalesAgreement Meta
		{
			get
			{
				return Allors.Meta.MetaSalesAgreement.Instance;
			}
		}
		...
		{ 
			var method = new SalesAgreementOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new SalesAgreementOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new SalesAgreementOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new SalesAgreementOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new SalesAgreementOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	{		
		...
		protected override void OnBuild(SalesAgreement instance)
		{
			...
			if(this.SecurityTokens!=null)
			{
				...
				/// <exclude/>
				public SalesAgreementBuilder WithAddenda(Addendum value)
		        {
					if(this.Addenda == null)
					{
