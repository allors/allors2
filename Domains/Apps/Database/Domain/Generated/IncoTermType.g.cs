...
{
	public partial class IncoTermType : Allors.IObject , TermType
	{
		private readonly IStrategy strategy;

		public IncoTermType(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaIncoTermType Meta
		{
			get
			{
				return Allors.Meta.MetaIncoTermType.Instance;
			}
		}
		...
		public static IncoTermType Instantiate (Allors.ISession allorsSession, string allorsObjectId)
		{
			return (IncoTermType) allorsSession.Instantiate(allorsObjectId);		
		}
		...
		{ 
			var method = new IncoTermTypeOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new IncoTermTypeOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new IncoTermTypeOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new IncoTermTypeOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new IncoTermTypeOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	public partial class IncoTermTypeBuilder : Allors.ObjectBuilder<IncoTermType> , TermTypeBuilder, global::System.IDisposable
	{		
		public IncoTermTypeBuilder(Allors.ISession session) : base(session)
	    {
	    }

		protected override void OnBuild(IncoTermType instance)
		{
			...
			if(this.SecurityTokens!=null)
			{
				...
				/// <exclude/>
				public IncoTermTypeBuilder WithLocalisedName(LocalisedText value)
		        {
					if(this.LocalisedNames == null)
					{
				...
				/// <exclude/>
				public IncoTermTypeBuilder WithName(global::System.String value)
		        {
				...
				/// <exclude/>
				public IncoTermTypeBuilder WithIsActive(global::System.Boolean? value)
		        {
				...
				/// <exclude/>
				public IncoTermTypeBuilder WithDeniedPermission(Permission value)
		        {
					if(this.DeniedPermissions == null)
					{
				...
				/// <exclude/>
				public IncoTermTypeBuilder WithSecurityToken(SecurityToken value)
		        {
					if(this.SecurityTokens == null)
					{
				...
				/// <exclude/>
				public IncoTermTypeBuilder WithUniqueId(global::System.Guid? value)
		        {
	...
	public partial class IncoTermTypes : global::Allors.ObjectsBase<IncoTermType>
	{
		public IncoTermTypes(Allors.ISession session) : base(session)
		{
		}
