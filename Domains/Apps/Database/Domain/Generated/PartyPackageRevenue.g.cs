...
{
	public partial class PartyPackageRevenue : Allors.IObject , AccessControlledObject, Deletable
	{
		private readonly IStrategy strategy;

		public PartyPackageRevenue(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaPartyPackageRevenue Meta
		{
			get
			{
				return Allors.Meta.MetaPartyPackageRevenue.Instance;
			}
		}
		...
		virtual public global::System.String PartyPackageName 
		{
			get
			{
				return (global::System.String) Strategy.GetUnitRole(Meta.PartyPackageName.RelationType);
			}
			set
			{
				Strategy.SetUnitRole(Meta.PartyPackageName.RelationType, value);
			}
		}
		...
		virtual public bool ExistPartyPackageName{
			get
			{
				return Strategy.ExistUnitRole(Meta.PartyPackageName.RelationType);
			}
		}

		virtual public void RemovePartyPackageName()
		{
			Strategy.RemoveUnitRole(Meta.PartyPackageName.RelationType);
		}
		...
		{ 
			var method = new PartyPackageRevenueOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new PartyPackageRevenueOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new PartyPackageRevenueOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new PartyPackageRevenueOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new PartyPackageRevenueOnPostDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new PartyPackageRevenueDelete(this);
            method.Execute();
            return method;
		}
	...
	public partial class PartyPackageRevenueBuilder : Allors.ObjectBuilder<PartyPackageRevenue> , AccessControlledObjectBuilder, DeletableBuilder, global::System.IDisposable
	{		
		public PartyPackageRevenueBuilder(Allors.ISession session) : base(session)
	    {
	    }

		protected override void OnBuild(PartyPackageRevenue instance)
		{
			...
			instance.PartyPackageName = this.PartyPackageName;
