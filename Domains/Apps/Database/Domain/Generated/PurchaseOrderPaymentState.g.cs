...
{
	public partial class PurchaseOrderPaymentState : Allors.IObject , ObjectState
	{
		private readonly IStrategy strategy;

		public PurchaseOrderPaymentState(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaPurchaseOrderPaymentState Meta
		{
			get
			{
				return Allors.Meta.MetaPurchaseOrderPaymentState.Instance;
			}
		}
		...
		public static PurchaseOrderPaymentState Instantiate (Allors.ISession allorsSession, string allorsObjectId)
		{
			return (PurchaseOrderPaymentState) allorsSession.Instantiate(allorsObjectId);		
		}
		...
		virtual public global::Allors.Extent<PurchaseOrder> PurchaseOrdersWherePreviousPurchaseOrderPaymentState
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.PurchaseOrdersWherePreviousPurchaseOrderPaymentState.RelationType);
			}
		}

		virtual public bool ExistPurchaseOrdersWherePreviousPurchaseOrderPaymentState
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.PurchaseOrdersWherePreviousPurchaseOrderPaymentState.RelationType);
			}
		}


		virtual public global::Allors.Extent<PurchaseOrder> PurchaseOrdersWhereLastPurchaseOrderPaymentState
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.PurchaseOrdersWhereLastPurchaseOrderPaymentState.RelationType);
			}
		}

		virtual public bool ExistPurchaseOrdersWhereLastPurchaseOrderPaymentState
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.PurchaseOrdersWhereLastPurchaseOrderPaymentState.RelationType);
			}
		}


		virtual public global::Allors.Extent<PurchaseOrder> PurchaseOrdersWherePurchaseOrderPaymentState
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.PurchaseOrdersWherePurchaseOrderPaymentState.RelationType);
			}
		}

		virtual public bool ExistPurchaseOrdersWherePurchaseOrderPaymentState
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.PurchaseOrdersWherePurchaseOrderPaymentState.RelationType);
			}
		}
		...
		{ 
			var method = new PurchaseOrderPaymentStateOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new PurchaseOrderPaymentStateOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new PurchaseOrderPaymentStateOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new PurchaseOrderPaymentStateOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new PurchaseOrderPaymentStateOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	public partial class PurchaseOrderPaymentStateBuilder : Allors.ObjectBuilder<PurchaseOrderPaymentState> , ObjectStateBuilder, global::System.IDisposable
	{		
		public PurchaseOrderPaymentStateBuilder(Allors.ISession session) : base(session)
	    {
	    }

		protected override void OnBuild(PurchaseOrderPaymentState instance)
		{
			...
			if(this.DeniedPermissions!=null)
			{
				...
				/// <exclude/>
				public PurchaseOrderPaymentStateBuilder WithDeniedPermission(Permission value)
		        {
					if(this.DeniedPermissions == null)
					{
				...
				/// <exclude/>
				public PurchaseOrderPaymentStateBuilder WithName(global::System.String value)
		        {
				...
				/// <exclude/>
				public PurchaseOrderPaymentStateBuilder WithUniqueId(global::System.Guid? value)
		        {
	...
	public partial class PurchaseOrderPaymentStates : global::Allors.ObjectsBase<PurchaseOrderPaymentState>
	{
		public PurchaseOrderPaymentStates(Allors.ISession session) : base(session)
		{
		}
