...
{
	public partial class ClientAgreement : Allors.IObject , Agreement
	{
		private readonly IStrategy strategy;

		public ClientAgreement(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaClientAgreement Meta
		{
			get
			{
				return Allors.Meta.MetaClientAgreement.Instance;
			}
		}
		...
		{ 
			var method = new ClientAgreementOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new ClientAgreementOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new ClientAgreementOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new ClientAgreementOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new ClientAgreementOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	{		
		...
		protected override void OnBuild(ClientAgreement instance)
		{
			...
			if(this.SecurityTokens!=null)
			{
				...
				/// <exclude/>
				public ClientAgreementBuilder WithAddenda(Addendum value)
		        {
					if(this.Addenda == null)
					{
