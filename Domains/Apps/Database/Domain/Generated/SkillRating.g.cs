...
{
	public partial class SkillRating : Allors.IObject , Enumeration
	{
		private readonly IStrategy strategy;

		public SkillRating(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaSkillRating Meta
		{
			get
			{
				return Allors.Meta.MetaSkillRating.Instance;
			}
		}
		...
		{ 
			get
			{
				return (PartySkill) Strategy.GetCompositeAssociation(Meta.PartySkillWhereSkillRating.RelationType);
			}
		} 
		...
		virtual public bool ExistPartySkillWhereSkillRating
		{
			get
			{
				return Strategy.ExistCompositeAssociation(Meta.PartySkillWhereSkillRating.RelationType);
			}
		}
		...
		public SkillRatingDelete Delete()
		{ 
			var method = new SkillRatingDelete(this);
            method.Execute();
            return method;
		}

		public SkillRatingDelete Delete(System.Action<SkillRatingDelete> action)
		{ 
			var method = new SkillRatingDelete(this);
            action(method);
            method.Execute();
		...
		{ 
			var method = new SkillRatingOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new SkillRatingOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new SkillRatingOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new SkillRatingOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new SkillRatingOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	{		
		...
		protected override void OnBuild(SkillRating instance)
		{
