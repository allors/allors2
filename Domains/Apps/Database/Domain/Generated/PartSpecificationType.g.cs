...
{
	public partial class PartSpecificationType : Allors.IObject , Enumeration
	{
		private readonly IStrategy strategy;

		public PartSpecificationType(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaPartSpecificationType Meta
		{
			get
			{
				return Allors.Meta.MetaPartSpecificationType.Instance;
			}
		}
		...
		public static PartSpecificationType Instantiate (Allors.ISession allorsSession, string allorsObjectId)
		{
			return (PartSpecificationType) allorsSession.Instantiate(allorsObjectId);		
		}
		...
		{ 
			var method = new PartSpecificationTypeOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new PartSpecificationTypeOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new PartSpecificationTypeOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new PartSpecificationTypeOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new PartSpecificationTypeOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	public partial class PartSpecificationTypeBuilder : Allors.ObjectBuilder<PartSpecificationType> , EnumerationBuilder, global::System.IDisposable
	{		
		public PartSpecificationTypeBuilder(Allors.ISession session) : base(session)
	    {
	    }

		protected override void OnBuild(PartSpecificationType instance)
		{
			...
			if(this.SecurityTokens!=null)
			{
				...
				/// <exclude/>
				public PartSpecificationTypeBuilder WithLocalisedName(LocalisedText value)
		        {
					if(this.LocalisedNames == null)
					{
				...
				/// <exclude/>
				public PartSpecificationTypeBuilder WithName(global::System.String value)
		        {
				...
				/// <exclude/>
				public PartSpecificationTypeBuilder WithIsActive(global::System.Boolean? value)
		        {
				...
				/// <exclude/>
				public PartSpecificationTypeBuilder WithDeniedPermission(Permission value)
		        {
					if(this.DeniedPermissions == null)
					{
				...
				/// <exclude/>
				public PartSpecificationTypeBuilder WithSecurityToken(SecurityToken value)
		        {
					if(this.SecurityTokens == null)
					{
				...
				/// <exclude/>
				public PartSpecificationTypeBuilder WithUniqueId(global::System.Guid? value)
		        {
	...
	public partial class PartSpecificationTypes : global::Allors.ObjectsBase<PartSpecificationType>
	{
		public PartSpecificationTypes(Allors.ISession session) : base(session)
		{
		}
