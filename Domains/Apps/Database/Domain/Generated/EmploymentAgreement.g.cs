...
{
	public partial class EmploymentAgreement : Allors.IObject , Agreement
	{
		private readonly IStrategy strategy;

		public EmploymentAgreement(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaEmploymentAgreement Meta
		{
			get
			{
				return Allors.Meta.MetaEmploymentAgreement.Instance;
			}
		}
		...
		{ 
			var method = new EmploymentAgreementOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new EmploymentAgreementOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new EmploymentAgreementOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new EmploymentAgreementOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new EmploymentAgreementOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	{		
		...
		protected override void OnBuild(EmploymentAgreement instance)
		{
			...
			if(this.SecurityTokens!=null)
			{
				...
				/// <exclude/>
				public EmploymentAgreementBuilder WithAddenda(Addendum value)
		        {
					if(this.Addenda == null)
					{
