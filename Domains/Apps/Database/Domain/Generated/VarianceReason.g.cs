...
{
	public partial class VarianceReason : Allors.IObject , Enumeration
	{
		private readonly IStrategy strategy;

		public VarianceReason(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaVarianceReason Meta
		{
			get
			{
				return Allors.Meta.MetaVarianceReason.Instance;
			}
		}
		...
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.InventoryItemVariancesWhereReason.RelationType);
			}
		}
		...
		virtual public bool ExistInventoryItemVariancesWhereReason
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.InventoryItemVariancesWhereReason.RelationType);
			}
		}
		...
		public VarianceReasonDelete Delete()
		{ 
			var method = new VarianceReasonDelete(this);
            method.Execute();
            return method;
		}

		public VarianceReasonDelete Delete(System.Action<VarianceReasonDelete> action)
		{ 
			var method = new VarianceReasonDelete(this);
            action(method);
            method.Execute();
		...
		{ 
			var method = new VarianceReasonOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new VarianceReasonOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new VarianceReasonOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new VarianceReasonOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new VarianceReasonOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	{		
		...
		protected override void OnBuild(VarianceReason instance)
		{
