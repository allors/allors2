...
{
	public partial class SalesInvoiceType : Allors.IObject , Enumeration
	{
		private readonly IStrategy strategy;

		public SalesInvoiceType(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaSalesInvoiceType Meta
		{
			get
			{
				return Allors.Meta.MetaSalesInvoiceType.Instance;
			}
		}
		...
		virtual public global::Allors.Extent<SalesInvoiceVersion> SalesInvoiceVersionsWhereSalesInvoiceType
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.SalesInvoiceVersionsWhereSalesInvoiceType.RelationType);
			}
		}

		virtual public bool ExistSalesInvoiceVersionsWhereSalesInvoiceType
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.SalesInvoiceVersionsWhereSalesInvoiceType.RelationType);
			}
		}
		...
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.SalesInvoicesWhereSalesInvoiceType.RelationType);
			}
		}
		...
		virtual public bool ExistSalesInvoicesWhereSalesInvoiceType
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.SalesInvoicesWhereSalesInvoiceType.RelationType);
			}
		}
		...
		{ 
			var method = new SalesInvoiceTypeOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new SalesInvoiceTypeOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new SalesInvoiceTypeOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new SalesInvoiceTypeOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new SalesInvoiceTypeOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	{		
		...
		protected override void OnBuild(SalesInvoiceType instance)
		{
