...
{
	public partial class Hobby : Allors.IObject , Enumeration
	{
		private readonly IStrategy strategy;

		public Hobby(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaHobby Meta
		{
			get
			{
				return Allors.Meta.MetaHobby.Instance;
			}
		}
		...
		virtual public global::Allors.Extent<Person> PeopleWhereHobby
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.PeopleWhereHobby.RelationType);
			}
		}

		virtual public bool ExistPeopleWhereHobby
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.PeopleWhereHobby.RelationType);
			}
		}


		virtual public global::Allors.Extent<PersonVersion> PersonVersionsWhereHobby
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.PersonVersionsWhereHobby.RelationType);
			}
		}

		virtual public bool ExistPersonVersionsWhereHobby
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.PersonVersionsWhereHobby.RelationType);
			}
		}
		...
		public HobbyDelete Delete()
		{ 
			var method = new HobbyDelete(this);
            method.Execute();
            return method;
		}

		public HobbyDelete Delete(System.Action<HobbyDelete> action)
		{ 
			var method = new HobbyDelete(this);
            action(method);
            method.Execute();
		...
		{ 
			var method = new HobbyOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new HobbyOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new HobbyOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new HobbyOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new HobbyOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	{		
		...
		protected override void OnBuild(Hobby instance)
		{
