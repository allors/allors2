...
{
	public partial class DeliverableType : Allors.IObject , Enumeration
	{
		private readonly IStrategy strategy;

		public DeliverableType(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaDeliverableType Meta
		{
			get
			{
				return Allors.Meta.MetaDeliverableType.Instance;
			}
		}
		...
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.DeliverablesWhereDeliverableType.RelationType);
			}
		}
		...
		virtual public bool ExistDeliverablesWhereDeliverableType
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.DeliverablesWhereDeliverableType.RelationType);
			}
		}
		...
		{ 
			var method = new DeliverableTypeOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new DeliverableTypeOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new DeliverableTypeOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new DeliverableTypeOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new DeliverableTypeOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	{		
		...
		protected override void OnBuild(DeliverableType instance)
		{
