...
{
	public partial class Salutation : Allors.IObject , Enumeration
	{
		private readonly IStrategy strategy;

		public Salutation(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaSalutation Meta
		{
			get
			{
				return Allors.Meta.MetaSalutation.Instance;
			}
		}
		...
		virtual public global::Allors.Extent<Person> PeopleWhereSalutation
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.PeopleWhereSalutation.RelationType);
			}
		}

		virtual public bool ExistPeopleWhereSalutation
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.PeopleWhereSalutation.RelationType);
			}
		}


		virtual public global::Allors.Extent<PersonVersion> PersonVersionsWhereSalutation
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.PersonVersionsWhereSalutation.RelationType);
			}
		}

		virtual public bool ExistPersonVersionsWhereSalutation
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.PersonVersionsWhereSalutation.RelationType);
			}
		}
		...
		public SalutationDelete Delete()
		{ 
			var method = new SalutationDelete(this);
            method.Execute();
            return method;
		}

		public SalutationDelete Delete(System.Action<SalutationDelete> action)
		{ 
			var method = new SalutationDelete(this);
            action(method);
            method.Execute();
		...
		{ 
			var method = new SalutationOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new SalutationOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new SalutationOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new SalutationOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new SalutationOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	public partial class SalutationBuilder : Allors.ObjectBuilder<Salutation> , EnumerationBuilder, global::System.IDisposable
	{		
		public SalutationBuilder(Allors.ISession session) : base(session)
	    {
	    }

		protected override void OnBuild(Salutation instance)
		{
