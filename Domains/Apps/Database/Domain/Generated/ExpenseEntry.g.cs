...
{
	public partial class ExpenseEntry : Allors.IObject , ServiceEntry
	{
		private readonly IStrategy strategy;

		public ExpenseEntry(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaExpenseEntry Meta
		{
			get
			{
				return Allors.Meta.MetaExpenseEntry.Instance;
			}
		}
		...
		{ 
			var method = new ExpenseEntryOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new ExpenseEntryOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new ExpenseEntryOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new ExpenseEntryOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new ExpenseEntryOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	{		
		...
		protected override void OnBuild(ExpenseEntry instance)
		{
