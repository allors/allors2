...
{
	public partial class RateType : Allors.IObject , Enumeration
	{
		private readonly IStrategy strategy;

		public RateType(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaRateType Meta
		{
			get
			{
				return Allors.Meta.MetaRateType.Instance;
			}
		}
		...
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.PositionTypeRatesWhereRateType.RelationType);
			}
		}
		...
		virtual public bool ExistPositionTypeRatesWhereRateType
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.PositionTypeRatesWhereRateType.RelationType);
			}
		}
		...
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.WorkEffortAssignmentRatesWhereRateType.RelationType);
			}
		}
		...
		virtual public bool ExistWorkEffortAssignmentRatesWhereRateType
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.WorkEffortAssignmentRatesWhereRateType.RelationType);
			}
		}
		...
		{ 
			var method = new RateTypeOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new RateTypeOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new RateTypeOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new RateTypeOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new RateTypeOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	{		
		...
		protected override void OnBuild(RateType instance)
		{
