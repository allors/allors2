...
{
	public partial class Equipment : Allors.IObject , FixedAsset
	{
		private readonly IStrategy strategy;

		public Equipment(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaEquipment Meta
		{
			get
			{
				return Allors.Meta.MetaEquipment.Instance;
			}
		}
		...
		{ 
			var method = new EquipmentOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new EquipmentOnDerive(this);
            method.Execute();
            return method;
		}
