...
{
	public partial class AgreementExhibit : Allors.IObject , AgreementItem
	{
		private readonly IStrategy strategy;

		public AgreementExhibit(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaAgreementExhibit Meta
		{
			get
			{
				return Allors.Meta.MetaAgreementExhibit.Instance;
			}
		}
		...
		{ 
			var method = new AgreementExhibitOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new AgreementExhibitOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new AgreementExhibitOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new AgreementExhibitOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new AgreementExhibitOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	{		
		...
		protected override void OnBuild(AgreementExhibit instance)
		{
			...
			if(this.SecurityTokens!=null)
			{
				...
				/// <exclude/>
				public AgreementExhibitBuilder WithAddenda(Addendum value)
		        {
					if(this.Addenda == null)
					{
