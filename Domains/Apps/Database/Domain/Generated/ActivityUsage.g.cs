...
{
	public partial class ActivityUsage : Allors.IObject , DeploymentUsage
	{
		private readonly IStrategy strategy;

		public ActivityUsage(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaActivityUsage Meta
		{
			get
			{
				return Allors.Meta.MetaActivityUsage.Instance;
			}
		}
		...
		{ 
			var method = new ActivityUsageOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new ActivityUsageOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new ActivityUsageOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new ActivityUsageOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new ActivityUsageOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	{		
		...
		protected override void OnBuild(ActivityUsage instance)
		{
