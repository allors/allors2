...
{
	public partial class PurchaseReturnState : Allors.IObject , ObjectState
	{
		private readonly IStrategy strategy;

		public PurchaseReturnState(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaPurchaseReturnState Meta
		{
			get
			{
				return Allors.Meta.MetaPurchaseReturnState.Instance;
			}
		}
		...
		public static PurchaseReturnState Instantiate (Allors.ISession allorsSession, string allorsObjectId)
		{
			return (PurchaseReturnState) allorsSession.Instantiate(allorsObjectId);		
		}
		...
		virtual public global::Allors.Extent<PurchaseReturnVersion> PurchaseReturnVersionsWherePurchaseReturnState
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.PurchaseReturnVersionsWherePurchaseReturnState.RelationType);
			}
		}

		virtual public bool ExistPurchaseReturnVersionsWherePurchaseReturnState
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.PurchaseReturnVersionsWherePurchaseReturnState.RelationType);
			}
		}


		virtual public global::Allors.Extent<PurchaseReturn> PurchaseReturnsWherePreviousPurchaseReturnState
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.PurchaseReturnsWherePreviousPurchaseReturnState.RelationType);
			}
		}

		virtual public bool ExistPurchaseReturnsWherePreviousPurchaseReturnState
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.PurchaseReturnsWherePreviousPurchaseReturnState.RelationType);
			}
		}


		virtual public global::Allors.Extent<PurchaseReturn> PurchaseReturnsWhereLastPurchaseReturnState
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.PurchaseReturnsWhereLastPurchaseReturnState.RelationType);
			}
		}

		virtual public bool ExistPurchaseReturnsWhereLastPurchaseReturnState
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.PurchaseReturnsWhereLastPurchaseReturnState.RelationType);
			}
		}


		virtual public global::Allors.Extent<PurchaseReturn> PurchaseReturnsWherePurchaseReturnState
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.PurchaseReturnsWherePurchaseReturnState.RelationType);
			}
		}

		virtual public bool ExistPurchaseReturnsWherePurchaseReturnState
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.PurchaseReturnsWherePurchaseReturnState.RelationType);
			}
		}
		...
		{ 
			var method = new PurchaseReturnStateOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new PurchaseReturnStateOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new PurchaseReturnStateOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new PurchaseReturnStateOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new PurchaseReturnStateOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	public partial class PurchaseReturnStateBuilder : Allors.ObjectBuilder<PurchaseReturnState> , ObjectStateBuilder, global::System.IDisposable
	{		
		public PurchaseReturnStateBuilder(Allors.ISession session) : base(session)
	    {
	    }

		protected override void OnBuild(PurchaseReturnState instance)
		{
			...
			if(this.DeniedPermissions!=null)
			{
				...
				/// <exclude/>
				public PurchaseReturnStateBuilder WithDeniedPermission(Permission value)
		        {
					if(this.DeniedPermissions == null)
					{
				...
				/// <exclude/>
				public PurchaseReturnStateBuilder WithName(global::System.String value)
		        {
				...
				/// <exclude/>
				public PurchaseReturnStateBuilder WithUniqueId(global::System.Guid? value)
		        {
	...
	public partial class PurchaseReturnStates : global::Allors.ObjectsBase<PurchaseReturnState>
	{
		public PurchaseReturnStates(Allors.ISession session) : base(session)
		{
		}
