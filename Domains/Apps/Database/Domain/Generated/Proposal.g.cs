...
{
	public partial class Proposal : Allors.IObject , Quote, Versioned
	{
		private readonly IStrategy strategy;

		public Proposal(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaProposal Meta
		{
			get
			{
				return Allors.Meta.MetaProposal.Instance;
			}
		}
		...
		virtual public ProposalVersion CurrentVersion
		{ 
			get
			{
				return (ProposalVersion) Strategy.GetCompositeRole(Meta.CurrentVersion.RelationType);
			}
			set
			{
		...
		virtual public global::Allors.Extent<ProposalVersion> AllVersions
		{ 
			get
			{
		...
		virtual public void AddAllVersion (ProposalVersion value)
		{
			Strategy.AddCompositeRole(Meta.AllVersions.RelationType, value);
		}

		virtual public void RemoveAllVersion (ProposalVersion value)
		{
		...
		{ 
			var method = new ProposalApprove(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new ProposalReject(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new ProposalOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new ProposalOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new ProposalOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new ProposalOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new ProposalOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	public partial class ProposalBuilder : Allors.ObjectBuilder<Proposal> , QuoteBuilder, VersionedBuilder, global::System.IDisposable
	{		
		public ProposalBuilder(Allors.ISession session) : base(session)
	    {
	    }

		protected override void OnBuild(Proposal instance)
		{
			...
			instance.LastModifiedBy = this.LastModifiedBy;
				...
				/// <exclude/>
				public ProposalBuilder WithCurrentVersion(ProposalVersion value)
		        {
				...
				public global::System.Collections.Generic.List<ProposalVersion> AllVersions {get; set;}	

				/// <exclude/>
				public ProposalBuilder WithAllVersion(ProposalVersion value)
		        {
					if(this.AllVersions == null)
					{
						this.AllVersions = new global::System.Collections.Generic.List<ProposalVersion>(); 
					}
				...
				/// <exclude/>
				public ProposalBuilder WithQuoteState(QuoteState value)
		        {
				...
				/// <exclude/>
				public ProposalBuilder WithInternalComment(global::System.String value)
		        {
				...
				/// <exclude/>
				public ProposalBuilder WithRequiredResponseDate(global::System.DateTime? value)
		        {
				...
				/// <exclude/>
				public ProposalBuilder WithFullfillContactMechanism(ContactMechanism value)
		        {
				...
				/// <exclude/>
				public ProposalBuilder WithCurrency(Currency value)
		        {
				...
				/// <exclude/>
				public ProposalBuilder WithRequest(Request value)
		        {
				...
				/// <exclude/>
				public ProposalBuilder WithContactPerson(Person value)
		        {
				...
				/// <exclude/>
				public ProposalBuilder WithPrintContent(global::System.String value)
		        {
				...
				/// <exclude/>
				public ProposalBuilder WithCreatedBy(User value)
		        {
				...
				/// <exclude/>
				public ProposalBuilder WithLastModifiedBy(User value)
		        {
				...
				/// <exclude/>
				public ProposalBuilder WithCreationDate(global::System.DateTime? value)
		        {
				...
				/// <exclude/>
				public ProposalBuilder WithLastModifiedDate(global::System.DateTime? value)
		        {
				...
				/// <exclude/>
				public ProposalBuilder WithComment(global::System.String value)
		        {
