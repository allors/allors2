...
{
	public partial class TransferState : Allors.IObject , ObjectState
	{
		private readonly IStrategy strategy;

		public TransferState(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaTransferState Meta
		{
			get
			{
				return Allors.Meta.MetaTransferState.Instance;
			}
		}
		...
		public static TransferState Instantiate (Allors.ISession allorsSession, string allorsObjectId)
		{
			return (TransferState) allorsSession.Instantiate(allorsObjectId);		
		}
		...
		virtual public global::Allors.Extent<TransferVersion> TransferVersionsWhereTransferState
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.TransferVersionsWhereTransferState.RelationType);
			}
		}

		virtual public bool ExistTransferVersionsWhereTransferState
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.TransferVersionsWhereTransferState.RelationType);
			}
		}


		virtual public global::Allors.Extent<Transfer> TransfersWherePreviousTransferState
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.TransfersWherePreviousTransferState.RelationType);
			}
		}

		virtual public bool ExistTransfersWherePreviousTransferState
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.TransfersWherePreviousTransferState.RelationType);
			}
		}


		virtual public global::Allors.Extent<Transfer> TransfersWhereLastTransferState
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.TransfersWhereLastTransferState.RelationType);
			}
		}

		virtual public bool ExistTransfersWhereLastTransferState
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.TransfersWhereLastTransferState.RelationType);
			}
		}


		virtual public global::Allors.Extent<Transfer> TransfersWhereTransferState
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.TransfersWhereTransferState.RelationType);
			}
		}

		virtual public bool ExistTransfersWhereTransferState
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.TransfersWhereTransferState.RelationType);
			}
		}
		...
		{ 
			var method = new TransferStateOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new TransferStateOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new TransferStateOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new TransferStateOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new TransferStateOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	public partial class TransferStateBuilder : Allors.ObjectBuilder<TransferState> , ObjectStateBuilder, global::System.IDisposable
	{		
		public TransferStateBuilder(Allors.ISession session) : base(session)
	    {
	    }

		protected override void OnBuild(TransferState instance)
		{
			...
			if(this.DeniedPermissions!=null)
			{
				...
				/// <exclude/>
				public TransferStateBuilder WithDeniedPermission(Permission value)
		        {
					if(this.DeniedPermissions == null)
					{
				...
				/// <exclude/>
				public TransferStateBuilder WithName(global::System.String value)
		        {
				...
				/// <exclude/>
				public TransferStateBuilder WithUniqueId(global::System.Guid? value)
		        {
	...
	public partial class TransferStates : global::Allors.ObjectsBase<TransferState>
	{
		public TransferStates(Allors.ISession session) : base(session)
		{
		}
