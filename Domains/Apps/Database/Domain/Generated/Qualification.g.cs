...
{
	public partial class Qualification : Allors.IObject , Enumeration
	{
		private readonly IStrategy strategy;

		public Qualification(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaQualification Meta
		{
			get
			{
				return Allors.Meta.MetaQualification.Instance;
			}
		}
		...
		virtual public global::Allors.Extent<PartyVersion> PartyVersionsWhereQualification
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.PartyVersionsWhereQualification.RelationType);
			}
		}

		virtual public bool ExistPartyVersionsWhereQualification
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.PartyVersionsWhereQualification.RelationType);
			}
		}
		...
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.PartiesWhereQualification.RelationType);
			}
		}
		...
		virtual public bool ExistPartiesWhereQualification
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.PartiesWhereQualification.RelationType);
			}
		}
		...
		public QualificationDelete Delete()
		{ 
			var method = new QualificationDelete(this);
            method.Execute();
            return method;
		}

		public QualificationDelete Delete(System.Action<QualificationDelete> action)
		{ 
			var method = new QualificationDelete(this);
            action(method);
            method.Execute();
		...
		{ 
			var method = new QualificationOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new QualificationOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new QualificationOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new QualificationOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new QualificationOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	public partial class QualificationBuilder : Allors.ObjectBuilder<Qualification> , EnumerationBuilder, global::System.IDisposable
	{		
		public QualificationBuilder(Allors.ISession session) : base(session)
	    {
	    }

		protected override void OnBuild(Qualification instance)
		{
