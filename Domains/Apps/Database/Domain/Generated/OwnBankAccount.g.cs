...
{
	public partial class OwnBankAccount : Allors.IObject , PaymentMethod, FinancialAccount
	{
		private readonly IStrategy strategy;

		public OwnBankAccount(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaOwnBankAccount Meta
		{
			get
			{
				return Allors.Meta.MetaOwnBankAccount.Instance;
			}
		}
		...
		{ 
			var method = new OwnBankAccountOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new OwnBankAccountOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new OwnBankAccountOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new OwnBankAccountOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new OwnBankAccountOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	{		
		...
		protected override void OnBuild(OwnBankAccount instance)
		{
