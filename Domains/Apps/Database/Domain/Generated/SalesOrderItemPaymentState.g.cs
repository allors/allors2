...
{
	public partial class SalesOrderItemPaymentState : Allors.IObject , ObjectState
	{
		private readonly IStrategy strategy;

		public SalesOrderItemPaymentState(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaSalesOrderItemPaymentState Meta
		{
			get
			{
				return Allors.Meta.MetaSalesOrderItemPaymentState.Instance;
			}
		}
		...
		public static SalesOrderItemPaymentState Instantiate (Allors.ISession allorsSession, string allorsObjectId)
		{
			return (SalesOrderItemPaymentState) allorsSession.Instantiate(allorsObjectId);		
		}
		...
		virtual public global::Allors.Extent<SalesOrderItem> SalesOrderItemsWherePreviousSalesOrderItemPaymentState
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.SalesOrderItemsWherePreviousSalesOrderItemPaymentState.RelationType);
			}
		}

		virtual public bool ExistSalesOrderItemsWherePreviousSalesOrderItemPaymentState
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.SalesOrderItemsWherePreviousSalesOrderItemPaymentState.RelationType);
			}
		}


		virtual public global::Allors.Extent<SalesOrderItem> SalesOrderItemsWhereLastSalesOrderItemPaymentState
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.SalesOrderItemsWhereLastSalesOrderItemPaymentState.RelationType);
			}
		}

		virtual public bool ExistSalesOrderItemsWhereLastSalesOrderItemPaymentState
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.SalesOrderItemsWhereLastSalesOrderItemPaymentState.RelationType);
			}
		}


		virtual public global::Allors.Extent<SalesOrderItem> SalesOrderItemsWhereSalesOrderItemPaymentState
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.SalesOrderItemsWhereSalesOrderItemPaymentState.RelationType);
			}
		}

		virtual public bool ExistSalesOrderItemsWhereSalesOrderItemPaymentState
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.SalesOrderItemsWhereSalesOrderItemPaymentState.RelationType);
			}
		}
		...
		{ 
			var method = new SalesOrderItemPaymentStateOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new SalesOrderItemPaymentStateOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new SalesOrderItemPaymentStateOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new SalesOrderItemPaymentStateOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new SalesOrderItemPaymentStateOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	public partial class SalesOrderItemPaymentStateBuilder : Allors.ObjectBuilder<SalesOrderItemPaymentState> , ObjectStateBuilder, global::System.IDisposable
	{		
		public SalesOrderItemPaymentStateBuilder(Allors.ISession session) : base(session)
	    {
	    }

		protected override void OnBuild(SalesOrderItemPaymentState instance)
		{
			...
			if(this.DeniedPermissions!=null)
			{
				...
				/// <exclude/>
				public SalesOrderItemPaymentStateBuilder WithDeniedPermission(Permission value)
		        {
					if(this.DeniedPermissions == null)
					{
				...
				/// <exclude/>
				public SalesOrderItemPaymentStateBuilder WithName(global::System.String value)
		        {
				...
				/// <exclude/>
				public SalesOrderItemPaymentStateBuilder WithUniqueId(global::System.Guid? value)
		        {
	...
	public partial class SalesOrderItemPaymentStates : global::Allors.ObjectsBase<SalesOrderItemPaymentState>
	{
		public SalesOrderItemPaymentStates(Allors.ISession session) : base(session)
		{
		}
