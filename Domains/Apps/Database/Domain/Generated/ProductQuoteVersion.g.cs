...
{
	public partial class ProductQuoteVersion : Allors.IObject , QuoteVersion
	{
		private readonly IStrategy strategy;

		public ProductQuoteVersion(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaProductQuoteVersion Meta
		{
			get
			{
				return Allors.Meta.MetaProductQuoteVersion.Instance;
			}
		}
		...
		public static ProductQuoteVersion Instantiate (Allors.ISession allorsSession, string allorsObjectId)
		{
			return (ProductQuoteVersion) allorsSession.Instantiate(allorsObjectId);		
		}
		...
		virtual public ProductQuote ProductQuoteWhereCurrentVersion
		{ 
			get
			{
				return (ProductQuote) Strategy.GetCompositeAssociation(Meta.ProductQuoteWhereCurrentVersion.RelationType);
			}
		} 

		virtual public bool ExistProductQuoteWhereCurrentVersion
		{
			get
			{
				return Strategy.ExistCompositeAssociation(Meta.ProductQuoteWhereCurrentVersion.RelationType);
			}
		}


		virtual public ProductQuote ProductQuoteWhereAllVersion
		{ 
			get
			{
				return (ProductQuote) Strategy.GetCompositeAssociation(Meta.ProductQuoteWhereAllVersion.RelationType);
			}
		} 

		virtual public bool ExistProductQuoteWhereAllVersion
		{
			get
			{
				return Strategy.ExistCompositeAssociation(Meta.ProductQuoteWhereAllVersion.RelationType);
			}
		}
		...
		{ 
			var method = new ProductQuoteVersionOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new ProductQuoteVersionOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new ProductQuoteVersionOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new ProductQuoteVersionOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new ProductQuoteVersionOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	public partial class ProductQuoteVersionBuilder : Allors.ObjectBuilder<ProductQuoteVersion> , QuoteVersionBuilder, global::System.IDisposable
	{		
		public ProductQuoteVersionBuilder(Allors.ISession session) : base(session)
	    {
	    }

		protected override void OnBuild(ProductQuoteVersion instance)
		{
			...
			if(this.SecurityTokens!=null)
			{
				...
				/// <exclude/>
				public ProductQuoteVersionBuilder WithQuoteState(QuoteState value)
		        {
				...
				/// <exclude/>
				public ProductQuoteVersionBuilder WithInternalComment(global::System.String value)
		        {
				...
				/// <exclude/>
				public ProductQuoteVersionBuilder WithRequiredResponseDate(global::System.DateTime? value)
		        {
				...
				/// <exclude/>
				public ProductQuoteVersionBuilder WithValidFromDate(global::System.DateTime? value)
		        {
				...
				/// <exclude/>
				public ProductQuoteVersionBuilder WithQuoteTerm(QuoteTerm value)
		        {
					if(this.QuoteTerms == null)
					{
				...
				/// <exclude/>
				public ProductQuoteVersionBuilder WithValidThroughDate(global::System.DateTime? value)
		        {
				...
				/// <exclude/>
				public ProductQuoteVersionBuilder WithDescription(global::System.String value)
		        {
				...
				/// <exclude/>
				public ProductQuoteVersionBuilder WithReceiver(Party value)
		        {
				...
				/// <exclude/>
				public ProductQuoteVersionBuilder WithFullfillContactMechanism(ContactMechanism value)
		        {
				...
				/// <exclude/>
				public ProductQuoteVersionBuilder WithPrice(global::System.Decimal? value)
		        {
				...
				/// <exclude/>
				public ProductQuoteVersionBuilder WithCurrency(Currency value)
		        {
				...
				/// <exclude/>
				public ProductQuoteVersionBuilder WithIssueDate(global::System.DateTime? value)
		        {
				...
				/// <exclude/>
				public ProductQuoteVersionBuilder WithQuoteItem(QuoteItem value)
		        {
					if(this.QuoteItems == null)
					{
				...
				/// <exclude/>
				public ProductQuoteVersionBuilder WithQuoteNumber(global::System.String value)
		        {
				...
				/// <exclude/>
				public ProductQuoteVersionBuilder WithRequest(Request value)
		        {
				...
				/// <exclude/>
				public ProductQuoteVersionBuilder WithDerivationId(global::System.Guid? value)
		        {
				...
				/// <exclude/>
				public ProductQuoteVersionBuilder WithDerivationTimeStamp(global::System.DateTime? value)
		        {
				...
				/// <exclude/>
				public ProductQuoteVersionBuilder WithDeniedPermission(Permission value)
		        {
					if(this.DeniedPermissions == null)
					{
				...
				/// <exclude/>
				public ProductQuoteVersionBuilder WithSecurityToken(SecurityToken value)
		        {
					if(this.SecurityTokens == null)
					{
	...
	public partial class ProductQuoteVersions : global::Allors.ObjectsBase<ProductQuoteVersion>
	{
		public ProductQuoteVersions(Allors.ISession session) : base(session)
		{
		}
