...
{
	public partial class CostCenterSplitMethod : Allors.IObject , Enumeration
	{
		private readonly IStrategy strategy;

		public CostCenterSplitMethod(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaCostCenterSplitMethod Meta
		{
			get
			{
				return Allors.Meta.MetaCostCenterSplitMethod.Instance;
			}
		}
		...
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.InternalOrganisationsWhereCostCenterSplitMethod.RelationType);
			}
		}
		...
		virtual public bool ExistInternalOrganisationsWhereCostCenterSplitMethod
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.InternalOrganisationsWhereCostCenterSplitMethod.RelationType);
			}
		}
		...
		{ 
			var method = new CostCenterSplitMethodOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new CostCenterSplitMethodOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new CostCenterSplitMethodOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new CostCenterSplitMethodOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new CostCenterSplitMethodOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	{		
		...
		protected override void OnBuild(CostCenterSplitMethod instance)
		{
