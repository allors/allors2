...
{
	public partial class MaritalStatus : Allors.IObject , Enumeration
	{
		private readonly IStrategy strategy;

		public MaritalStatus(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaMaritalStatus Meta
		{
			get
			{
				return Allors.Meta.MetaMaritalStatus.Instance;
			}
		}
		...
		{ 
			get
			{
				return (Person) Strategy.GetCompositeAssociation(Meta.PersonWhereMaritalStatus.RelationType);
			}
		} 
		...
		virtual public bool ExistPersonWhereMaritalStatus
		{
			get
			{
				return Strategy.ExistCompositeAssociation(Meta.PersonWhereMaritalStatus.RelationType);
			}
		}


		virtual public PersonVersion PersonVersionWhereMaritalStatus
		{ 
			get
			{
				return (PersonVersion) Strategy.GetCompositeAssociation(Meta.PersonVersionWhereMaritalStatus.RelationType);
			}
		} 

		virtual public bool ExistPersonVersionWhereMaritalStatus
		{
			get
			{
				return Strategy.ExistCompositeAssociation(Meta.PersonVersionWhereMaritalStatus.RelationType);
			}
		}
		...
		public MaritalStatusDelete Delete()
		{ 
			var method = new MaritalStatusDelete(this);
            method.Execute();
            return method;
		}

		public MaritalStatusDelete Delete(System.Action<MaritalStatusDelete> action)
		{ 
			var method = new MaritalStatusDelete(this);
            action(method);
            method.Execute();
		...
		{ 
			var method = new MaritalStatusOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new MaritalStatusOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new MaritalStatusOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new MaritalStatusOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new MaritalStatusOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	{		
		...
		protected override void OnBuild(MaritalStatus instance)
		{
