...
{
	public partial class PickListState : Allors.IObject , ObjectState
	{
		private readonly IStrategy strategy;

		public PickListState(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaPickListState Meta
		{
			get
			{
				return Allors.Meta.MetaPickListState.Instance;
			}
		}
		...
		public static PickListState Instantiate (Allors.ISession allorsSession, string allorsObjectId)
		{
			return (PickListState) allorsSession.Instantiate(allorsObjectId);		
		}
		...
		virtual public global::Allors.Extent<PickListVersion> PickListVersionsWherePickListState
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.PickListVersionsWherePickListState.RelationType);
			}
		}

		virtual public bool ExistPickListVersionsWherePickListState
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.PickListVersionsWherePickListState.RelationType);
			}
		}


		virtual public global::Allors.Extent<PickList> PickListsWherePreviousPickListState
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.PickListsWherePreviousPickListState.RelationType);
			}
		}

		virtual public bool ExistPickListsWherePreviousPickListState
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.PickListsWherePreviousPickListState.RelationType);
			}
		}


		virtual public global::Allors.Extent<PickList> PickListsWhereLastPickListState
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.PickListsWhereLastPickListState.RelationType);
			}
		}

		virtual public bool ExistPickListsWhereLastPickListState
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.PickListsWhereLastPickListState.RelationType);
			}
		}


		virtual public global::Allors.Extent<PickList> PickListsWherePickListState
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.PickListsWherePickListState.RelationType);
			}
		}

		virtual public bool ExistPickListsWherePickListState
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.PickListsWherePickListState.RelationType);
			}
		}
		...
		{ 
			var method = new PickListStateOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new PickListStateOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new PickListStateOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new PickListStateOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new PickListStateOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	public partial class PickListStateBuilder : Allors.ObjectBuilder<PickListState> , ObjectStateBuilder, global::System.IDisposable
	{		
		public PickListStateBuilder(Allors.ISession session) : base(session)
	    {
	    }

		protected override void OnBuild(PickListState instance)
		{
			...
			if(this.DeniedPermissions!=null)
			{
				...
				/// <exclude/>
				public PickListStateBuilder WithDeniedPermission(Permission value)
		        {
					if(this.DeniedPermissions == null)
					{
				...
				/// <exclude/>
				public PickListStateBuilder WithName(global::System.String value)
		        {
				...
				/// <exclude/>
				public PickListStateBuilder WithUniqueId(global::System.Guid? value)
		        {
	...
	public partial class PickListStates : global::Allors.ObjectsBase<PickListState>
	{
		public PickListStates(Allors.ISession session) : base(session)
		{
		}
