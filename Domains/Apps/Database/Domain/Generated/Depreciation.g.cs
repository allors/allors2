...
{
	public partial class Depreciation : Allors.IObject , InternalAccountingTransaction
	{
		private readonly IStrategy strategy;

		public Depreciation(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaDepreciation Meta
		{
			get
			{
				return Allors.Meta.MetaDepreciation.Instance;
			}
		}
		...
		{ 
			var method = new DepreciationOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new DepreciationOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new DepreciationOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new DepreciationOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new DepreciationOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	{		
		...
		protected override void OnBuild(Depreciation instance)
		{
