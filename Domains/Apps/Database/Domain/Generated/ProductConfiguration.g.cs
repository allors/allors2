...
{
	public partial class ProductConfiguration : Allors.IObject , ProductAssociation
	{
		private readonly IStrategy strategy;

		public ProductConfiguration(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaProductConfiguration Meta
		{
			get
			{
				return Allors.Meta.MetaProductConfiguration.Instance;
			}
		}
		...
		virtual public global::System.Decimal? QuantityUsed 
		{
			get
			{
				return (global::System.Decimal?) Strategy.GetUnitRole(Meta.QuantityUsed.RelationType);
			}
			set
			{
		...
		{ 
			var method = new ProductConfigurationOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new ProductConfigurationOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new ProductConfigurationOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new ProductConfigurationOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new ProductConfigurationOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	{		
		...
		protected override void OnBuild(ProductConfiguration instance)
		{
			...
			if(this.SecurityTokens!=null)
			{
				...
				/// <exclude/>
				public ProductConfigurationBuilder WithProductsUsedIn(Product value)
		        {
					if(this.ProductsUsedIn == null)
					{
