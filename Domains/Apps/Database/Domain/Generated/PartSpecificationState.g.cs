...
{
	public partial class PartSpecificationState : Allors.IObject , ObjectState
	{
		private readonly IStrategy strategy;

		public PartSpecificationState(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaPartSpecificationState Meta
		{
			get
			{
				return Allors.Meta.MetaPartSpecificationState.Instance;
			}
		}
		...
		public static PartSpecificationState Instantiate (Allors.ISession allorsSession, string allorsObjectId)
		{
			return (PartSpecificationState) allorsSession.Instantiate(allorsObjectId);		
		}
		...
		virtual public global::Allors.Extent<PartSpecificationVersion> PartSpecificationVersionsWherePartSpecificationState
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.PartSpecificationVersionsWherePartSpecificationState.RelationType);
			}
		}

		virtual public bool ExistPartSpecificationVersionsWherePartSpecificationState
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.PartSpecificationVersionsWherePartSpecificationState.RelationType);
			}
		}


		virtual public global::Allors.Extent<PartSpecification> PartSpecificationsWherePreviousPartSpecificationState
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.PartSpecificationsWherePreviousPartSpecificationState.RelationType);
			}
		}

		virtual public bool ExistPartSpecificationsWherePreviousPartSpecificationState
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.PartSpecificationsWherePreviousPartSpecificationState.RelationType);
			}
		}


		virtual public global::Allors.Extent<PartSpecification> PartSpecificationsWhereLastPartSpecificationState
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.PartSpecificationsWhereLastPartSpecificationState.RelationType);
			}
		}

		virtual public bool ExistPartSpecificationsWhereLastPartSpecificationState
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.PartSpecificationsWhereLastPartSpecificationState.RelationType);
			}
		}


		virtual public global::Allors.Extent<PartSpecification> PartSpecificationsWherePartSpecificationState
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.PartSpecificationsWherePartSpecificationState.RelationType);
			}
		}

		virtual public bool ExistPartSpecificationsWherePartSpecificationState
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.PartSpecificationsWherePartSpecificationState.RelationType);
			}
		}
		...
		{ 
			var method = new PartSpecificationStateOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new PartSpecificationStateOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new PartSpecificationStateOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new PartSpecificationStateOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new PartSpecificationStateOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	public partial class PartSpecificationStateBuilder : Allors.ObjectBuilder<PartSpecificationState> , ObjectStateBuilder, global::System.IDisposable
	{		
		public PartSpecificationStateBuilder(Allors.ISession session) : base(session)
	    {
	    }

		protected override void OnBuild(PartSpecificationState instance)
		{
			...
			if(this.DeniedPermissions!=null)
			{
				...
				/// <exclude/>
				public PartSpecificationStateBuilder WithDeniedPermission(Permission value)
		        {
					if(this.DeniedPermissions == null)
					{
				...
				/// <exclude/>
				public PartSpecificationStateBuilder WithName(global::System.String value)
		        {
				...
				/// <exclude/>
				public PartSpecificationStateBuilder WithUniqueId(global::System.Guid? value)
		        {
	...
	public partial class PartSpecificationStates : global::Allors.ObjectsBase<PartSpecificationState>
	{
		public PartSpecificationStates(Allors.ISession session) : base(session)
		{
		}
