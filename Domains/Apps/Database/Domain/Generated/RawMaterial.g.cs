...
{
	public partial class RawMaterial : Allors.IObject , Part
	{
		private readonly IStrategy strategy;

		public RawMaterial(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaRawMaterial Meta
		{
			get
			{
				return Allors.Meta.MetaRawMaterial.Instance;
			}
		}
		...
		{ 
			var method = new RawMaterialOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new RawMaterialOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new RawMaterialOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new RawMaterialOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new RawMaterialOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	{		
		...
		protected override void OnBuild(RawMaterial instance)
		{
			...
			if(this.SecurityTokens!=null)
			{
				...
				/// <exclude/>
				public RawMaterialBuilder WithSku(global::System.String value)
		        {
