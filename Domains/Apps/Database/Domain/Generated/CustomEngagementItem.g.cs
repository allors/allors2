...
{
	public partial class CustomEngagementItem : Allors.IObject , EngagementItem
	{
		private readonly IStrategy strategy;

		public CustomEngagementItem(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaCustomEngagementItem Meta
		{
			get
			{
				return Allors.Meta.MetaCustomEngagementItem.Instance;
			}
		}
		...
		virtual public global::System.String DescriptionOfWork 
		{
			get
			{
				return (global::System.String) Strategy.GetUnitRole(Meta.DescriptionOfWork.RelationType);
			}
			set
			{
				Strategy.SetUnitRole(Meta.DescriptionOfWork.RelationType, value);
			}
		}
		...
		virtual public bool ExistDescriptionOfWork{
			get
			{
				return Strategy.ExistUnitRole(Meta.DescriptionOfWork.RelationType);
			}
		}

		virtual public void RemoveDescriptionOfWork()
		{
			Strategy.RemoveUnitRole(Meta.DescriptionOfWork.RelationType);
		}
		...
		virtual public global::System.Decimal? AgreedUponPrice 
		{
			get
			{
				return (global::System.Decimal?) Strategy.GetUnitRole(Meta.AgreedUponPrice.RelationType);
			}
			set
			{
				Strategy.SetUnitRole(Meta.AgreedUponPrice.RelationType, value);
			}
		}
		...
		virtual public bool ExistAgreedUponPrice{
			get
			{
				return Strategy.ExistUnitRole(Meta.AgreedUponPrice.RelationType);
			}
		}

		virtual public void RemoveAgreedUponPrice()
		{
			Strategy.RemoveUnitRole(Meta.AgreedUponPrice.RelationType);
		}
		...
		{ 
			var method = new CustomEngagementItemOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new CustomEngagementItemOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new CustomEngagementItemOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new CustomEngagementItemOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new CustomEngagementItemOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	{		
		...
		protected override void OnBuild(CustomEngagementItem instance)
		{

			instance.DescriptionOfWork = this.DescriptionOfWork;
		
		
			

			if(this.AgreedUponPrice.HasValue)
			{
				instance.AgreedUponPrice = this.AgreedUponPrice.Value;
			}			
