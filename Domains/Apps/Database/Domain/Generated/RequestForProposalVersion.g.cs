...
{
	public partial class RequestForProposalVersion : Allors.IObject , RequestVersion
	{
		private readonly IStrategy strategy;

		public RequestForProposalVersion(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaRequestForProposalVersion Meta
		{
			get
			{
				return Allors.Meta.MetaRequestForProposalVersion.Instance;
			}
		}
		...
		public static RequestForProposalVersion Instantiate (Allors.ISession allorsSession, string allorsObjectId)
		{
			return (RequestForProposalVersion) allorsSession.Instantiate(allorsObjectId);		
		}
		...
		virtual public RequestForProposal RequestForProposalWhereCurrentVersion
		{ 
			get
			{
				return (RequestForProposal) Strategy.GetCompositeAssociation(Meta.RequestForProposalWhereCurrentVersion.RelationType);
			}
		} 

		virtual public bool ExistRequestForProposalWhereCurrentVersion
		{
			get
			{
				return Strategy.ExistCompositeAssociation(Meta.RequestForProposalWhereCurrentVersion.RelationType);
			}
		}


		virtual public RequestForProposal RequestForProposalWhereAllVersion
		{ 
			get
			{
				return (RequestForProposal) Strategy.GetCompositeAssociation(Meta.RequestForProposalWhereAllVersion.RelationType);
			}
		} 

		virtual public bool ExistRequestForProposalWhereAllVersion
		{
			get
			{
				return Strategy.ExistCompositeAssociation(Meta.RequestForProposalWhereAllVersion.RelationType);
			}
		}
		...
		{ 
			var method = new RequestForProposalVersionOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new RequestForProposalVersionOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new RequestForProposalVersionOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new RequestForProposalVersionOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new RequestForProposalVersionOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	public partial class RequestForProposalVersionBuilder : Allors.ObjectBuilder<RequestForProposalVersion> , RequestVersionBuilder, global::System.IDisposable
	{		
		public RequestForProposalVersionBuilder(Allors.ISession session) : base(session)
	    {
	    }

		protected override void OnBuild(RequestForProposalVersion instance)
		{
			...
			if(this.SecurityTokens!=null)
			{
				...
				/// <exclude/>
				public RequestForProposalVersionBuilder WithRequestState(RequestState value)
		        {
				...
				/// <exclude/>
				public RequestForProposalVersionBuilder WithInternalComment(global::System.String value)
		        {
				...
				/// <exclude/>
				public RequestForProposalVersionBuilder WithDescription(global::System.String value)
		        {
				...
				/// <exclude/>
				public RequestForProposalVersionBuilder WithRequestDate(global::System.DateTime? value)
		        {
				...
				/// <exclude/>
				public RequestForProposalVersionBuilder WithRequiredResponseDate(global::System.DateTime? value)
		        {
				...
				/// <exclude/>
				public RequestForProposalVersionBuilder WithRequestItem(RequestItem value)
		        {
					if(this.RequestItems == null)
					{
				...
				/// <exclude/>
				public RequestForProposalVersionBuilder WithRequestNumber(global::System.String value)
		        {
				...
				/// <exclude/>
				public RequestForProposalVersionBuilder WithRespondingParty(RespondingParty value)
		        {
					if(this.RespondingParties == null)
					{
				...
				/// <exclude/>
				public RequestForProposalVersionBuilder WithOriginator(Party value)
		        {
				...
				/// <exclude/>
				public RequestForProposalVersionBuilder WithCurrency(Currency value)
		        {
				...
				/// <exclude/>
				public RequestForProposalVersionBuilder WithFullfillContactMechanism(ContactMechanism value)
		        {
				...
				/// <exclude/>
				public RequestForProposalVersionBuilder WithEmailAddress(global::System.String value)
		        {
				...
				/// <exclude/>
				public RequestForProposalVersionBuilder WithTelephoneNumber(global::System.String value)
		        {
				...
				/// <exclude/>
				public RequestForProposalVersionBuilder WithTelephoneCountryCode(global::System.String value)
		        {
				...
				/// <exclude/>
				public RequestForProposalVersionBuilder WithDerivationId(global::System.Guid? value)
		        {
				...
				/// <exclude/>
				public RequestForProposalVersionBuilder WithDerivationTimeStamp(global::System.DateTime? value)
		        {
				...
				/// <exclude/>
				public RequestForProposalVersionBuilder WithDeniedPermission(Permission value)
		        {
					if(this.DeniedPermissions == null)
					{
				...
				/// <exclude/>
				public RequestForProposalVersionBuilder WithSecurityToken(SecurityToken value)
		        {
					if(this.SecurityTokens == null)
					{
	...
	public partial class RequestForProposalVersions : global::Allors.ObjectsBase<RequestForProposalVersion>
	{
		public RequestForProposalVersions(Allors.ISession session) : base(session)
		{
		}
