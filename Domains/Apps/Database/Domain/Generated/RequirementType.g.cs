...
{
	public partial class RequirementType : Allors.IObject , Enumeration
	{
		private readonly IStrategy strategy;

		public RequirementType(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaRequirementType Meta
		{
			get
			{
				return Allors.Meta.MetaRequirementType.Instance;
			}
		}
		...
		public static RequirementType Instantiate (Allors.ISession allorsSession, string allorsObjectId)
		{
			return (RequirementType) allorsSession.Instantiate(allorsObjectId);		
		}
		...
		virtual public global::Allors.Extent<RequirementVersion> RequirementVersionsWhereRequirementType
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.RequirementVersionsWhereRequirementType.RelationType);
			}
		}

		virtual public bool ExistRequirementVersionsWhereRequirementType
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.RequirementVersionsWhereRequirementType.RelationType);
			}
		}


		virtual public global::Allors.Extent<Requirement> RequirementsWhereRequirementType
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.RequirementsWhereRequirementType.RelationType);
			}
		}

		virtual public bool ExistRequirementsWhereRequirementType
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.RequirementsWhereRequirementType.RelationType);
			}
		}
		...
		{ 
			var method = new RequirementTypeOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new RequirementTypeOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new RequirementTypeOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new RequirementTypeOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new RequirementTypeOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	public partial class RequirementTypeBuilder : Allors.ObjectBuilder<RequirementType> , EnumerationBuilder, global::System.IDisposable
	{		
		public RequirementTypeBuilder(Allors.ISession session) : base(session)
	    {
	    }

		protected override void OnBuild(RequirementType instance)
		{
			...
			if(this.SecurityTokens!=null)
			{
				...
				/// <exclude/>
				public RequirementTypeBuilder WithLocalisedName(LocalisedText value)
		        {
					if(this.LocalisedNames == null)
					{
				...
				/// <exclude/>
				public RequirementTypeBuilder WithName(global::System.String value)
		        {
				...
				/// <exclude/>
				public RequirementTypeBuilder WithIsActive(global::System.Boolean? value)
		        {
				...
				/// <exclude/>
				public RequirementTypeBuilder WithDeniedPermission(Permission value)
		        {
					if(this.DeniedPermissions == null)
					{
				...
				/// <exclude/>
				public RequirementTypeBuilder WithSecurityToken(SecurityToken value)
		        {
					if(this.SecurityTokens == null)
					{
				...
				/// <exclude/>
				public RequirementTypeBuilder WithUniqueId(global::System.Guid? value)
		        {
	...
	public partial class RequirementTypes : global::Allors.ObjectsBase<RequirementType>
	{
		public RequirementTypes(Allors.ISession session) : base(session)
		{
		}
