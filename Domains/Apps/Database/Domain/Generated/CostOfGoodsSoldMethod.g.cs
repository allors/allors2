...
{
	public partial class CostOfGoodsSoldMethod : Allors.IObject , Enumeration
	{
		private readonly IStrategy strategy;

		public CostOfGoodsSoldMethod(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaCostOfGoodsSoldMethod Meta
		{
			get
			{
				return Allors.Meta.MetaCostOfGoodsSoldMethod.Instance;
			}
		}
		...
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.InternalOrganisationsWhereCostOfGoodsSoldMethod.RelationType);
			}
		}
		...
		virtual public bool ExistInternalOrganisationsWhereCostOfGoodsSoldMethod
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.InternalOrganisationsWhereCostOfGoodsSoldMethod.RelationType);
			}
		}
		...
		{ 
			var method = new CostOfGoodsSoldMethodOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new CostOfGoodsSoldMethodOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new CostOfGoodsSoldMethodOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new CostOfGoodsSoldMethodOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new CostOfGoodsSoldMethodOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	{		
		...
		protected override void OnBuild(CostOfGoodsSoldMethod instance)
		{
