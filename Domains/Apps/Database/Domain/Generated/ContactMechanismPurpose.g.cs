...
{
	public partial class ContactMechanismPurpose : Allors.IObject , Enumeration
	{
		private readonly IStrategy strategy;

		public ContactMechanismPurpose(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaContactMechanismPurpose Meta
		{
			get
			{
				return Allors.Meta.MetaContactMechanismPurpose.Instance;
			}
		}
		...
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.PartyContactMechanismsWhereContactPurpose.RelationType);
			}
		}
		...
		virtual public bool ExistPartyContactMechanismsWhereContactPurpose
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.PartyContactMechanismsWhereContactPurpose.RelationType);
			}
		}
		...
		public ContactMechanismPurposeDelete Delete()
		{ 
			var method = new ContactMechanismPurposeDelete(this);
            method.Execute();
            return method;
		}

		public ContactMechanismPurposeDelete Delete(System.Action<ContactMechanismPurposeDelete> action)
		{ 
			var method = new ContactMechanismPurposeDelete(this);
            action(method);
            method.Execute();
		...
		{ 
			var method = new ContactMechanismPurposeOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new ContactMechanismPurposeOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new ContactMechanismPurposeOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new ContactMechanismPurposeOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new ContactMechanismPurposeOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	{		
		...
		protected override void OnBuild(ContactMechanismPurpose instance)
		{
