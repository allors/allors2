...
{
	public partial class VatRateUsage : Allors.IObject , Enumeration
	{
		private readonly IStrategy strategy;

		public VatRateUsage(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaVatRateUsage Meta
		{
			get
			{
				return Allors.Meta.MetaVatRateUsage.Instance;
			}
		}
		...
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.VatRatesWhereVatRateUsage.RelationType);
			}
		}
		...
		virtual public bool ExistVatRatesWhereVatRateUsage
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.VatRatesWhereVatRateUsage.RelationType);
			}
		}
		...
		{ 
			var method = new VatRateUsageOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new VatRateUsageOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new VatRateUsageOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new VatRateUsageOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new VatRateUsageOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	{		
		...
		protected override void OnBuild(VatRateUsage instance)
		{
