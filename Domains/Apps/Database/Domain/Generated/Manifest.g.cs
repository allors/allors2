...
{
	public partial class Manifest : Allors.IObject , Document
	{
		private readonly IStrategy strategy;

		public Manifest(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaManifest Meta
		{
			get
			{
				return Allors.Meta.MetaManifest.Instance;
			}
		}
		...
		{ 
			var method = new ManifestOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new ManifestOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new ManifestOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new ManifestOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new ManifestOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	{		
		...
		protected override void OnBuild(Manifest instance)
		{
