...
{
	public partial class OrganisationUnit : Allors.IObject , Enumeration
	{
		private readonly IStrategy strategy;

		public OrganisationUnit(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaOrganisationUnit Meta
		{
			get
			{
				return Allors.Meta.MetaOrganisationUnit.Instance;
			}
		}
		...
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.OrganisationRollUpsWhereRollupKind.RelationType);
			}
		}
		...
		virtual public bool ExistOrganisationRollUpsWhereRollupKind
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.OrganisationRollUpsWhereRollupKind.RelationType);
			}
		}
		...
		public OrganisationUnitDelete Delete()
		{ 
			var method = new OrganisationUnitDelete(this);
            method.Execute();
            return method;
		}

		public OrganisationUnitDelete Delete(System.Action<OrganisationUnitDelete> action)
		{ 
			var method = new OrganisationUnitDelete(this);
            action(method);
            method.Execute();
		...
		{ 
			var method = new OrganisationUnitOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new OrganisationUnitOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new OrganisationUnitOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new OrganisationUnitOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new OrganisationUnitOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	{		
		...
		protected override void OnBuild(OrganisationUnit instance)
		{
