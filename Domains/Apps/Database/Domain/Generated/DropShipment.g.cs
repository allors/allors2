...
{
	public partial class DropShipment : Allors.IObject , Shipment, Versioned
	{
		private readonly IStrategy strategy;

		public DropShipment(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaDropShipment Meta
		{
			get
			{
				return Allors.Meta.MetaDropShipment.Instance;
			}
		}
		...
		virtual public DropShipmentState PreviousDropShipmentState
		{ 
			get
			{
				return (DropShipmentState) Strategy.GetCompositeRole(Meta.PreviousDropShipmentState.RelationType);
			}
			set
			{
				Strategy.SetCompositeRole(Meta.PreviousDropShipmentState.RelationType, value);
			}
		}

		virtual public bool ExistPreviousDropShipmentState
		{
			get
			{
				return Strategy.ExistCompositeRole(Meta.PreviousDropShipmentState.RelationType);
			}
		}

		virtual public void RemovePreviousDropShipmentState()
		{
			Strategy.RemoveCompositeRole(Meta.PreviousDropShipmentState.RelationType);
		}


		virtual public DropShipmentState LastDropShipmentState
		{ 
			get
			{
				return (DropShipmentState) Strategy.GetCompositeRole(Meta.LastDropShipmentState.RelationType);
			}
			set
			{
				Strategy.SetCompositeRole(Meta.LastDropShipmentState.RelationType, value);
			}
		}

		virtual public bool ExistLastDropShipmentState
		{
			get
			{
				return Strategy.ExistCompositeRole(Meta.LastDropShipmentState.RelationType);
			}
		}

		virtual public void RemoveLastDropShipmentState()
		{
			Strategy.RemoveCompositeRole(Meta.LastDropShipmentState.RelationType);
		}
		...
		virtual public DropShipmentVersion CurrentVersion
		{ 
			get
			{
				return (DropShipmentVersion) Strategy.GetCompositeRole(Meta.CurrentVersion.RelationType);
			}
			set
			{
		...
		virtual public global::Allors.Extent<DropShipmentVersion> AllVersions
		{ 
			get
			{
		...
		virtual public void AddAllVersion (DropShipmentVersion value)
		{
			Strategy.AddCompositeRole(Meta.AllVersions.RelationType, value);
		}

		virtual public void RemoveAllVersion (DropShipmentVersion value)
		{
		...
		{ 
			var method = new DropShipmentOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new DropShipmentOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new DropShipmentOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new DropShipmentOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new DropShipmentOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	public partial class DropShipmentBuilder : Allors.ObjectBuilder<DropShipment> , ShipmentBuilder, VersionedBuilder, global::System.IDisposable
	{		
		public DropShipmentBuilder(Allors.ISession session) : base(session)
	    {
	    }

		protected override void OnBuild(DropShipment instance)
		{
			...
			if(this.SecurityTokens!=null)
			{
				...
				/// <exclude/>
				public DropShipmentBuilder WithDropShipmentState(DropShipmentState value)
		        {
				...
				/// <exclude/>
				public DropShipmentBuilder WithCurrentVersion(DropShipmentVersion value)
		        {
				...
				public global::System.Collections.Generic.List<DropShipmentVersion> AllVersions {get; set;}	

				/// <exclude/>
				public DropShipmentBuilder WithAllVersion(DropShipmentVersion value)
		        {
					if(this.AllVersions == null)
					{
						this.AllVersions = new global::System.Collections.Generic.List<DropShipmentVersion>(); 
					}
				...
				/// <exclude/>
				public DropShipmentBuilder WithComment(global::System.String value)
		        {
				...
				/// <exclude/>
				public DropShipmentBuilder WithCreatedBy(User value)
		        {
				...
				/// <exclude/>
				public DropShipmentBuilder WithLastModifiedBy(User value)
		        {
				...
				/// <exclude/>
				public DropShipmentBuilder WithCreationDate(global::System.DateTime? value)
		        {
				...
				/// <exclude/>
				public DropShipmentBuilder WithLastModifiedDate(global::System.DateTime? value)
		        {
