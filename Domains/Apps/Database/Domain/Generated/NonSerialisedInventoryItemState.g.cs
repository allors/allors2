...
{
	public partial class NonSerialisedInventoryItemState : Allors.IObject , ObjectState
	{
		private readonly IStrategy strategy;

		public NonSerialisedInventoryItemState(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaNonSerialisedInventoryItemState Meta
		{
			get
			{
				return Allors.Meta.MetaNonSerialisedInventoryItemState.Instance;
			}
		}
		...
		public static NonSerialisedInventoryItemState Instantiate (Allors.ISession allorsSession, string allorsObjectId)
		{
			return (NonSerialisedInventoryItemState) allorsSession.Instantiate(allorsObjectId);		
		}
		...
		virtual public global::Allors.Extent<NonSerialisedInventoryItem> NonSerialisedInventoryItemsWherePreviousNonSerialisedInventoryItemState
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.NonSerialisedInventoryItemsWherePreviousNonSerialisedInventoryItemState.RelationType);
			}
		}

		virtual public bool ExistNonSerialisedInventoryItemsWherePreviousNonSerialisedInventoryItemState
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.NonSerialisedInventoryItemsWherePreviousNonSerialisedInventoryItemState.RelationType);
			}
		}


		virtual public global::Allors.Extent<NonSerialisedInventoryItem> NonSerialisedInventoryItemsWhereLastNonSerialisedInventoryItemState
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.NonSerialisedInventoryItemsWhereLastNonSerialisedInventoryItemState.RelationType);
			}
		}

		virtual public bool ExistNonSerialisedInventoryItemsWhereLastNonSerialisedInventoryItemState
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.NonSerialisedInventoryItemsWhereLastNonSerialisedInventoryItemState.RelationType);
			}
		}


		virtual public global::Allors.Extent<NonSerialisedInventoryItem> NonSerialisedInventoryItemsWhereNonSerialisedInventoryItemState
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.NonSerialisedInventoryItemsWhereNonSerialisedInventoryItemState.RelationType);
			}
		}

		virtual public bool ExistNonSerialisedInventoryItemsWhereNonSerialisedInventoryItemState
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.NonSerialisedInventoryItemsWhereNonSerialisedInventoryItemState.RelationType);
			}
		}


		virtual public global::Allors.Extent<NonSerialisedInventoryItemVersion> NonSerialisedInventoryItemVersionsWhereNonSerialisedInventoryItemState
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.NonSerialisedInventoryItemVersionsWhereNonSerialisedInventoryItemState.RelationType);
			}
		}

		virtual public bool ExistNonSerialisedInventoryItemVersionsWhereNonSerialisedInventoryItemState
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.NonSerialisedInventoryItemVersionsWhereNonSerialisedInventoryItemState.RelationType);
			}
		}
		...
		{ 
			var method = new NonSerialisedInventoryItemStateOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new NonSerialisedInventoryItemStateOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new NonSerialisedInventoryItemStateOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new NonSerialisedInventoryItemStateOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new NonSerialisedInventoryItemStateOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	public partial class NonSerialisedInventoryItemStateBuilder : Allors.ObjectBuilder<NonSerialisedInventoryItemState> , ObjectStateBuilder, global::System.IDisposable
	{		
		public NonSerialisedInventoryItemStateBuilder(Allors.ISession session) : base(session)
	    {
	    }

		protected override void OnBuild(NonSerialisedInventoryItemState instance)
		{
			...
			if(this.DeniedPermissions!=null)
			{
				...
				/// <exclude/>
				public NonSerialisedInventoryItemStateBuilder WithDeniedPermission(Permission value)
		        {
					if(this.DeniedPermissions == null)
					{
				...
				/// <exclude/>
				public NonSerialisedInventoryItemStateBuilder WithName(global::System.String value)
		        {
				...
				/// <exclude/>
				public NonSerialisedInventoryItemStateBuilder WithUniqueId(global::System.Guid? value)
		        {
	...
	public partial class NonSerialisedInventoryItemStates : global::Allors.ObjectsBase<NonSerialisedInventoryItemState>
	{
		public NonSerialisedInventoryItemStates(Allors.ISession session) : base(session)
		{
		}
