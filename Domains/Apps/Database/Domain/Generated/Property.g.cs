...
{
	public partial class Property : Allors.IObject , FixedAsset
	{
		private readonly IStrategy strategy;

		public Property(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaProperty Meta
		{
			get
			{
				return Allors.Meta.MetaProperty.Instance;
			}
		}
		...
		{ 
			var method = new PropertyOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new PropertyOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new PropertyOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new PropertyOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new PropertyOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	{		
		...
		protected override void OnBuild(Property instance)
		{
