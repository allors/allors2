...
{
	public partial class PayCheck : Allors.IObject , Payment
	{
		private readonly IStrategy strategy;

		public PayCheck(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaPayCheck Meta
		{
			get
			{
				return Allors.Meta.MetaPayCheck.Instance;
			}
		}
		...
		{ 
			get
			{
				return Strategy.GetCompositeRoles(Meta.Deductions.RelationType);
			}
			set
			{
				Strategy.SetCompositeRoles(Meta.Deductions.RelationType, value);
			}
		}

		virtual public void AddDeduction (Deduction value)
		{
			Strategy.AddCompositeRole(Meta.Deductions.RelationType, value);
		}

		virtual public void RemoveDeduction (Deduction value)
		{
			Strategy.RemoveCompositeRole(Meta.Deductions.RelationType, value);
		}
		...
		virtual public bool ExistDeductions
		{
			get
			{
				return Strategy.ExistCompositeRoles(Meta.Deductions.RelationType);
			}
		}

		virtual public void RemoveDeductions()
		{
			Strategy.RemoveCompositeRoles(Meta.Deductions.RelationType);
		}
		...
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.PerformanceReviewsWhereBonusPayCheck.RelationType);
			}
		}
		...
		virtual public bool ExistPerformanceReviewsWhereBonusPayCheck
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.PerformanceReviewsWhereBonusPayCheck.RelationType);
			}
		}
		...
		{ 
			var method = new PayCheckOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new PayCheckOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new PayCheckOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new PayCheckOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new PayCheckOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	{		
		...
		protected override void OnBuild(PayCheck instance)
		{
			...
			{
				instance.Deductions = this.Deductions.ToArray();
			}
