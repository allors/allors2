...
{
	public partial class SkillLevel : Allors.IObject , Enumeration
	{
		private readonly IStrategy strategy;

		public SkillLevel(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaSkillLevel Meta
		{
			get
			{
				return Allors.Meta.MetaSkillLevel.Instance;
			}
		}
		...
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.NeededSkillsWhereSkillLevel.RelationType);
			}
		}
		...
		virtual public bool ExistNeededSkillsWhereSkillLevel
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.NeededSkillsWhereSkillLevel.RelationType);
			}
		}
		...
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.PartySkillsWhereSkillLevel.RelationType);
			}
		}
		...
		virtual public bool ExistPartySkillsWhereSkillLevel
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.PartySkillsWhereSkillLevel.RelationType);
			}
		}
		...
		public SkillLevelDelete Delete()
		{ 
			var method = new SkillLevelDelete(this);
            method.Execute();
            return method;
		}

		public SkillLevelDelete Delete(System.Action<SkillLevelDelete> action)
		{ 
			var method = new SkillLevelDelete(this);
            action(method);
            method.Execute();
		...
		{ 
			var method = new SkillLevelOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new SkillLevelOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new SkillLevelOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new SkillLevelOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new SkillLevelOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	{		
		...
		protected override void OnBuild(SkillLevel instance)
		{
