...
{
	public partial class ProposalVersion : Allors.IObject , QuoteVersion
	{
		private readonly IStrategy strategy;

		public ProposalVersion(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaProposalVersion Meta
		{
			get
			{
				return Allors.Meta.MetaProposalVersion.Instance;
			}
		}
		...
		public static ProposalVersion Instantiate (Allors.ISession allorsSession, string allorsObjectId)
		{
			return (ProposalVersion) allorsSession.Instantiate(allorsObjectId);		
		}
		...
		virtual public Proposal ProposalWhereCurrentVersion
		{ 
			get
			{
				return (Proposal) Strategy.GetCompositeAssociation(Meta.ProposalWhereCurrentVersion.RelationType);
			}
		} 

		virtual public bool ExistProposalWhereCurrentVersion
		{
			get
			{
				return Strategy.ExistCompositeAssociation(Meta.ProposalWhereCurrentVersion.RelationType);
			}
		}


		virtual public Proposal ProposalWhereAllVersion
		{ 
			get
			{
				return (Proposal) Strategy.GetCompositeAssociation(Meta.ProposalWhereAllVersion.RelationType);
			}
		} 

		virtual public bool ExistProposalWhereAllVersion
		{
			get
			{
				return Strategy.ExistCompositeAssociation(Meta.ProposalWhereAllVersion.RelationType);
			}
		}
		...
		{ 
			var method = new ProposalVersionOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new ProposalVersionOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new ProposalVersionOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new ProposalVersionOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new ProposalVersionOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	public partial class ProposalVersionBuilder : Allors.ObjectBuilder<ProposalVersion> , QuoteVersionBuilder, global::System.IDisposable
	{		
		public ProposalVersionBuilder(Allors.ISession session) : base(session)
	    {
	    }

		protected override void OnBuild(ProposalVersion instance)
		{
			...
			if(this.SecurityTokens!=null)
			{
				...
				/// <exclude/>
				public ProposalVersionBuilder WithQuoteState(QuoteState value)
		        {
				...
				/// <exclude/>
				public ProposalVersionBuilder WithInternalComment(global::System.String value)
		        {
				...
				/// <exclude/>
				public ProposalVersionBuilder WithRequiredResponseDate(global::System.DateTime? value)
		        {
				...
				/// <exclude/>
				public ProposalVersionBuilder WithValidFromDate(global::System.DateTime? value)
		        {
				...
				/// <exclude/>
				public ProposalVersionBuilder WithQuoteTerm(QuoteTerm value)
		        {
					if(this.QuoteTerms == null)
					{
				...
				/// <exclude/>
				public ProposalVersionBuilder WithValidThroughDate(global::System.DateTime? value)
		        {
				...
				/// <exclude/>
				public ProposalVersionBuilder WithDescription(global::System.String value)
		        {
				...
				/// <exclude/>
				public ProposalVersionBuilder WithReceiver(Party value)
		        {
				...
				/// <exclude/>
				public ProposalVersionBuilder WithFullfillContactMechanism(ContactMechanism value)
		        {
				...
				/// <exclude/>
				public ProposalVersionBuilder WithPrice(global::System.Decimal? value)
		        {
				...
				/// <exclude/>
				public ProposalVersionBuilder WithCurrency(Currency value)
		        {
				...
				/// <exclude/>
				public ProposalVersionBuilder WithIssueDate(global::System.DateTime? value)
		        {
				...
				/// <exclude/>
				public ProposalVersionBuilder WithQuoteItem(QuoteItem value)
		        {
					if(this.QuoteItems == null)
					{
				...
				/// <exclude/>
				public ProposalVersionBuilder WithQuoteNumber(global::System.String value)
		        {
				...
				/// <exclude/>
				public ProposalVersionBuilder WithRequest(Request value)
		        {
				...
				/// <exclude/>
				public ProposalVersionBuilder WithDerivationId(global::System.Guid? value)
		        {
				...
				/// <exclude/>
				public ProposalVersionBuilder WithDerivationTimeStamp(global::System.DateTime? value)
		        {
				...
				/// <exclude/>
				public ProposalVersionBuilder WithDeniedPermission(Permission value)
		        {
					if(this.DeniedPermissions == null)
					{
				...
				/// <exclude/>
				public ProposalVersionBuilder WithSecurityToken(SecurityToken value)
		        {
					if(this.SecurityTokens == null)
					{
	...
	public partial class ProposalVersions : global::Allors.ObjectsBase<ProposalVersion>
	{
		public ProposalVersions(Allors.ISession session) : base(session)
		{
		}
