...
{
	public partial class TaxDocument : Allors.IObject , Document
	{
		private readonly IStrategy strategy;

		public TaxDocument(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaTaxDocument Meta
		{
			get
			{
				return Allors.Meta.MetaTaxDocument.Instance;
			}
		}
		...
		{ 
			var method = new TaxDocumentOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new TaxDocumentOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new TaxDocumentOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new TaxDocumentOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new TaxDocumentOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	{		
		...
		protected override void OnBuild(TaxDocument instance)
		{
