...
{
	public partial class JournalType : Allors.IObject , Enumeration
	{
		private readonly IStrategy strategy;

		public JournalType(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaJournalType Meta
		{
			get
			{
				return Allors.Meta.MetaJournalType.Instance;
			}
		}
		...
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.JournalsWhereJournalType.RelationType);
			}
		}
		...
		virtual public bool ExistJournalsWhereJournalType
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.JournalsWhereJournalType.RelationType);
			}
		}
		...
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.JournalsWherePreviousJournalType.RelationType);
			}
		}
		...
		virtual public bool ExistJournalsWherePreviousJournalType
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.JournalsWherePreviousJournalType.RelationType);
			}
		}
		...
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.JournalEntryNumbersWhereJournalType.RelationType);
			}
		}
		...
		virtual public bool ExistJournalEntryNumbersWhereJournalType
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.JournalEntryNumbersWhereJournalType.RelationType);
			}
		}
		...
		{ 
			var method = new JournalTypeOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new JournalTypeOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new JournalTypeOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new JournalTypeOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new JournalTypeOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	{		
		...
		protected override void OnBuild(JournalType instance)
		{
