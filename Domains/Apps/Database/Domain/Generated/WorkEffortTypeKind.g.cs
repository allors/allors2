...
{
	public partial class WorkEffortTypeKind : Allors.IObject , Enumeration
	{
		private readonly IStrategy strategy;

		public WorkEffortTypeKind(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaWorkEffortTypeKind Meta
		{
			get
			{
				return Allors.Meta.MetaWorkEffortTypeKind.Instance;
			}
		}
		...
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.WorkEffortTypesWhereWorkEffortTypeKind.RelationType);
			}
		}
		...
		virtual public bool ExistWorkEffortTypesWhereWorkEffortTypeKind
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.WorkEffortTypesWhereWorkEffortTypeKind.RelationType);
			}
		}
		...
		{ 
			var method = new WorkEffortTypeKindOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new WorkEffortTypeKindOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new WorkEffortTypeKindOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new WorkEffortTypeKindOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new WorkEffortTypeKindOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	{		
		...
		protected override void OnBuild(WorkEffortTypeKind instance)
		{
