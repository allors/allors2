...
{
	public partial class Note : Allors.IObject , ExternalAccountingTransaction
	{
		private readonly IStrategy strategy;

		public Note(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaNote Meta
		{
			get
			{
				return Allors.Meta.MetaNote.Instance;
			}
		}
		...
		{ 
			var method = new NoteOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new NoteOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new NoteOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new NoteOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new NoteOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	{		
		...
		protected override void OnBuild(Note instance)
		{
