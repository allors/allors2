...
{
	public partial class AccountingTransactionType : Allors.IObject , Enumeration
	{
		private readonly IStrategy strategy;

		public AccountingTransactionType(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaAccountingTransactionType Meta
		{
			get
			{
				return Allors.Meta.MetaAccountingTransactionType.Instance;
			}
		}
		...
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.AccountingTransactionNumbersWhereAccountingTransactionType.RelationType);
			}
		}
		...
		virtual public bool ExistAccountingTransactionNumbersWhereAccountingTransactionType
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.AccountingTransactionNumbersWhereAccountingTransactionType.RelationType);
			}
		}
		...
		{ 
			var method = new AccountingTransactionTypeOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new AccountingTransactionTypeOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new AccountingTransactionTypeOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new AccountingTransactionTypeOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new AccountingTransactionTypeOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	{		
		...
		protected override void OnBuild(AccountingTransactionType instance)
		{
