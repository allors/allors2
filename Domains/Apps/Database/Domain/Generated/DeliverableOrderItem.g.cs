...
{
	public partial class DeliverableOrderItem : Allors.IObject , EngagementItem
	{
		private readonly IStrategy strategy;

		public DeliverableOrderItem(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaDeliverableOrderItem Meta
		{
			get
			{
				return Allors.Meta.MetaDeliverableOrderItem.Instance;
			}
		}
		...
		{ 
			var method = new DeliverableOrderItemOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new DeliverableOrderItemOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new DeliverableOrderItemOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new DeliverableOrderItemOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new DeliverableOrderItemOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	{		
		...
		protected override void OnBuild(DeliverableOrderItem instance)
		{
