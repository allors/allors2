...
{
	public partial class RequestForQuote : Allors.IObject , Request, Versioned
	{
		private readonly IStrategy strategy;

		public RequestForQuote(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaRequestForQuote Meta
		{
			get
			{
				return Allors.Meta.MetaRequestForQuote.Instance;
			}
		}
		...
		virtual public RequestForQuoteVersion CurrentVersion
		{ 
			get
			{
				return (RequestForQuoteVersion) Strategy.GetCompositeRole(Meta.CurrentVersion.RelationType);
			}
			set
			{
		...
		virtual public global::Allors.Extent<RequestForQuoteVersion> AllVersions
		{ 
			get
			{
		...
		virtual public void AddAllVersion (RequestForQuoteVersion value)
		{
			Strategy.AddCompositeRole(Meta.AllVersions.RelationType, value);
		}

		virtual public void RemoveAllVersion (RequestForQuoteVersion value)
		{
		...
		public RequestForQuoteCreateQuote CreateQuote()
		{ 
			var method = new RequestForQuoteCreateQuote(this);
            method.Execute();
            return method;
		}

		public RequestForQuoteCreateQuote CreateQuote(System.Action<RequestForQuoteCreateQuote> action)
		{ 
			var method = new RequestForQuoteCreateQuote(this);
            action(method);
            method.Execute();
		...
		{ 
			var method = new RequestForQuoteCancel(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new RequestForQuoteReject(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new RequestForQuoteSubmit(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new RequestForQuoteHold(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new RequestForQuoteOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new RequestForQuoteOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new RequestForQuoteOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new RequestForQuoteOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new RequestForQuoteOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	public partial class RequestForQuoteBuilder : Allors.ObjectBuilder<RequestForQuote> , RequestBuilder, VersionedBuilder, global::System.IDisposable
	{		
		public RequestForQuoteBuilder(Allors.ISession session) : base(session)
	    {
	    }

		protected override void OnBuild(RequestForQuote instance)
		{
			...
			instance.LastModifiedBy = this.LastModifiedBy;
				...
				/// <exclude/>
				public RequestForQuoteBuilder WithCurrentVersion(RequestForQuoteVersion value)
		        {
				...
				public global::System.Collections.Generic.List<RequestForQuoteVersion> AllVersions {get; set;}	

				/// <exclude/>
				public RequestForQuoteBuilder WithAllVersion(RequestForQuoteVersion value)
		        {
					if(this.AllVersions == null)
					{
						this.AllVersions = new global::System.Collections.Generic.List<RequestForQuoteVersion>(); 
					}
				...
				/// <exclude/>
				public RequestForQuoteBuilder WithRequestState(RequestState value)
		        {
				...
				/// <exclude/>
				public RequestForQuoteBuilder WithInternalComment(global::System.String value)
		        {
				...
				/// <exclude/>
				public RequestForQuoteBuilder WithRequestDate(global::System.DateTime? value)
		        {
				...
				/// <exclude/>
				public RequestForQuoteBuilder WithCurrency(Currency value)
		        {
				...
				/// <exclude/>
				public RequestForQuoteBuilder WithFullfillContactMechanism(ContactMechanism value)
		        {
				...
				/// <exclude/>
				public RequestForQuoteBuilder WithEmailAddress(global::System.String value)
		        {
				...
				/// <exclude/>
				public RequestForQuoteBuilder WithTelephoneNumber(global::System.String value)
		        {
				...
				/// <exclude/>
				public RequestForQuoteBuilder WithTelephoneCountryCode(global::System.String value)
		        {
				...
				/// <exclude/>
				public RequestForQuoteBuilder WithContactPerson(Person value)
		        {
				...
				/// <exclude/>
				public RequestForQuoteBuilder WithCreatedBy(User value)
		        {
				...
				/// <exclude/>
				public RequestForQuoteBuilder WithLastModifiedBy(User value)
		        {
				...
				/// <exclude/>
				public RequestForQuoteBuilder WithCreationDate(global::System.DateTime? value)
		        {
				...
				/// <exclude/>
				public RequestForQuoteBuilder WithLastModifiedDate(global::System.DateTime? value)
		        {
				...
				/// <exclude/>
				public RequestForQuoteBuilder WithPrintContent(global::System.String value)
		        {
