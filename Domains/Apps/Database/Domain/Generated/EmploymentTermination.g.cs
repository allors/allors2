...
{
	public partial class EmploymentTermination : Allors.IObject , Enumeration
	{
		private readonly IStrategy strategy;

		public EmploymentTermination(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaEmploymentTermination Meta
		{
			get
			{
				return Allors.Meta.MetaEmploymentTermination.Instance;
			}
		}
		...
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.EmploymentsWhereEmploymentTermination.RelationType);
			}
		}
		...
		virtual public bool ExistEmploymentsWhereEmploymentTermination
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.EmploymentsWhereEmploymentTermination.RelationType);
			}
		}
		...
		public EmploymentTerminationDelete Delete()
		{ 
			var method = new EmploymentTerminationDelete(this);
            method.Execute();
            return method;
		}

		public EmploymentTerminationDelete Delete(System.Action<EmploymentTerminationDelete> action)
		{ 
			var method = new EmploymentTerminationDelete(this);
            action(method);
            method.Execute();
		...
		{ 
			var method = new EmploymentTerminationOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new EmploymentTerminationOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new EmploymentTerminationOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new EmploymentTerminationOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new EmploymentTerminationOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	public partial class EmploymentTerminationBuilder : Allors.ObjectBuilder<EmploymentTermination> , EnumerationBuilder, global::System.IDisposable
	{		
		public EmploymentTerminationBuilder(Allors.ISession session) : base(session)
	    {
	    }

		protected override void OnBuild(EmploymentTermination instance)
		{
