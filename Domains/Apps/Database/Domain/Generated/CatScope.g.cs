...
{
	public partial class CatScope : Allors.IObject , Enumeration
	{
		private readonly IStrategy strategy;

		public CatScope(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaCatScope Meta
		{
			get
			{
				return Allors.Meta.MetaCatScope.Instance;
			}
		}
		...
		public static CatScope Instantiate (Allors.ISession allorsSession, string allorsObjectId)
		{
			return (CatScope) allorsSession.Instantiate(allorsObjectId);		
		}
		...
		virtual public global::Allors.Extent<Catalogue> CataloguesWhereCatScope
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.CataloguesWhereCatScope.RelationType);
			}
		}

		virtual public bool ExistCataloguesWhereCatScope
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.CataloguesWhereCatScope.RelationType);
			}
		}


		virtual public global::Allors.Extent<ProductCategory> ProductCategoriesWhereCatScope
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.ProductCategoriesWhereCatScope.RelationType);
			}
		}

		virtual public bool ExistProductCategoriesWhereCatScope
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.ProductCategoriesWhereCatScope.RelationType);
			}
		}
		...
		{ 
			var method = new CatScopeOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new CatScopeOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new CatScopeOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new CatScopeOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new CatScopeOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	public partial class CatScopeBuilder : Allors.ObjectBuilder<CatScope> , EnumerationBuilder, global::System.IDisposable
	{		
		public CatScopeBuilder(Allors.ISession session) : base(session)
	    {
	    }

		protected override void OnBuild(CatScope instance)
		{
			...
			if(this.SecurityTokens!=null)
			{
				...
				/// <exclude/>
				public CatScopeBuilder WithLocalisedName(LocalisedText value)
		        {
					if(this.LocalisedNames == null)
					{
				...
				/// <exclude/>
				public CatScopeBuilder WithName(global::System.String value)
		        {
				...
				/// <exclude/>
				public CatScopeBuilder WithIsActive(global::System.Boolean? value)
		        {
				...
				/// <exclude/>
				public CatScopeBuilder WithDeniedPermission(Permission value)
		        {
					if(this.DeniedPermissions == null)
					{
				...
				/// <exclude/>
				public CatScopeBuilder WithSecurityToken(SecurityToken value)
		        {
					if(this.SecurityTokens == null)
					{
				...
				/// <exclude/>
				public CatScopeBuilder WithUniqueId(global::System.Guid? value)
		        {
	...
	public partial class CatScopes : global::Allors.ObjectsBase<CatScope>
	{
		public CatScopes(Allors.ISession session) : base(session)
		{
		}
