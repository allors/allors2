...
{
	public partial class CustomerReturn : Allors.IObject , Shipment, Versioned
	{
		private readonly IStrategy strategy;

		public CustomerReturn(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaCustomerReturn Meta
		{
			get
			{
				return Allors.Meta.MetaCustomerReturn.Instance;
			}
		}
		...
		virtual public CustomerReturnState PreviousCustomerReturnState
		{ 
			get
			{
				return (CustomerReturnState) Strategy.GetCompositeRole(Meta.PreviousCustomerReturnState.RelationType);
			}
			set
			{
				Strategy.SetCompositeRole(Meta.PreviousCustomerReturnState.RelationType, value);
			}
		}

		virtual public bool ExistPreviousCustomerReturnState
		{
			get
			{
				return Strategy.ExistCompositeRole(Meta.PreviousCustomerReturnState.RelationType);
			}
		}

		virtual public void RemovePreviousCustomerReturnState()
		{
			Strategy.RemoveCompositeRole(Meta.PreviousCustomerReturnState.RelationType);
		}


		virtual public CustomerReturnState LastCustomerReturnState
		{ 
			get
			{
				return (CustomerReturnState) Strategy.GetCompositeRole(Meta.LastCustomerReturnState.RelationType);
			}
			set
			{
				Strategy.SetCompositeRole(Meta.LastCustomerReturnState.RelationType, value);
			}
		}

		virtual public bool ExistLastCustomerReturnState
		{
			get
			{
				return Strategy.ExistCompositeRole(Meta.LastCustomerReturnState.RelationType);
			}
		}

		virtual public void RemoveLastCustomerReturnState()
		{
			Strategy.RemoveCompositeRole(Meta.LastCustomerReturnState.RelationType);
		}
		...
		virtual public CustomerReturnVersion CurrentVersion
		{ 
			get
			{
				return (CustomerReturnVersion) Strategy.GetCompositeRole(Meta.CurrentVersion.RelationType);
			}
			set
			{
		...
		virtual public global::Allors.Extent<CustomerReturnVersion> AllVersions
		{ 
			get
			{
		...
		virtual public void AddAllVersion (CustomerReturnVersion value)
		{
			Strategy.AddCompositeRole(Meta.AllVersions.RelationType, value);
		}

		virtual public void RemoveAllVersion (CustomerReturnVersion value)
		{
		...
		{ 
			var method = new CustomerReturnOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new CustomerReturnOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new CustomerReturnOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new CustomerReturnOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new CustomerReturnOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	public partial class CustomerReturnBuilder : Allors.ObjectBuilder<CustomerReturn> , ShipmentBuilder, VersionedBuilder, global::System.IDisposable
	{		
		public CustomerReturnBuilder(Allors.ISession session) : base(session)
	    {
	    }

		protected override void OnBuild(CustomerReturn instance)
		{
			...
			if(this.SecurityTokens!=null)
			{
				...
				/// <exclude/>
				public CustomerReturnBuilder WithCustomerReturnState(CustomerReturnState value)
		        {
				...
				/// <exclude/>
				public CustomerReturnBuilder WithCurrentVersion(CustomerReturnVersion value)
		        {
				...
				public global::System.Collections.Generic.List<CustomerReturnVersion> AllVersions {get; set;}	

				/// <exclude/>
				public CustomerReturnBuilder WithAllVersion(CustomerReturnVersion value)
		        {
					if(this.AllVersions == null)
					{
						this.AllVersions = new global::System.Collections.Generic.List<CustomerReturnVersion>(); 
					}
				...
				/// <exclude/>
				public CustomerReturnBuilder WithComment(global::System.String value)
		        {
				...
				/// <exclude/>
				public CustomerReturnBuilder WithCreatedBy(User value)
		        {
				...
				/// <exclude/>
				public CustomerReturnBuilder WithLastModifiedBy(User value)
		        {
				...
				/// <exclude/>
				public CustomerReturnBuilder WithCreationDate(global::System.DateTime? value)
		        {
				...
				/// <exclude/>
				public CustomerReturnBuilder WithLastModifiedDate(global::System.DateTime? value)
		        {
