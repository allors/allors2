...
{
	public partial class RequestState : Allors.IObject , ObjectState
	{
		private readonly IStrategy strategy;

		public RequestState(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaRequestState Meta
		{
			get
			{
				return Allors.Meta.MetaRequestState.Instance;
			}
		}
		...
		public static RequestState Instantiate (Allors.ISession allorsSession, string allorsObjectId)
		{
			return (RequestState) allorsSession.Instantiate(allorsObjectId);		
		}
		...
		virtual public RequestVersion RequestVersionWhereRequestState
		{ 
			get
			{
				return (RequestVersion) Strategy.GetCompositeAssociation(Meta.RequestVersionWhereRequestState.RelationType);
			}
		} 

		virtual public bool ExistRequestVersionWhereRequestState
		{
			get
			{
				return Strategy.ExistCompositeAssociation(Meta.RequestVersionWhereRequestState.RelationType);
			}
		}


		virtual public global::Allors.Extent<Request> RequestsWherePreviousRequestState
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.RequestsWherePreviousRequestState.RelationType);
			}
		}

		virtual public bool ExistRequestsWherePreviousRequestState
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.RequestsWherePreviousRequestState.RelationType);
			}
		}


		virtual public global::Allors.Extent<Request> RequestsWhereLastRequestState
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.RequestsWhereLastRequestState.RelationType);
			}
		}

		virtual public bool ExistRequestsWhereLastRequestState
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.RequestsWhereLastRequestState.RelationType);
			}
		}


		virtual public global::Allors.Extent<Request> RequestsWhereRequestState
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.RequestsWhereRequestState.RelationType);
			}
		}

		virtual public bool ExistRequestsWhereRequestState
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.RequestsWhereRequestState.RelationType);
			}
		}
		...
		{ 
			var method = new RequestStateOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new RequestStateOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new RequestStateOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new RequestStateOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new RequestStateOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	public partial class RequestStateBuilder : Allors.ObjectBuilder<RequestState> , ObjectStateBuilder, global::System.IDisposable
	{		
		public RequestStateBuilder(Allors.ISession session) : base(session)
	    {
	    }

		protected override void OnBuild(RequestState instance)
		{
			...
			if(this.DeniedPermissions!=null)
			{
				...
				/// <exclude/>
				public RequestStateBuilder WithDeniedPermission(Permission value)
		        {
					if(this.DeniedPermissions == null)
					{
				...
				/// <exclude/>
				public RequestStateBuilder WithName(global::System.String value)
		        {
				...
				/// <exclude/>
				public RequestStateBuilder WithUniqueId(global::System.Guid? value)
		        {
	...
	public partial class RequestStates : global::Allors.ObjectsBase<RequestState>
	{
		public RequestStates(Allors.ISession session) : base(session)
		{
		}
