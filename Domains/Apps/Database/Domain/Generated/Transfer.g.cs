...
{
	public partial class Transfer : Allors.IObject , Shipment, Versioned
	{
		private readonly IStrategy strategy;

		public Transfer(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaTransfer Meta
		{
			get
			{
				return Allors.Meta.MetaTransfer.Instance;
			}
		}
		...
		virtual public TransferState PreviousTransferState
		{ 
			get
			{
				return (TransferState) Strategy.GetCompositeRole(Meta.PreviousTransferState.RelationType);
			}
			set
			{
				Strategy.SetCompositeRole(Meta.PreviousTransferState.RelationType, value);
			}
		}

		virtual public bool ExistPreviousTransferState
		{
			get
			{
				return Strategy.ExistCompositeRole(Meta.PreviousTransferState.RelationType);
			}
		}

		virtual public void RemovePreviousTransferState()
		{
			Strategy.RemoveCompositeRole(Meta.PreviousTransferState.RelationType);
		}


		virtual public TransferState LastTransferState
		{ 
			get
			{
				return (TransferState) Strategy.GetCompositeRole(Meta.LastTransferState.RelationType);
			}
			set
			{
				Strategy.SetCompositeRole(Meta.LastTransferState.RelationType, value);
			}
		}

		virtual public bool ExistLastTransferState
		{
			get
			{
				return Strategy.ExistCompositeRole(Meta.LastTransferState.RelationType);
			}
		}

		virtual public void RemoveLastTransferState()
		{
			Strategy.RemoveCompositeRole(Meta.LastTransferState.RelationType);
		}
		...
		virtual public TransferVersion CurrentVersion
		{ 
			get
			{
				return (TransferVersion) Strategy.GetCompositeRole(Meta.CurrentVersion.RelationType);
			}
			set
			{
		...
		virtual public global::Allors.Extent<TransferVersion> AllVersions
		{ 
			get
			{
		...
		virtual public void AddAllVersion (TransferVersion value)
		{
			Strategy.AddCompositeRole(Meta.AllVersions.RelationType, value);
		}

		virtual public void RemoveAllVersion (TransferVersion value)
		{
		...
		{ 
			var method = new TransferOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new TransferOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new TransferOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new TransferOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new TransferOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	public partial class TransferBuilder : Allors.ObjectBuilder<Transfer> , ShipmentBuilder, VersionedBuilder, global::System.IDisposable
	{		
		public TransferBuilder(Allors.ISession session) : base(session)
	    {
	    }

		protected override void OnBuild(Transfer instance)
		{
			...
			if(this.SecurityTokens!=null)
			{
				...
				/// <exclude/>
				public TransferBuilder WithTransferState(TransferState value)
		        {
				...
				/// <exclude/>
				public TransferBuilder WithCurrentVersion(TransferVersion value)
		        {
				...
				public global::System.Collections.Generic.List<TransferVersion> AllVersions {get; set;}	

				/// <exclude/>
				public TransferBuilder WithAllVersion(TransferVersion value)
		        {
					if(this.AllVersions == null)
					{
						this.AllVersions = new global::System.Collections.Generic.List<TransferVersion>(); 
					}
				...
				/// <exclude/>
				public TransferBuilder WithComment(global::System.String value)
		        {
				...
				/// <exclude/>
				public TransferBuilder WithCreatedBy(User value)
		        {
				...
				/// <exclude/>
				public TransferBuilder WithLastModifiedBy(User value)
		        {
				...
				/// <exclude/>
				public TransferBuilder WithCreationDate(global::System.DateTime? value)
		        {
				...
				/// <exclude/>
				public TransferBuilder WithLastModifiedDate(global::System.DateTime? value)
		        {
