...
{
	public partial class SoftwareFeature : Allors.IObject , ProductFeature, Enumeration
	{
		private readonly IStrategy strategy;

		public SoftwareFeature(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaSoftwareFeature Meta
		{
			get
			{
				return Allors.Meta.MetaSoftwareFeature.Instance;
			}
		}
		...
		public SoftwareFeatureDelete Delete()
		{ 
			var method = new SoftwareFeatureDelete(this);
            method.Execute();
            return method;
		}

		public SoftwareFeatureDelete Delete(System.Action<SoftwareFeatureDelete> action)
		{ 
			var method = new SoftwareFeatureDelete(this);
            action(method);
            method.Execute();
		...
		{ 
			var method = new SoftwareFeatureOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new SoftwareFeatureOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new SoftwareFeatureOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new SoftwareFeatureOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new SoftwareFeatureOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	{		
		...
		protected override void OnBuild(SoftwareFeature instance)
		{
