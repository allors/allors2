...
{
	public partial class RatingType : Allors.IObject , Enumeration
	{
		private readonly IStrategy strategy;

		public RatingType(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaRatingType Meta
		{
			get
			{
				return Allors.Meta.MetaRatingType.Instance;
			}
		}
		...
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.EngagementRatesWhereRatingType.RelationType);
			}
		}
		...
		virtual public bool ExistEngagementRatesWhereRatingType
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.EngagementRatesWhereRatingType.RelationType);
			}
		}
		...
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.PerformanceReviewItemsWhereRatingType.RelationType);
			}
		}
		...
		virtual public bool ExistPerformanceReviewItemsWhereRatingType
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.PerformanceReviewItemsWhereRatingType.RelationType);
			}
		}
		...
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.SupplierOfferingsWhereRating.RelationType);
			}
		}
		...
		virtual public bool ExistSupplierOfferingsWhereRating
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.SupplierOfferingsWhereRating.RelationType);
			}
		}
		...
		{ 
			var method = new RatingTypeOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new RatingTypeOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new RatingTypeOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new RatingTypeOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new RatingTypeOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	{		
		...
		protected override void OnBuild(RatingType instance)
		{
