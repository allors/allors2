...
{
	public partial class LetterCorrespondenceVersion : Allors.IObject , CommunicationEventVersion
	{
		private readonly IStrategy strategy;

		public LetterCorrespondenceVersion(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaLetterCorrespondenceVersion Meta
		{
			get
			{
				return Allors.Meta.MetaLetterCorrespondenceVersion.Instance;
			}
		}
		...
		public static LetterCorrespondenceVersion Instantiate (Allors.ISession allorsSession, string allorsObjectId)
		{
			return (LetterCorrespondenceVersion) allorsSession.Instantiate(allorsObjectId);		
		}
		...
		{ 
			get
			{
				return Strategy.GetCompositeRoles(Meta.PostalAddresses.RelationType);
			}
			set
			{
				Strategy.SetCompositeRoles(Meta.PostalAddresses.RelationType, value);
			}
		}

		virtual public void AddPostalAddress (PostalAddress value)
		{
			Strategy.AddCompositeRole(Meta.PostalAddresses.RelationType, value);
		}

		virtual public void RemovePostalAddress (PostalAddress value)
		{
			Strategy.RemoveCompositeRole(Meta.PostalAddresses.RelationType, value);
		}
		...
		virtual public bool ExistPostalAddresses
		{
			get
			{
				return Strategy.ExistCompositeRoles(Meta.PostalAddresses.RelationType);
			}
		}

		virtual public void RemovePostalAddresses()
		{
			Strategy.RemoveCompositeRoles(Meta.PostalAddresses.RelationType);
		}


		virtual public global::Allors.Extent<Party> Originators
		{ 
			get
			{
				return Strategy.GetCompositeRoles(Meta.Originators.RelationType);
			}
			set
			{
				Strategy.SetCompositeRoles(Meta.Originators.RelationType, value);
			}
		}

		virtual public void AddOriginator (Party value)
		{
			Strategy.AddCompositeRole(Meta.Originators.RelationType, value);
		}

		virtual public void RemoveOriginator (Party value)
		{
			Strategy.RemoveCompositeRole(Meta.Originators.RelationType, value);
		}

		virtual public bool ExistOriginators
		{
			get
			{
				return Strategy.ExistCompositeRoles(Meta.Originators.RelationType);
			}
		}

		virtual public void RemoveOriginators()
		{
			Strategy.RemoveCompositeRoles(Meta.Originators.RelationType);
		}
		...
		virtual public global::System.Boolean IncomingLetter 
		{
			get
			{
				return (global::System.Boolean) Strategy.GetUnitRole(Meta.IncomingLetter.RelationType);
			}
			set
			{
				Strategy.SetUnitRole(Meta.IncomingLetter.RelationType, value);
			}
		}

		virtual public bool ExistIncomingLetter{
			get
			{
				return Strategy.ExistUnitRole(Meta.IncomingLetter.RelationType);
			}
		}

		virtual public void RemoveIncomingLetter()
		{
			Strategy.RemoveUnitRole(Meta.IncomingLetter.RelationType);
		}
		...
		virtual public LetterCorrespondence LetterCorrespondenceWhereCurrentVersion
		{ 
			get
			{
				return (LetterCorrespondence) Strategy.GetCompositeAssociation(Meta.LetterCorrespondenceWhereCurrentVersion.RelationType);
			}
		} 

		virtual public bool ExistLetterCorrespondenceWhereCurrentVersion
		{
			get
			{
				return Strategy.ExistCompositeAssociation(Meta.LetterCorrespondenceWhereCurrentVersion.RelationType);
			}
		}


		virtual public LetterCorrespondence LetterCorrespondenceWhereAllVersion
		{ 
			get
			{
				return (LetterCorrespondence) Strategy.GetCompositeAssociation(Meta.LetterCorrespondenceWhereAllVersion.RelationType);
			}
		} 

		virtual public bool ExistLetterCorrespondenceWhereAllVersion
		{
			get
			{
				return Strategy.ExistCompositeAssociation(Meta.LetterCorrespondenceWhereAllVersion.RelationType);
			}
		}
		...
		{ 
			var method = new LetterCorrespondenceVersionOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new LetterCorrespondenceVersionOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new LetterCorrespondenceVersionOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new LetterCorrespondenceVersionOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new LetterCorrespondenceVersionOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	public partial class LetterCorrespondenceVersionBuilder : Allors.ObjectBuilder<LetterCorrespondenceVersion> , CommunicationEventVersionBuilder, global::System.IDisposable
	{		
		public LetterCorrespondenceVersionBuilder(Allors.ISession session) : base(session)
	    {
	    }

		protected override void OnBuild(LetterCorrespondenceVersion instance)
		{
			

			if(this.IncomingLetter.HasValue)
			{
				instance.IncomingLetter = this.IncomingLetter.Value;
			}			
			...
			{
				instance.PostalAddresses = this.PostalAddresses.ToArray();
			}
		
			if(this.Originators!=null)
			{
				instance.Originators = this.Originators.ToArray();
			}
			...
			if(this.SecurityTokens!=null)
			{
				...
				/// <exclude/>
				public LetterCorrespondenceVersionBuilder WithPostalAddress(PostalAddress value)
		        {
					if(this.PostalAddresses == null)
					{
				...
				public global::System.Collections.Generic.List<Party> Originators {get; set;}	

				/// <exclude/>
				public LetterCorrespondenceVersionBuilder WithOriginator(Party value)
		        {
					if(this.Originators == null)
					{
						this.Originators = new global::System.Collections.Generic.List<Party>(); 
					}
		            this.Originators.Add(value);
		            return this;
		        }		
				...
				/// <exclude/>
				public LetterCorrespondenceVersionBuilder WithReceiver(Party value)
		        {
					if(this.Receivers == null)
					{
				...
				public global::System.Boolean? IncomingLetter {get; set;}

				/// <exclude/>
				public LetterCorrespondenceVersionBuilder WithIncomingLetter(global::System.Boolean? value)
		        {
				    if(this.IncomingLetter!=null){throw new global::System.ArgumentException("One multicplicity");}
		            this.IncomingLetter = value;
		            return this;
		        }	
				...
				/// <exclude/>
				public LetterCorrespondenceVersionBuilder WithComment(global::System.String value)
		        {
				...
				/// <exclude/>
				public LetterCorrespondenceVersionBuilder WithCreatedBy(User value)
		        {
				...
				/// <exclude/>
				public LetterCorrespondenceVersionBuilder WithLastModifiedBy(User value)
		        {
				...
				/// <exclude/>
				public LetterCorrespondenceVersionBuilder WithCreationDate(global::System.DateTime? value)
		        {
				...
				/// <exclude/>
				public LetterCorrespondenceVersionBuilder WithLastModifiedDate(global::System.DateTime? value)
		        {
				...
				/// <exclude/>
				public LetterCorrespondenceVersionBuilder WithScheduledStart(global::System.DateTime? value)
		        {
				...
				/// <exclude/>
				public LetterCorrespondenceVersionBuilder WithContactMechanism(ContactMechanism value)
		        {
					if(this.ContactMechanisms == null)
					{
				...
				/// <exclude/>
				public LetterCorrespondenceVersionBuilder WithInitialScheduledStart(global::System.DateTime? value)
		        {
				...
				/// <exclude/>
				public LetterCorrespondenceVersionBuilder WithEventPurpose(CommunicationEventPurpose value)
		        {
					if(this.EventPurposes == null)
					{
				...
				/// <exclude/>
				public LetterCorrespondenceVersionBuilder WithScheduledEnd(global::System.DateTime? value)
		        {
				...
				/// <exclude/>
				public LetterCorrespondenceVersionBuilder WithActualEnd(global::System.DateTime? value)
		        {
				...
				/// <exclude/>
				public LetterCorrespondenceVersionBuilder WithWorkEffort(WorkEffort value)
		        {
					if(this.WorkEfforts == null)
					{
				...
				/// <exclude/>
				public LetterCorrespondenceVersionBuilder WithDescription(global::System.String value)
		        {
				...
				/// <exclude/>
				public LetterCorrespondenceVersionBuilder WithInitialScheduledEnd(global::System.DateTime? value)
		        {
				...
				/// <exclude/>
				public LetterCorrespondenceVersionBuilder WithSubject(global::System.String value)
		        {
				...
				/// <exclude/>
				public LetterCorrespondenceVersionBuilder WithDocument(Media value)
		        {
					if(this.Documents == null)
					{
				...
				/// <exclude/>
				public LetterCorrespondenceVersionBuilder WithCase(Case value)
		        {
				...
				/// <exclude/>
				public LetterCorrespondenceVersionBuilder WithPriority(Priority value)
		        {
				...
				/// <exclude/>
				public LetterCorrespondenceVersionBuilder WithOwner(Person value)
		        {
				...
				/// <exclude/>
				public LetterCorrespondenceVersionBuilder WithNote(global::System.String value)
		        {
				...
				/// <exclude/>
				public LetterCorrespondenceVersionBuilder WithActualStart(global::System.DateTime? value)
		        {
				...
				/// <exclude/>
				public LetterCorrespondenceVersionBuilder WithSendNotification(global::System.Boolean? value)
		        {
				...
				/// <exclude/>
				public LetterCorrespondenceVersionBuilder WithSendReminder(global::System.Boolean? value)
		        {
				...
				/// <exclude/>
				public LetterCorrespondenceVersionBuilder WithRemindAt(global::System.DateTime? value)
		        {
				...
				/// <exclude/>
				public LetterCorrespondenceVersionBuilder WithDerivationId(global::System.Guid? value)
		        {
				...
				/// <exclude/>
				public LetterCorrespondenceVersionBuilder WithDerivationTimeStamp(global::System.DateTime? value)
		        {
				...
				/// <exclude/>
				public LetterCorrespondenceVersionBuilder WithDeniedPermission(Permission value)
		        {
					if(this.DeniedPermissions == null)
					{
				...
				/// <exclude/>
				public LetterCorrespondenceVersionBuilder WithSecurityToken(SecurityToken value)
		        {
					if(this.SecurityTokens == null)
					{
	...
	public partial class LetterCorrespondenceVersions : global::Allors.ObjectsBase<LetterCorrespondenceVersion>
	{
		public LetterCorrespondenceVersions(Allors.ISession session) : base(session)
		{
		}
