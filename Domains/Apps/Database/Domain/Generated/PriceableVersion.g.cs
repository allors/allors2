...
{
	public partial interface PriceableVersion :  Version, Allors.IObject
	{
	...
	public partial interface PriceableVersionBuilder : VersionBuilder , global::System.IDisposable
	{	
	...
	public partial class PriceableVersions : global::Allors.ObjectsBase<PriceableVersion>
	{
		public PriceableVersions(Allors.ISession session) : base(session)
		{
		}

		public Allors.Meta.MetaPriceableVersion Meta
		{
			get
			{
				return Allors.Meta.MetaPriceableVersion.Instance;
			}
		}
