...
{
	public partial class AccountAdjustment : Allors.IObject , FinancialAccountTransaction
	{
		private readonly IStrategy strategy;

		public AccountAdjustment(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaAccountAdjustment Meta
		{
			get
			{
				return Allors.Meta.MetaAccountAdjustment.Instance;
			}
		}
		...
		{ 
			var method = new AccountAdjustmentOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new AccountAdjustmentOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new AccountAdjustmentOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new AccountAdjustmentOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new AccountAdjustmentOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	{		
		...
		protected override void OnBuild(AccountAdjustment instance)
		{
