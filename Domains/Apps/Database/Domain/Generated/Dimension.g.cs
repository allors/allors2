...
{
	public partial class Dimension : Allors.IObject , ProductFeature
	{
		private readonly IStrategy strategy;

		public Dimension(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaDimension Meta
		{
			get
			{
				return Allors.Meta.MetaDimension.Instance;
			}
		}
		...
		virtual public global::System.Decimal? Unit 
		{
			get
			{
				return (global::System.Decimal?) Strategy.GetUnitRole(Meta.Unit.RelationType);
			}
			set
			{
				Strategy.SetUnitRole(Meta.Unit.RelationType, value);
			}
		}
		...
		virtual public bool ExistUnit{
			get
			{
				return Strategy.ExistUnitRole(Meta.Unit.RelationType);
			}
		}

		virtual public void RemoveUnit()
		{
			Strategy.RemoveUnitRole(Meta.Unit.RelationType);
		}
		...
		{ 
			var method = new DimensionOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new DimensionOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new DimensionOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new DimensionOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new DimensionOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	{		
		...
		protected override void OnBuild(Dimension instance)
		{
			

			if(this.Unit.HasValue)
			{
				instance.Unit = this.Unit.Value;
			}			
