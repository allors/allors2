...
{
	public partial class Territory : Allors.IObject , CityBound, GeographicBoundary, CountryBound
	{
		private readonly IStrategy strategy;

		public Territory(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaTerritory Meta
		{
			get
			{
				return Allors.Meta.MetaTerritory.Instance;
			}
		}
		...
		{ 
			var method = new TerritoryOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new TerritoryOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new TerritoryOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new TerritoryOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new TerritoryOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	public partial class TerritoryBuilder : Allors.ObjectBuilder<Territory> , CityBoundBuilder, GeographicBoundaryBuilder, CountryBoundBuilder, global::System.IDisposable
	{		
		public TerritoryBuilder(Allors.ISession session) : base(session)
	    {
	    }

		protected override void OnBuild(Territory instance)
		{
