...
{
	public partial class ProfessionalPlacement : Allors.IObject , EngagementItem
	{
		private readonly IStrategy strategy;

		public ProfessionalPlacement(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaProfessionalPlacement Meta
		{
			get
			{
				return Allors.Meta.MetaProfessionalPlacement.Instance;
			}
		}
		...
		{ 
			var method = new ProfessionalPlacementOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new ProfessionalPlacementOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new ProfessionalPlacementOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new ProfessionalPlacementOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new ProfessionalPlacementOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	{		
		...
		protected override void OnBuild(ProfessionalPlacement instance)
		{
