...
{
	public partial class Obligation : Allors.IObject , ExternalAccountingTransaction
	{
		private readonly IStrategy strategy;

		public Obligation(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaObligation Meta
		{
			get
			{
				return Allors.Meta.MetaObligation.Instance;
			}
		}
		...
		{ 
			var method = new ObligationOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new ObligationOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new ObligationOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new ObligationOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new ObligationOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	{		
		...
		protected override void OnBuild(Obligation instance)
		{
