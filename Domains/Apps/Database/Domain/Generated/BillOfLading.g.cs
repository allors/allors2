...
{
	public partial class BillOfLading : Allors.IObject , Document
	{
		private readonly IStrategy strategy;

		public BillOfLading(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaBillOfLading Meta
		{
			get
			{
				return Allors.Meta.MetaBillOfLading.Instance;
			}
		}
		...
		{ 
			var method = new BillOfLadingOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new BillOfLadingOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new BillOfLadingOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new BillOfLadingOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new BillOfLadingOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	{		
		...
		protected override void OnBuild(BillOfLading instance)
		{
