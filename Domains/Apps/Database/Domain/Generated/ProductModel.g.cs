...
{
	public partial class ProductModel : Allors.IObject , Document
	{
		private readonly IStrategy strategy;

		public ProductModel(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaProductModel Meta
		{
			get
			{
				return Allors.Meta.MetaProductModel.Instance;
			}
		}
		...
		{ 
			var method = new ProductModelOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new ProductModelOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new ProductModelOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new ProductModelOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new ProductModelOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	{		
		...
		protected override void OnBuild(ProductModel instance)
		{
