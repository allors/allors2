...
{
	public partial class CapitalBudget : Allors.IObject , Budget, Versioned
	{
		private readonly IStrategy strategy;

		public CapitalBudget(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaCapitalBudget Meta
		{
			get
			{
				return Allors.Meta.MetaCapitalBudget.Instance;
			}
		}
		...
		{ 
			var method = new CapitalBudgetClose(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new CapitalBudgetReopen(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new CapitalBudgetOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new CapitalBudgetOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new CapitalBudgetOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new CapitalBudgetOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new CapitalBudgetOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	public partial class CapitalBudgetBuilder : Allors.ObjectBuilder<CapitalBudget> , BudgetBuilder, VersionedBuilder, global::System.IDisposable
	{		
		public CapitalBudgetBuilder(Allors.ISession session) : base(session)
	    {
	    }

		protected override void OnBuild(CapitalBudget instance)
		{
			...
			if(this.SecurityTokens!=null)
			{
				...
				/// <exclude/>
				public CapitalBudgetBuilder WithCurrentVersion(SalesOrderVersion value)
		        {
				...
				/// <exclude/>
				public CapitalBudgetBuilder WithAllVersion(SalesOrderVersion value)
		        {
					if(this.AllVersions == null)
					{
				...
				/// <exclude/>
				public CapitalBudgetBuilder WithBudgetState(BudgetState value)
		        {
