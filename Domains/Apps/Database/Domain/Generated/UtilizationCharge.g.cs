...
{
	public partial class UtilizationCharge : Allors.IObject , PriceComponent
	{
		private readonly IStrategy strategy;

		public UtilizationCharge(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaUtilizationCharge Meta
		{
			get
			{
				return Allors.Meta.MetaUtilizationCharge.Instance;
			}
		}
		...
		{ 
			var method = new UtilizationChargeOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new UtilizationChargeOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new UtilizationChargeOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new UtilizationChargeOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new UtilizationChargeOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	{		
		...
		protected override void OnBuild(UtilizationCharge instance)
		{
