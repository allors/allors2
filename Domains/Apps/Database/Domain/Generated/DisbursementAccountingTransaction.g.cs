...
{
	public partial class DisbursementAccountingTransaction : Allors.IObject , ExternalAccountingTransaction
	{
		private readonly IStrategy strategy;

		public DisbursementAccountingTransaction(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaDisbursementAccountingTransaction Meta
		{
			get
			{
				return Allors.Meta.MetaDisbursementAccountingTransaction.Instance;
			}
		}
		...
		{ 
			var method = new DisbursementAccountingTransactionOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new DisbursementAccountingTransactionOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new DisbursementAccountingTransactionOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new DisbursementAccountingTransactionOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new DisbursementAccountingTransactionOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	{		
		...
		protected override void OnBuild(DisbursementAccountingTransaction instance)
		{
