...
{
	public partial class FacilityType : Allors.IObject , Enumeration
	{
		private readonly IStrategy strategy;

		public FacilityType(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaFacilityType Meta
		{
			get
			{
				return Allors.Meta.MetaFacilityType.Instance;
			}
		}
		...
		public static FacilityType Instantiate (Allors.ISession allorsSession, string allorsObjectId)
		{
			return (FacilityType) allorsSession.Instantiate(allorsObjectId);		
		}
		...
		virtual public global::Allors.Extent<Facility> FacilitiesWhereFacilityType
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.FacilitiesWhereFacilityType.RelationType);
			}
		}

		virtual public bool ExistFacilitiesWhereFacilityType
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.FacilitiesWhereFacilityType.RelationType);
			}
		}
		...
		{ 
			var method = new FacilityTypeOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new FacilityTypeOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new FacilityTypeOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new FacilityTypeOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new FacilityTypeOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	public partial class FacilityTypeBuilder : Allors.ObjectBuilder<FacilityType> , EnumerationBuilder, global::System.IDisposable
	{		
		public FacilityTypeBuilder(Allors.ISession session) : base(session)
	    {
	    }

		protected override void OnBuild(FacilityType instance)
		{
			...
			if(this.SecurityTokens!=null)
			{
				...
				/// <exclude/>
				public FacilityTypeBuilder WithLocalisedName(LocalisedText value)
		        {
					if(this.LocalisedNames == null)
					{
				...
				/// <exclude/>
				public FacilityTypeBuilder WithName(global::System.String value)
		        {
				...
				/// <exclude/>
				public FacilityTypeBuilder WithIsActive(global::System.Boolean? value)
		        {
				...
				/// <exclude/>
				public FacilityTypeBuilder WithDeniedPermission(Permission value)
		        {
					if(this.DeniedPermissions == null)
					{
				...
				/// <exclude/>
				public FacilityTypeBuilder WithSecurityToken(SecurityToken value)
		        {
					if(this.SecurityTokens == null)
					{
				...
				/// <exclude/>
				public FacilityTypeBuilder WithUniqueId(global::System.Guid? value)
		        {
	...
	public partial class FacilityTypes : global::Allors.ObjectsBase<FacilityType>
	{
		public FacilityTypes(Allors.ISession session) : base(session)
		{
		}
