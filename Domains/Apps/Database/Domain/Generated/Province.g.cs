...
{
	public partial class Province : Allors.IObject , CityBound, GeographicBoundary, CountryBound
	{
		private readonly IStrategy strategy;

		public Province(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaProvince Meta
		{
			get
			{
				return Allors.Meta.MetaProvince.Instance;
			}
		}
		...
		{ 
			var method = new ProvinceOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new ProvinceOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new ProvinceOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new ProvinceOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new ProvinceOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	public partial class ProvinceBuilder : Allors.ObjectBuilder<Province> , CityBoundBuilder, GeographicBoundaryBuilder, CountryBoundBuilder, global::System.IDisposable
	{		
		public ProvinceBuilder(Allors.ISession session) : base(session)
	    {
	    }

		protected override void OnBuild(Province instance)
		{
