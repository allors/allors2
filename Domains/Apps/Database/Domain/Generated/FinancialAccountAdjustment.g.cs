...
{
	public partial class FinancialAccountAdjustment : Allors.IObject , FinancialAccountTransaction
	{
		private readonly IStrategy strategy;

		public FinancialAccountAdjustment(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaFinancialAccountAdjustment Meta
		{
			get
			{
				return Allors.Meta.MetaFinancialAccountAdjustment.Instance;
			}
		}
		...
		{ 
			var method = new FinancialAccountAdjustmentOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new FinancialAccountAdjustmentOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new FinancialAccountAdjustmentOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new FinancialAccountAdjustmentOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new FinancialAccountAdjustmentOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	{		
		...
		protected override void OnBuild(FinancialAccountAdjustment instance)
		{
