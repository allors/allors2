...
{
	public partial class DiscountComponent : Allors.IObject , PriceComponent
	{
		private readonly IStrategy strategy;

		public DiscountComponent(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaDiscountComponent Meta
		{
			get
			{
				return Allors.Meta.MetaDiscountComponent.Instance;
			}
		}
		...
		{ 
			var method = new DiscountComponentOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new DiscountComponentOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new DiscountComponentOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new DiscountComponentOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new DiscountComponentOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	{		
		...
		protected override void OnBuild(DiscountComponent instance)
		{
