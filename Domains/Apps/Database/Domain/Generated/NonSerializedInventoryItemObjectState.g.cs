...
{
	public partial class NonSerializedInventoryItemObjectState : Allors.IObject , ObjectState
	{
		private readonly IStrategy strategy;

		public NonSerializedInventoryItemObjectState(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaNonSerializedInventoryItemObjectState Meta
		{
			get
			{
				return Allors.Meta.MetaNonSerializedInventoryItemObjectState.Instance;
			}
		}
		...
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.NonSerializedInventoryItemStatusesWhereNonSerializedInventoryItemObjectState.RelationType);
			}
		}
		...
		virtual public bool ExistNonSerializedInventoryItemStatusesWhereNonSerializedInventoryItemObjectState
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.NonSerializedInventoryItemStatusesWhereNonSerializedInventoryItemObjectState.RelationType);
			}
		}
		...
		{ 
			var method = new NonSerializedInventoryItemObjectStateOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new NonSerializedInventoryItemObjectStateOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new NonSerializedInventoryItemObjectStateOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new NonSerializedInventoryItemObjectStateOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new NonSerializedInventoryItemObjectStateOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	{		
		...
		protected override void OnBuild(NonSerializedInventoryItemObjectState instance)
		{
