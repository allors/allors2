...
{
	public partial class SalesOrderItemShipmentState : Allors.IObject , ObjectState
	{
		private readonly IStrategy strategy;

		public SalesOrderItemShipmentState(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaSalesOrderItemShipmentState Meta
		{
			get
			{
				return Allors.Meta.MetaSalesOrderItemShipmentState.Instance;
			}
		}
		...
		public static SalesOrderItemShipmentState Instantiate (Allors.ISession allorsSession, string allorsObjectId)
		{
			return (SalesOrderItemShipmentState) allorsSession.Instantiate(allorsObjectId);		
		}
		...
		virtual public global::Allors.Extent<SalesOrderItem> SalesOrderItemsWherePreviousSalesOrderItemShipmentState
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.SalesOrderItemsWherePreviousSalesOrderItemShipmentState.RelationType);
			}
		}

		virtual public bool ExistSalesOrderItemsWherePreviousSalesOrderItemShipmentState
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.SalesOrderItemsWherePreviousSalesOrderItemShipmentState.RelationType);
			}
		}


		virtual public global::Allors.Extent<SalesOrderItem> SalesOrderItemsWhereLastSalesOrderItemShipmentState
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.SalesOrderItemsWhereLastSalesOrderItemShipmentState.RelationType);
			}
		}

		virtual public bool ExistSalesOrderItemsWhereLastSalesOrderItemShipmentState
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.SalesOrderItemsWhereLastSalesOrderItemShipmentState.RelationType);
			}
		}


		virtual public global::Allors.Extent<SalesOrderItem> SalesOrderItemsWhereSalesOrderItemShipmentState
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.SalesOrderItemsWhereSalesOrderItemShipmentState.RelationType);
			}
		}

		virtual public bool ExistSalesOrderItemsWhereSalesOrderItemShipmentState
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.SalesOrderItemsWhereSalesOrderItemShipmentState.RelationType);
			}
		}
		...
		{ 
			var method = new SalesOrderItemShipmentStateOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new SalesOrderItemShipmentStateOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new SalesOrderItemShipmentStateOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new SalesOrderItemShipmentStateOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new SalesOrderItemShipmentStateOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	public partial class SalesOrderItemShipmentStateBuilder : Allors.ObjectBuilder<SalesOrderItemShipmentState> , ObjectStateBuilder, global::System.IDisposable
	{		
		public SalesOrderItemShipmentStateBuilder(Allors.ISession session) : base(session)
	    {
	    }

		protected override void OnBuild(SalesOrderItemShipmentState instance)
		{
			...
			if(this.DeniedPermissions!=null)
			{
				...
				/// <exclude/>
				public SalesOrderItemShipmentStateBuilder WithDeniedPermission(Permission value)
		        {
					if(this.DeniedPermissions == null)
					{
				...
				/// <exclude/>
				public SalesOrderItemShipmentStateBuilder WithName(global::System.String value)
		        {
				...
				/// <exclude/>
				public SalesOrderItemShipmentStateBuilder WithUniqueId(global::System.Guid? value)
		        {
	...
	public partial class SalesOrderItemShipmentStates : global::Allors.ObjectsBase<SalesOrderItemShipmentState>
	{
		public SalesOrderItemShipmentStates(Allors.ISession session) : base(session)
		{
		}
