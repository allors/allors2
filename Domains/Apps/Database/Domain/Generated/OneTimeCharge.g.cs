...
{
	public partial class OneTimeCharge : Allors.IObject , PriceComponent
	{
		private readonly IStrategy strategy;

		public OneTimeCharge(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaOneTimeCharge Meta
		{
			get
			{
				return Allors.Meta.MetaOneTimeCharge.Instance;
			}
		}
		...
		{ 
			var method = new OneTimeChargeOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new OneTimeChargeOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new OneTimeChargeOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new OneTimeChargeOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new OneTimeChargeOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	{		
		...
		protected override void OnBuild(OneTimeCharge instance)
		{
