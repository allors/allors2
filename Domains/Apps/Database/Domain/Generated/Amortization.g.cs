...
{
	public partial class Amortization : Allors.IObject , InternalAccountingTransaction
	{
		private readonly IStrategy strategy;

		public Amortization(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaAmortization Meta
		{
			get
			{
				return Allors.Meta.MetaAmortization.Instance;
			}
		}
		...
		{ 
			var method = new AmortizationOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new AmortizationOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new AmortizationOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new AmortizationOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new AmortizationOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	{		
		...
		protected override void OnBuild(Amortization instance)
		{
