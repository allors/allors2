...
{
	public partial class EstimatedMaterialCost : Allors.IObject , EstimatedProductCost
	{
		private readonly IStrategy strategy;

		public EstimatedMaterialCost(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaEstimatedMaterialCost Meta
		{
			get
			{
				return Allors.Meta.MetaEstimatedMaterialCost.Instance;
			}
		}
		...
		{ 
			var method = new EstimatedMaterialCostOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new EstimatedMaterialCostOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new EstimatedMaterialCostOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new EstimatedMaterialCostOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new EstimatedMaterialCostOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	{		
		...
		protected override void OnBuild(EstimatedMaterialCost instance)
		{
