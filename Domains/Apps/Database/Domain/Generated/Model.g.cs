...
{
	public partial class Model : Allors.IObject , ProductFeature, Enumeration
	{
		private readonly IStrategy strategy;

		public Model(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaModel Meta
		{
			get
			{
				return Allors.Meta.MetaModel.Instance;
			}
		}
		...
		virtual public Brand BrandWhereModel
		{ 
			get
			{
				return (Brand) Strategy.GetCompositeAssociation(Meta.BrandWhereModel.RelationType);
			}
		} 

		virtual public bool ExistBrandWhereModel
		{
			get
			{
				return Strategy.ExistCompositeAssociation(Meta.BrandWhereModel.RelationType);
			}
		}
		...
		{ 
			var method = new ModelDelete(this);
            method.Execute();
            return method;
		}

		public ModelDelete Delete(System.Action<ModelDelete> action)
		{ 
			var method = new ModelDelete(this);
            action(method);
            method.Execute();
		...
		{ 
			var method = new ModelOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new ModelOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new ModelOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new ModelOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new ModelOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	{		
		...
		protected override void OnBuild(Model instance)
		{
