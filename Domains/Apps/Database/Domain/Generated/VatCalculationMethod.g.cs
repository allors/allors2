...
{
	public partial class VatCalculationMethod : Allors.IObject , Enumeration
	{
		private readonly IStrategy strategy;

		public VatCalculationMethod(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaVatCalculationMethod Meta
		{
			get
			{
				return Allors.Meta.MetaVatCalculationMethod.Instance;
			}
		}
		...
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.VatRatesWhereVatCalculationMethod.RelationType);
			}
		}
		...
		virtual public bool ExistVatRatesWhereVatCalculationMethod
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.VatRatesWhereVatCalculationMethod.RelationType);
			}
		}
		...
		{ 
			var method = new VatCalculationMethodOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new VatCalculationMethodOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new VatCalculationMethodOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new VatCalculationMethodOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new VatCalculationMethodOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	{		
		...
		protected override void OnBuild(VatCalculationMethod instance)
		{
