...
{
	public partial class InvoiceTermType : Allors.IObject , TermType
	{
		private readonly IStrategy strategy;

		public InvoiceTermType(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaInvoiceTermType Meta
		{
			get
			{
				return Allors.Meta.MetaInvoiceTermType.Instance;
			}
		}
		...
		public static InvoiceTermType Instantiate (Allors.ISession allorsSession, string allorsObjectId)
		{
			return (InvoiceTermType) allorsSession.Instantiate(allorsObjectId);		
		}
		...
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.OrderTermsWhereTermType.RelationType);
			}
		}
		...
		virtual public bool ExistOrderTermsWhereTermType
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.OrderTermsWhereTermType.RelationType);
			}
		}
		...
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.QuoteTermsWhereTermType.RelationType);
			}
		}
		...
		virtual public bool ExistQuoteTermsWhereTermType
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.QuoteTermsWhereTermType.RelationType);
			}
		}
		...
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.AgreementTermsWhereTermType.RelationType);
			}
		}
		...
		virtual public bool ExistAgreementTermsWhereTermType
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.AgreementTermsWhereTermType.RelationType);
			}
		}
		...
		{ 
			var method = new InvoiceTermTypeOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new InvoiceTermTypeOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new InvoiceTermTypeOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new InvoiceTermTypeOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new InvoiceTermTypeOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	public partial class InvoiceTermTypeBuilder : Allors.ObjectBuilder<InvoiceTermType> , TermTypeBuilder, global::System.IDisposable
	{		
		public InvoiceTermTypeBuilder(Allors.ISession session) : base(session)
	    {
	    }

		protected override void OnBuild(InvoiceTermType instance)
		{
			...
			if(this.SecurityTokens!=null)
			{
				...
				/// <exclude/>
				public InvoiceTermTypeBuilder WithLocalisedName(LocalisedText value)
		        {
					if(this.LocalisedNames == null)
					{
				...
				/// <exclude/>
				public InvoiceTermTypeBuilder WithName(global::System.String value)
		        {
				...
				/// <exclude/>
				public InvoiceTermTypeBuilder WithIsActive(global::System.Boolean? value)
		        {
				...
				/// <exclude/>
				public InvoiceTermTypeBuilder WithDeniedPermission(Permission value)
		        {
					if(this.DeniedPermissions == null)
					{
				...
				/// <exclude/>
				public InvoiceTermTypeBuilder WithSecurityToken(SecurityToken value)
		        {
					if(this.SecurityTokens == null)
					{
				...
				/// <exclude/>
				public InvoiceTermTypeBuilder WithUniqueId(global::System.Guid? value)
		        {
	...
	public partial class InvoiceTermTypes : global::Allors.ObjectsBase<InvoiceTermType>
	{
		public InvoiceTermTypes(Allors.ISession session) : base(session)
		{
		}
