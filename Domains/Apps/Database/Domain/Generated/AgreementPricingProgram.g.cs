...
{
	public partial class AgreementPricingProgram : Allors.IObject , AgreementItem
	{
		private readonly IStrategy strategy;

		public AgreementPricingProgram(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaAgreementPricingProgram Meta
		{
			get
			{
				return Allors.Meta.MetaAgreementPricingProgram.Instance;
			}
		}
		...
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.PriceComponentsWhereAgreementPricingProgram.RelationType);
			}
		}
		...
		virtual public bool ExistPriceComponentsWhereAgreementPricingProgram
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.PriceComponentsWhereAgreementPricingProgram.RelationType);
			}
		}
		...
		{ 
			var method = new AgreementPricingProgramOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new AgreementPricingProgramOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new AgreementPricingProgramOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new AgreementPricingProgramOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new AgreementPricingProgramOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	{		
		...
		protected override void OnBuild(AgreementPricingProgram instance)
		{
			...
			if(this.SecurityTokens!=null)
			{
				...
				/// <exclude/>
				public AgreementPricingProgramBuilder WithAddenda(Addendum value)
		        {
					if(this.Addenda == null)
					{
