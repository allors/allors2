...
{
	public partial class PersonRole : Allors.IObject , Enumeration
	{
		private readonly IStrategy strategy;

		public PersonRole(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaPersonRole Meta
		{
			get
			{
				return Allors.Meta.MetaPersonRole.Instance;
			}
		}
		...
		public static PersonRole Instantiate (Allors.ISession allorsSession, string allorsObjectId)
		{
			return (PersonRole) allorsSession.Instantiate(allorsObjectId);		
		}
		...
		virtual public global::Allors.Extent<Person> PeopleWherePersonRole
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.PeopleWherePersonRole.RelationType);
			}
		}

		virtual public bool ExistPeopleWherePersonRole
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.PeopleWherePersonRole.RelationType);
			}
		}


		virtual public global::Allors.Extent<PersonVersion> PersonVersionsWherePersonRole
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.PersonVersionsWherePersonRole.RelationType);
			}
		}

		virtual public bool ExistPersonVersionsWherePersonRole
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.PersonVersionsWherePersonRole.RelationType);
			}
		}
		...
		{ 
			var method = new PersonRoleOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new PersonRoleOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new PersonRoleOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new PersonRoleOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new PersonRoleOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	public partial class PersonRoleBuilder : Allors.ObjectBuilder<PersonRole> , EnumerationBuilder, global::System.IDisposable
	{		
		public PersonRoleBuilder(Allors.ISession session) : base(session)
	    {
	    }

		protected override void OnBuild(PersonRole instance)
		{
			...
			if(this.SecurityTokens!=null)
			{
				...
				/// <exclude/>
				public PersonRoleBuilder WithLocalisedName(LocalisedText value)
		        {
					if(this.LocalisedNames == null)
					{
				...
				/// <exclude/>
				public PersonRoleBuilder WithName(global::System.String value)
		        {
				...
				/// <exclude/>
				public PersonRoleBuilder WithIsActive(global::System.Boolean? value)
		        {
				...
				/// <exclude/>
				public PersonRoleBuilder WithDeniedPermission(Permission value)
		        {
					if(this.DeniedPermissions == null)
					{
				...
				/// <exclude/>
				public PersonRoleBuilder WithSecurityToken(SecurityToken value)
		        {
					if(this.SecurityTokens == null)
					{
				...
				/// <exclude/>
				public PersonRoleBuilder WithUniqueId(global::System.Guid? value)
		        {
	...
	public partial class PersonRoles : global::Allors.ObjectsBase<PersonRole>
	{
		public PersonRoles(Allors.ISession session) : base(session)
		{
		}
