...
{
	public partial class RecurringCharge : Allors.IObject , PriceComponent
	{
		private readonly IStrategy strategy;

		public RecurringCharge(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaRecurringCharge Meta
		{
			get
			{
				return Allors.Meta.MetaRecurringCharge.Instance;
			}
		}
		...
		{ 
			var method = new RecurringChargeOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new RecurringChargeOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new RecurringChargeOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new RecurringChargeOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new RecurringChargeOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	{		
		...
		protected override void OnBuild(RecurringCharge instance)
		{
