...
{
	public partial class DunningType : Allors.IObject , Enumeration
	{
		private readonly IStrategy strategy;

		public DunningType(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaDunningType Meta
		{
			get
			{
				return Allors.Meta.MetaDunningType.Instance;
			}
		}
		...
		virtual public global::Allors.Extent<PartyVersion> PartyVersionsWhereDunningType
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.PartyVersionsWhereDunningType.RelationType);
			}
		}

		virtual public bool ExistPartyVersionsWhereDunningType
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.PartyVersionsWhereDunningType.RelationType);
			}
		}


		virtual public global::Allors.Extent<Party> PartiesWhereDunningType
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.PartiesWhereDunningType.RelationType);
			}
		}

		virtual public bool ExistPartiesWhereDunningType
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.PartiesWhereDunningType.RelationType);
			}
		}
		...
		public DunningTypeDelete Delete()
		{ 
			var method = new DunningTypeDelete(this);
            method.Execute();
            return method;
		}

		public DunningTypeDelete Delete(System.Action<DunningTypeDelete> action)
		{ 
			var method = new DunningTypeDelete(this);
            action(method);
            method.Execute();
		...
		{ 
			var method = new DunningTypeOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new DunningTypeOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new DunningTypeOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new DunningTypeOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new DunningTypeOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	{		
		...
		protected override void OnBuild(DunningType instance)
		{
