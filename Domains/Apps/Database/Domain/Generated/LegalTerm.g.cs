...
{
	public partial class LegalTerm : Allors.IObject , AgreementTerm
	{
		private readonly IStrategy strategy;

		public LegalTerm(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaLegalTerm Meta
		{
			get
			{
				return Allors.Meta.MetaLegalTerm.Instance;
			}
		}
		...
		{ 
			var method = new LegalTermOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new LegalTermOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new LegalTermOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new LegalTermOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new LegalTermOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	{		
		...
		protected override void OnBuild(LegalTerm instance)
		{
