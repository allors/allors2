...
{
	public partial class EmploymentApplicationStatus : Allors.IObject , Enumeration
	{
		private readonly IStrategy strategy;

		public EmploymentApplicationStatus(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaEmploymentApplicationStatus Meta
		{
			get
			{
				return Allors.Meta.MetaEmploymentApplicationStatus.Instance;
			}
		}
		...
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.EmploymentApplicationsWhereEmploymentApplicationStatus.RelationType);
			}
		}
		...
		virtual public bool ExistEmploymentApplicationsWhereEmploymentApplicationStatus
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.EmploymentApplicationsWhereEmploymentApplicationStatus.RelationType);
			}
		}
		...
		{ 
			var method = new EmploymentApplicationStatusOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new EmploymentApplicationStatusOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new EmploymentApplicationStatusOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new EmploymentApplicationStatusOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new EmploymentApplicationStatusOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	{		
		...
		protected override void OnBuild(EmploymentApplicationStatus instance)
		{
