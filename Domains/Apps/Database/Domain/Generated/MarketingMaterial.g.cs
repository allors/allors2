...
{
	public partial class MarketingMaterial : Allors.IObject , Document
	{
		private readonly IStrategy strategy;

		public MarketingMaterial(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaMarketingMaterial Meta
		{
			get
			{
				return Allors.Meta.MetaMarketingMaterial.Instance;
			}
		}
		...
		{ 
			var method = new MarketingMaterialOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new MarketingMaterialOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new MarketingMaterialOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new MarketingMaterialOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new MarketingMaterialOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	{		
		...
		protected override void OnBuild(MarketingMaterial instance)
		{
