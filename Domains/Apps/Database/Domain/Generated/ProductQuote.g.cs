...
{
	public partial class ProductQuote : Allors.IObject , Quote, Versioned
	{
		private readonly IStrategy strategy;

		public ProductQuote(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaProductQuote Meta
		{
			get
			{
				return Allors.Meta.MetaProductQuote.Instance;
			}
		}
		...
		virtual public ProductQuoteVersion CurrentVersion
		{ 
			get
			{
				return (ProductQuoteVersion) Strategy.GetCompositeRole(Meta.CurrentVersion.RelationType);
			}
			set
			{
		...
		virtual public global::Allors.Extent<ProductQuoteVersion> AllVersions
		{ 
			get
			{
		...
		virtual public void AddAllVersion (ProductQuoteVersion value)
		{
			Strategy.AddCompositeRole(Meta.AllVersions.RelationType, value);
		}

		virtual public void RemoveAllVersion (ProductQuoteVersion value)
		{
		...
		virtual public QuoteState PreviousQuoteState
		{ 
			get
			{
				return (QuoteState) Strategy.GetCompositeRole(Meta.PreviousQuoteState.RelationType);
			}
			set
			{
				Strategy.SetCompositeRole(Meta.PreviousQuoteState.RelationType, value);
			}
		}

		virtual public bool ExistPreviousQuoteState
		{
			get
			{
				return Strategy.ExistCompositeRole(Meta.PreviousQuoteState.RelationType);
			}
		}

		virtual public void RemovePreviousQuoteState()
		{
			Strategy.RemoveCompositeRole(Meta.PreviousQuoteState.RelationType);
		}


		virtual public QuoteState LastQuoteState
		{ 
			get
			{
				return (QuoteState) Strategy.GetCompositeRole(Meta.LastQuoteState.RelationType);
			}
			set
			{
				Strategy.SetCompositeRole(Meta.LastQuoteState.RelationType, value);
			}
		}

		virtual public bool ExistLastQuoteState
		{
			get
			{
				return Strategy.ExistCompositeRole(Meta.LastQuoteState.RelationType);
			}
		}

		virtual public void RemoveLastQuoteState()
		{
			Strategy.RemoveCompositeRole(Meta.LastQuoteState.RelationType);
		}
		...
		virtual public global::Allors.Extent<SalesOrderVersion> SalesOrderVersionsWhereQuote
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.SalesOrderVersionsWhereQuote.RelationType);
			}
		}

		virtual public bool ExistSalesOrderVersionsWhereQuote
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.SalesOrderVersionsWhereQuote.RelationType);
			}
		}


		virtual public SalesOrder SalesOrderWhereQuote
		{ 
			get
			{
				return (SalesOrder) Strategy.GetCompositeAssociation(Meta.SalesOrderWhereQuote.RelationType);
			}
		} 

		virtual public bool ExistSalesOrderWhereQuote
		{
			get
			{
				return Strategy.ExistCompositeAssociation(Meta.SalesOrderWhereQuote.RelationType);
			}
		}



		public ProductQuoteOrder Order()
		{ 
			var method = new ProductQuoteOrder(this);
            method.Execute();
            return method;
		}

		public ProductQuoteOrder Order(System.Action<ProductQuoteOrder> action)
		{ 
			var method = new ProductQuoteOrder(this);
            action(method);
            method.Execute();
		...
		public QuoteApprove Approve()
		{ 
			var method = new ProductQuoteApprove(this);
            method.Execute();
            return method;
		}

		public QuoteApprove Approve(System.Action<QuoteApprove> action)
		{ 
			var method = new ProductQuoteApprove(this);
            action(method);
            method.Execute();
		...
		public QuoteReject Reject()
		{ 
			var method = new ProductQuoteReject(this);
            method.Execute();
            return method;
		}

		public QuoteReject Reject(System.Action<QuoteReject> action)
		{ 
			var method = new ProductQuoteReject(this);
            action(method);
            method.Execute();
		...
		{ 
			var method = new ProductQuoteOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new ProductQuoteOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new ProductQuoteOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new ProductQuoteOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new ProductQuoteOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	public partial class ProductQuoteBuilder : Allors.ObjectBuilder<ProductQuote> , QuoteBuilder, VersionedBuilder, global::System.IDisposable
	{		
		public ProductQuoteBuilder(Allors.ISession session) : base(session)
	    {
	    }

		protected override void OnBuild(ProductQuote instance)
		{
			...
			instance.LastModifiedBy = this.LastModifiedBy;
				...
				/// <exclude/>
				public ProductQuoteBuilder WithCurrentVersion(ProductQuoteVersion value)
		        {
				...
				public global::System.Collections.Generic.List<ProductQuoteVersion> AllVersions {get; set;}	

				/// <exclude/>
				public ProductQuoteBuilder WithAllVersion(ProductQuoteVersion value)
		        {
					if(this.AllVersions == null)
					{
						this.AllVersions = new global::System.Collections.Generic.List<ProductQuoteVersion>(); 
					}
				...
				/// <exclude/>
				public ProductQuoteBuilder WithQuoteState(QuoteState value)
		        {
				...
				/// <exclude/>
				public ProductQuoteBuilder WithInternalComment(global::System.String value)
		        {
				...
				/// <exclude/>
				public ProductQuoteBuilder WithRequiredResponseDate(global::System.DateTime? value)
		        {
				...
				/// <exclude/>
				public ProductQuoteBuilder WithFullfillContactMechanism(ContactMechanism value)
		        {
				...
				/// <exclude/>
				public ProductQuoteBuilder WithCurrency(Currency value)
		        {
				...
				/// <exclude/>
				public ProductQuoteBuilder WithRequest(Request value)
		        {
				...
				/// <exclude/>
				public ProductQuoteBuilder WithContactPerson(Person value)
		        {
				...
				/// <exclude/>
				public ProductQuoteBuilder WithPrintContent(global::System.String value)
		        {
				...
				/// <exclude/>
				public ProductQuoteBuilder WithCreatedBy(User value)
		        {
				...
				/// <exclude/>
				public ProductQuoteBuilder WithLastModifiedBy(User value)
		        {
				...
				/// <exclude/>
				public ProductQuoteBuilder WithCreationDate(global::System.DateTime? value)
		        {
				...
				/// <exclude/>
				public ProductQuoteBuilder WithLastModifiedDate(global::System.DateTime? value)
		        {
				...
				/// <exclude/>
				public ProductQuoteBuilder WithComment(global::System.String value)
		        {
