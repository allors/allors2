...
{
	public partial class PurchaseOrderShipmentState : Allors.IObject , ObjectState
	{
		private readonly IStrategy strategy;

		public PurchaseOrderShipmentState(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaPurchaseOrderShipmentState Meta
		{
			get
			{
				return Allors.Meta.MetaPurchaseOrderShipmentState.Instance;
			}
		}
		...
		public static PurchaseOrderShipmentState Instantiate (Allors.ISession allorsSession, string allorsObjectId)
		{
			return (PurchaseOrderShipmentState) allorsSession.Instantiate(allorsObjectId);		
		}
		...
		virtual public global::Allors.Extent<PurchaseOrder> PurchaseOrdersWherePreviousPurchaseOrderShipmentOrderState
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.PurchaseOrdersWherePreviousPurchaseOrderShipmentOrderState.RelationType);
			}
		}

		virtual public bool ExistPurchaseOrdersWherePreviousPurchaseOrderShipmentOrderState
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.PurchaseOrdersWherePreviousPurchaseOrderShipmentOrderState.RelationType);
			}
		}


		virtual public global::Allors.Extent<PurchaseOrder> PurchaseOrdersWhereLastPurchaseOrderShipmentState
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.PurchaseOrdersWhereLastPurchaseOrderShipmentState.RelationType);
			}
		}

		virtual public bool ExistPurchaseOrdersWhereLastPurchaseOrderShipmentState
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.PurchaseOrdersWhereLastPurchaseOrderShipmentState.RelationType);
			}
		}


		virtual public global::Allors.Extent<PurchaseOrder> PurchaseOrdersWherePurchaseOrderShipmentState
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.PurchaseOrdersWherePurchaseOrderShipmentState.RelationType);
			}
		}

		virtual public bool ExistPurchaseOrdersWherePurchaseOrderShipmentState
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.PurchaseOrdersWherePurchaseOrderShipmentState.RelationType);
			}
		}
		...
		{ 
			var method = new PurchaseOrderShipmentStateOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new PurchaseOrderShipmentStateOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new PurchaseOrderShipmentStateOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new PurchaseOrderShipmentStateOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new PurchaseOrderShipmentStateOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	public partial class PurchaseOrderShipmentStateBuilder : Allors.ObjectBuilder<PurchaseOrderShipmentState> , ObjectStateBuilder, global::System.IDisposable
	{		
		public PurchaseOrderShipmentStateBuilder(Allors.ISession session) : base(session)
	    {
	    }

		protected override void OnBuild(PurchaseOrderShipmentState instance)
		{
			...
			if(this.DeniedPermissions!=null)
			{
				...
				/// <exclude/>
				public PurchaseOrderShipmentStateBuilder WithDeniedPermission(Permission value)
		        {
					if(this.DeniedPermissions == null)
					{
				...
				/// <exclude/>
				public PurchaseOrderShipmentStateBuilder WithName(global::System.String value)
		        {
				...
				/// <exclude/>
				public PurchaseOrderShipmentStateBuilder WithUniqueId(global::System.Guid? value)
		        {
	...
	public partial class PurchaseOrderShipmentStates : global::Allors.ObjectsBase<PurchaseOrderShipmentState>
	{
		public PurchaseOrderShipmentStates(Allors.ISession session) : base(session)
		{
		}
