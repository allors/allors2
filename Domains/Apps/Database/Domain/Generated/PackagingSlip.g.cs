...
{
	public partial class PackagingSlip : Allors.IObject , Document
	{
		private readonly IStrategy strategy;

		public PackagingSlip(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaPackagingSlip Meta
		{
			get
			{
				return Allors.Meta.MetaPackagingSlip.Instance;
			}
		}
		...
		{ 
			var method = new PackagingSlipOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new PackagingSlipOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new PackagingSlipOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new PackagingSlipOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new PackagingSlipOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	{		
		...
		protected override void OnBuild(PackagingSlip instance)
		{
