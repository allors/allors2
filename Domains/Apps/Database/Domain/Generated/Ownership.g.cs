...
{
	public partial class Ownership : Allors.IObject , Enumeration
	{
		private readonly IStrategy strategy;

		public Ownership(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaOwnership Meta
		{
			get
			{
				return Allors.Meta.MetaOwnership.Instance;
			}
		}
		...
		public static Ownership Instantiate (Allors.ISession allorsSession, string allorsObjectId)
		{
			return (Ownership) allorsSession.Instantiate(allorsObjectId);		
		}
		...
		virtual public global::Allors.Extent<SerialisedInventoryItemVersion> SerialisedInventoryItemVersionsWhereOwnership
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.SerialisedInventoryItemVersionsWhereOwnership.RelationType);
			}
		}

		virtual public bool ExistSerialisedInventoryItemVersionsWhereOwnership
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.SerialisedInventoryItemVersionsWhereOwnership.RelationType);
			}
		}


		virtual public global::Allors.Extent<SerialisedInventoryItem> SerialisedInventoryItemsWhereOwnership
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.SerialisedInventoryItemsWhereOwnership.RelationType);
			}
		}

		virtual public bool ExistSerialisedInventoryItemsWhereOwnership
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.SerialisedInventoryItemsWhereOwnership.RelationType);
			}
		}
		...
		{ 
			var method = new OwnershipOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new OwnershipOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new OwnershipOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new OwnershipOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new OwnershipOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	public partial class OwnershipBuilder : Allors.ObjectBuilder<Ownership> , EnumerationBuilder, global::System.IDisposable
	{		
		public OwnershipBuilder(Allors.ISession session) : base(session)
	    {
	    }

		protected override void OnBuild(Ownership instance)
		{
			...
			if(this.SecurityTokens!=null)
			{
				...
				/// <exclude/>
				public OwnershipBuilder WithLocalisedName(LocalisedText value)
		        {
					if(this.LocalisedNames == null)
					{
				...
				/// <exclude/>
				public OwnershipBuilder WithName(global::System.String value)
		        {
				...
				/// <exclude/>
				public OwnershipBuilder WithIsActive(global::System.Boolean? value)
		        {
				...
				/// <exclude/>
				public OwnershipBuilder WithDeniedPermission(Permission value)
		        {
					if(this.DeniedPermissions == null)
					{
				...
				/// <exclude/>
				public OwnershipBuilder WithSecurityToken(SecurityToken value)
		        {
					if(this.SecurityTokens == null)
					{
				...
				/// <exclude/>
				public OwnershipBuilder WithUniqueId(global::System.Guid? value)
		        {
	...
	public partial class Ownerships : global::Allors.ObjectsBase<Ownership>
	{
		public Ownerships(Allors.ISession session) : base(session)
		{
		}
