...
{
	public partial class HazardousMaterialsDocument : Allors.IObject , Document
	{
		private readonly IStrategy strategy;

		public HazardousMaterialsDocument(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaHazardousMaterialsDocument Meta
		{
			get
			{
				return Allors.Meta.MetaHazardousMaterialsDocument.Instance;
			}
		}
		...
		{ 
			var method = new HazardousMaterialsDocumentOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new HazardousMaterialsDocumentOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new HazardousMaterialsDocumentOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new HazardousMaterialsDocumentOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new HazardousMaterialsDocumentOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	{		
		...
		protected override void OnBuild(HazardousMaterialsDocument instance)
		{
