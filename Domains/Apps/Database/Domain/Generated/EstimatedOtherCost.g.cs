...
{
	public partial class EstimatedOtherCost : Allors.IObject , EstimatedProductCost
	{
		private readonly IStrategy strategy;

		public EstimatedOtherCost(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaEstimatedOtherCost Meta
		{
			get
			{
				return Allors.Meta.MetaEstimatedOtherCost.Instance;
			}
		}
		...
		{ 
			var method = new EstimatedOtherCostOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new EstimatedOtherCostOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new EstimatedOtherCostOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new EstimatedOtherCostOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new EstimatedOtherCostOnPostDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new EstimatedOtherCostDelete(this);
            method.Execute();
            return method;
		}
	...
	{		
		...
		protected override void OnBuild(EstimatedOtherCost instance)
		{
