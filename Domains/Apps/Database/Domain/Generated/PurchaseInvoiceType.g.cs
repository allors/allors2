...
{
	public partial class PurchaseInvoiceType : Allors.IObject , Enumeration
	{
		private readonly IStrategy strategy;

		public PurchaseInvoiceType(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaPurchaseInvoiceType Meta
		{
			get
			{
				return Allors.Meta.MetaPurchaseInvoiceType.Instance;
			}
		}
		...
		virtual public global::Allors.Extent<PurchaseInvoiceVersion> PurchaseInvoiceVersionsWherePurchaseInvoiceType
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.PurchaseInvoiceVersionsWherePurchaseInvoiceType.RelationType);
			}
		}

		virtual public bool ExistPurchaseInvoiceVersionsWherePurchaseInvoiceType
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.PurchaseInvoiceVersionsWherePurchaseInvoiceType.RelationType);
			}
		}
		...
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.PurchaseInvoicesWherePurchaseInvoiceType.RelationType);
			}
		}
		...
		virtual public bool ExistPurchaseInvoicesWherePurchaseInvoiceType
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.PurchaseInvoicesWherePurchaseInvoiceType.RelationType);
			}
		}
		...
		{ 
			var method = new PurchaseInvoiceTypeOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new PurchaseInvoiceTypeOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new PurchaseInvoiceTypeOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new PurchaseInvoiceTypeOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new PurchaseInvoiceTypeOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	{		
		...
		protected override void OnBuild(PurchaseInvoiceType instance)
		{
