...
{
	public partial class VolumeUsage : Allors.IObject , DeploymentUsage
	{
		private readonly IStrategy strategy;

		public VolumeUsage(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaVolumeUsage Meta
		{
			get
			{
				return Allors.Meta.MetaVolumeUsage.Instance;
			}
		}
		...
		{ 
			var method = new VolumeUsageOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new VolumeUsageOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new VolumeUsageOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new VolumeUsageOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new VolumeUsageOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	{		
		...
		protected override void OnBuild(VolumeUsage instance)
		{
