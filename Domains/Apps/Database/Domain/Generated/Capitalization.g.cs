...
{
	public partial class Capitalization : Allors.IObject , InternalAccountingTransaction
	{
		private readonly IStrategy strategy;

		public Capitalization(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaCapitalization Meta
		{
			get
			{
				return Allors.Meta.MetaCapitalization.Instance;
			}
		}
		...
		{ 
			var method = new CapitalizationOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new CapitalizationOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new CapitalizationOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new CapitalizationOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new CapitalizationOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	{		
		...
		protected override void OnBuild(Capitalization instance)
		{
