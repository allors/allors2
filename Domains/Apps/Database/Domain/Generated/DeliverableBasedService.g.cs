...
{
	public partial class DeliverableBasedService : Allors.IObject , Service
	{
		private readonly IStrategy strategy;

		public DeliverableBasedService(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaDeliverableBasedService Meta
		{
			get
			{
				return Allors.Meta.MetaDeliverableBasedService.Instance;
			}
		}
		...
		{ 
			var method = new DeliverableBasedServiceOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new DeliverableBasedServiceOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new DeliverableBasedServiceOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new DeliverableBasedServiceOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new DeliverableBasedServiceOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	{		
		...
		protected override void OnBuild(DeliverableBasedService instance)
		{
			...
			if(this.SecurityTokens!=null)
			{
				...
				/// <exclude/>
				public DeliverableBasedServiceBuilder WithInternalComment(global::System.String value)
		        {
				...
				/// <exclude/>
				public DeliverableBasedServiceBuilder WithLocalisedName(LocalisedText value)
		        {
					if(this.LocalisedNames == null)
					{
				...
				/// <exclude/>
				public DeliverableBasedServiceBuilder WithLocalisedDescription(LocalisedText value)
		        {
					if(this.LocalisedDescriptions == null)
					{
				...
				/// <exclude/>
				public DeliverableBasedServiceBuilder WithLocalisedComment(LocalisedText value)
		        {
					if(this.LocalisedComments == null)
					{
				...
				/// <exclude/>
				public DeliverableBasedServiceBuilder WithComment(global::System.String value)
		        {
