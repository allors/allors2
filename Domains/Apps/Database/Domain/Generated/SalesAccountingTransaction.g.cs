...
{
	public partial class SalesAccountingTransaction : Allors.IObject , ExternalAccountingTransaction
	{
		private readonly IStrategy strategy;

		public SalesAccountingTransaction(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaSalesAccountingTransaction Meta
		{
			get
			{
				return Allors.Meta.MetaSalesAccountingTransaction.Instance;
			}
		}
		...
		{ 
			var method = new SalesAccountingTransactionOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new SalesAccountingTransactionOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new SalesAccountingTransactionOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new SalesAccountingTransactionOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new SalesAccountingTransactionOnPostDerive(this);
            method.Execute();
            return method;
		}
	...
	{		
		...
		protected override void OnBuild(SalesAccountingTransaction instance)
		{
