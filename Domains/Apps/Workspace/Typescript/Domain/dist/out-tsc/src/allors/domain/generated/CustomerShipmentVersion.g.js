...
class CustomerShipmentVersion extends framework_1.SessionObject {
    get CanReadCustomerShipmentState() {
        return this.canRead('CustomerShipmentState');
    }
    get CanWriteCustomerShipmentState() {
        return this.canWrite('CustomerShipmentState');
    }
    get CustomerShipmentState() {
        return this.get('CustomerShipmentState');
    }
    set CustomerShipmentState(value) {
        this.set('CustomerShipmentState', value);
    }
    get CanReadReleasedManually() {
        return this.canRead('ReleasedManually');
    }
    get CanWriteReleasedManually() {
        return this.canWrite('ReleasedManually');
    }
    get ReleasedManually() {
        return this.get('ReleasedManually');
    }
    set ReleasedManually(value) {
...
exports.CustomerShipmentVersion = CustomerShipmentVersion;
//# sourceMappingURL=CustomerShipmentVersion.g.js.map