...
class PurchaseReturnVersion extends framework_1.SessionObject {
    get CanReadPurchaseReturnState() {
        return this.canRead('PurchaseReturnState');
    }
    get CanWritePurchaseReturnState() {
        return this.canWrite('PurchaseReturnState');
    }
    get PurchaseReturnState() {
        return this.get('PurchaseReturnState');
    }
    set PurchaseReturnState(value) {
...
exports.PurchaseReturnVersion = PurchaseReturnVersion;
//# sourceMappingURL=PurchaseReturnVersion.g.js.map