...
class PhoneCommunicationVersion extends framework_1.SessionObject {
    get CanReadLeftVoiceMail() {
        return this.canRead('LeftVoiceMail');
    }
    get CanWriteLeftVoiceMail() {
        return this.canWrite('LeftVoiceMail');
    }
    get LeftVoiceMail() {
        return this.get('LeftVoiceMail');
    }
    set LeftVoiceMail(value) {
        this.set('LeftVoiceMail', value);
    }
    get CanReadIncomingCall() {
        return this.canRead('IncomingCall');
    }
    get CanWriteIncomingCall() {
...
exports.PhoneCommunicationVersion = PhoneCommunicationVersion;
//# sourceMappingURL=PhoneCommunicationVersion.g.js.map