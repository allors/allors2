...
class PurchaseShipmentVersion extends framework_1.SessionObject {
    get CanReadPurchaseShipmentState() {
        return this.canRead('PurchaseShipmentState');
    }
    get CanWritePurchaseShipmentState() {
        return this.canWrite('PurchaseShipmentState');
    }
    get PurchaseShipmentState() {
        return this.get('PurchaseShipmentState');
    }
    set PurchaseShipmentState(value) {
    ...
    get CanReadPurchaseOrder() {
        return this.canRead('PurchaseOrder');
    }
    get CanWritePurchaseOrder() {
...
exports.PurchaseShipmentVersion = PurchaseShipmentVersion;
//# sourceMappingURL=PurchaseShipmentVersion.g.js.map