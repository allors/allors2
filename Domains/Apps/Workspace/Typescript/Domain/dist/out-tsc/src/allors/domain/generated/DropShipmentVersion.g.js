...
class DropShipmentVersion extends framework_1.SessionObject {
    get CanReadDropShipmentState() {
        return this.canRead('DropShipmentState');
    }
    get CanWriteDropShipmentState() {
        return this.canWrite('DropShipmentState');
    }
    get DropShipmentState() {
        return this.get('DropShipmentState');
    }
    set DropShipmentState(value) {
...
exports.DropShipmentVersion = DropShipmentVersion;
//# sourceMappingURL=DropShipmentVersion.g.js.map