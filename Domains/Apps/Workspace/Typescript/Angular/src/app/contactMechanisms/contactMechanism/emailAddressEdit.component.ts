...
export class EmailAddressEditComponent implements OnInit, AfterViewInit, OnDestroy {
      ...
      .mergeMap((url: any) => {
        ...
        return this.scope
          ...
          .do(() => {
            ...
            const contactMechanism: EmailAddress = partyContactMechanism.ContactMechanism as EmailAddress;
  ...
  save(event: Event): void {
    ...
    const webAddress: EmailAddress = partyContactMechanism.ContactMechanism as EmailAddress;
