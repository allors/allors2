...
export class EmailCommunication extends SessionObject implements CommunicationEvent {
    ...
    get CurrentVersion(): EmailCommunicationVersion {
        return this.get('CurrentVersion');
    }

    set CurrentVersion(value: EmailCommunicationVersion) {
    ...
    get AllVersions(): EmailCommunicationVersion[] {
        return this.get('AllVersions');
    }

    AddAllVersion(value: EmailCommunicationVersion) {
        return this.add('AllVersions', value);
    }

    RemoveAllVersion(value: EmailCommunicationVersion) {
        return this.remove('AllVersions', value);
    }

    set AllVersions(value: EmailCommunicationVersion[]) {
    ...
    get Originator(): EmailAddress {
        return this.get('Originator');
    }

    set Originator(value: EmailAddress) {
        this.set('Originator', value);
    }

    get CanReadAddressees(): boolean {
        return this.canRead('Addressees');
    }

    get CanWriteAddressees(): boolean {
        return this.canWrite('Addressees');
    }

    get Addressees(): EmailAddress[] {
        return this.get('Addressees');
    }

    AddAddressee(value: EmailAddress) {
        return this.add('Addressees', value);
    }

    RemoveAddressee(value: EmailAddress) {
        return this.remove('Addressees', value);
    }

    set Addressees(value: EmailAddress[]) {
        this.set('Addressees', value);
    }

    get CanReadCarbonCopies(): boolean {
        return this.canRead('CarbonCopies');
    }

    get CanWriteCarbonCopies(): boolean {
        return this.canWrite('CarbonCopies');
    }

    get CarbonCopies(): EmailAddress[] {
        return this.get('CarbonCopies');
    }

    AddCarbonCopy(value: EmailAddress) {
        return this.add('CarbonCopies', value);
    }

    RemoveCarbonCopy(value: EmailAddress) {
        return this.remove('CarbonCopies', value);
    }

    set CarbonCopies(value: EmailAddress[]) {
        this.set('CarbonCopies', value);
    }

    get CanReadBlindCopies(): boolean {
        return this.canRead('BlindCopies');
    }

    get CanWriteBlindCopies(): boolean {
        return this.canWrite('BlindCopies');
    }

    get BlindCopies(): EmailAddress[] {
        return this.get('BlindCopies');
    }

    AddBlindCopy(value: EmailAddress) {
        return this.add('BlindCopies', value);
    }

    RemoveBlindCopy(value: EmailAddress) {
        return this.remove('BlindCopies', value);
    }

    set BlindCopies(value: EmailAddress[]) {
        this.set('BlindCopies', value);
    }

    get CanReadEmailTemplate(): boolean {
        return this.canRead('EmailTemplate');
    }

    get CanWriteEmailTemplate(): boolean {
        return this.canWrite('EmailTemplate');
    }
    ...
    set EmailTemplate(value: EmailTemplate) {
        this.set('EmailTemplate', value);
    }

    get CanReadIncomingMail(): boolean {
        return this.canRead('IncomingMail');
    }

    get CanWriteIncomingMail(): boolean {
        return this.canWrite('IncomingMail');
    }

    get IncomingMail(): boolean {
        return this.get('IncomingMail');
    }

    set IncomingMail(value: boolean) {
        this.set('IncomingMail', value);
    }
