...
export class PhoneCommunication extends SessionObject implements CommunicationEvent {
    ...
    get CurrentVersion(): PhoneCommunicationVersion {
        return this.get('CurrentVersion');
    }

    set CurrentVersion(value: PhoneCommunicationVersion) {
    ...
    get AllVersions(): PhoneCommunicationVersion[] {
        return this.get('AllVersions');
    }

    AddAllVersion(value: PhoneCommunicationVersion) {
        return this.add('AllVersions', value);
    }

    RemoveAllVersion(value: PhoneCommunicationVersion) {
        return this.remove('AllVersions', value);
    }

    set AllVersions(value: PhoneCommunicationVersion[]) {
