...
export class AccountingPeriodVersion extends SessionObject implements BudgetVersion {
    ...
    get Parent(): AccountingPeriod {
        return this.get('Parent');
    }

    set Parent(value: AccountingPeriod) {
    ...
    get CanReadPeriodNumber(): boolean {
        return this.canRead('PeriodNumber');
    }

    get CanWritePeriodNumber(): boolean {
    ...
    get CanReadTimeFrequency(): boolean {
        return this.canRead('TimeFrequency');
    }

    get CanWriteTimeFrequency(): boolean {
        return this.canWrite('TimeFrequency');
    }

    get TimeFrequency(): TimeFrequency {
        return this.get('TimeFrequency');
    }

    set TimeFrequency(value: TimeFrequency) {
