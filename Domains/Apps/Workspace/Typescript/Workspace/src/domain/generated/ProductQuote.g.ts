...
export class ProductQuote extends SessionObject implements Quote {
    ...
    get CurrentVersion(): ProductQuoteVersion {
        return this.get('CurrentVersion');
    }

    set CurrentVersion(value: ProductQuoteVersion) {
    ...
    get AllVersions(): ProductQuoteVersion[] {
        return this.get('AllVersions');
    }

    AddAllVersion(value: ProductQuoteVersion) {
        return this.add('AllVersions', value);
    }

    RemoveAllVersion(value: ProductQuoteVersion) {
        return this.remove('AllVersions', value);
    }

    set AllVersions(value: ProductQuoteVersion[]) {
    ...
    get CanExecuteOrder(): boolean {
        return this.canExecute('Order');
    }

    get Order(): Method {
        return new Method(this, 'Order');
    }
