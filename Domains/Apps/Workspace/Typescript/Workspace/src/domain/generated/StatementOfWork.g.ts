...
export class StatementOfWork extends SessionObject implements Quote {
    ...
    get CurrentVersion(): StatementOfWorkVersion {
        return this.get('CurrentVersion');
    }

    set CurrentVersion(value: StatementOfWorkVersion) {
    ...
    get AllVersions(): StatementOfWorkVersion[] {
        return this.get('AllVersions');
    }

    AddAllVersion(value: StatementOfWorkVersion) {
        return this.add('AllVersions', value);
    }

    RemoveAllVersion(value: StatementOfWorkVersion) {
        return this.remove('AllVersions', value);
    }

    set AllVersions(value: StatementOfWorkVersion[]) {
