...
export class PurchaseReturn extends SessionObject implements Shipment {
    ...
    get CurrentVersion(): PurchaseReturnVersion {
        return this.get('CurrentVersion');
    }

    set CurrentVersion(value: PurchaseReturnVersion) {
    ...
    get AllVersions(): PurchaseReturnVersion[] {
        return this.get('AllVersions');
    }

    AddAllVersion(value: PurchaseReturnVersion) {
        return this.add('AllVersions', value);
    }

    RemoveAllVersion(value: PurchaseReturnVersion) {
        return this.remove('AllVersions', value);
    }

    set AllVersions(value: PurchaseReturnVersion[]) {
