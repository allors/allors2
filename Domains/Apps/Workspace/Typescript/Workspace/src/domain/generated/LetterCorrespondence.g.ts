...
export class LetterCorrespondence extends SessionObject implements CommunicationEvent {
    ...
    get CurrentVersion(): LetterCorrespondenceVersion {
        return this.get('CurrentVersion');
    }

    set CurrentVersion(value: LetterCorrespondenceVersion) {
    ...
    get AllVersions(): LetterCorrespondenceVersion[] {
        return this.get('AllVersions');
    }

    AddAllVersion(value: LetterCorrespondenceVersion) {
        return this.add('AllVersions', value);
    }

    RemoveAllVersion(value: LetterCorrespondenceVersion) {
        return this.remove('AllVersions', value);
    }

    set AllVersions(value: LetterCorrespondenceVersion[]) {
