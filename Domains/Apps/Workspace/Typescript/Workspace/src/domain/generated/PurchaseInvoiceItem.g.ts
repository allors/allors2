...
export class PurchaseInvoiceItem extends SessionObject implements InvoiceItem {
    get CanReadPurchaseInvoiceItemState(): boolean {
        return this.canRead('PurchaseInvoiceItemState');
    }

    get CanWritePurchaseInvoiceItemState(): boolean {
        return this.canWrite('PurchaseInvoiceItemState');
    }

    get PurchaseInvoiceItemState(): PurchaseInvoiceItemState {
        return this.get('PurchaseInvoiceItemState');
    }

    set PurchaseInvoiceItemState(value: PurchaseInvoiceItemState) {
    ...
    get CurrentVersion(): PurchaseInvoiceItemVersion {
        return this.get('CurrentVersion');
    }

    set CurrentVersion(value: PurchaseInvoiceItemVersion) {
    ...
    get AllVersions(): PurchaseInvoiceItemVersion[] {
        return this.get('AllVersions');
    }

    AddAllVersion(value: PurchaseInvoiceItemVersion) {
        return this.add('AllVersions', value);
    }

    RemoveAllVersion(value: PurchaseInvoiceItemVersion) {
        return this.remove('AllVersions', value);
    }

    set AllVersions(value: PurchaseInvoiceItemVersion[]) {
