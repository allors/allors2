...
export class AccountingPeriod extends SessionObject implements Budget {
    ...
    get CurrentVersion(): AccountingPeriodVersion {
        return this.get('CurrentVersion');
    }

    set CurrentVersion(value: AccountingPeriodVersion) {
    ...
    get AllVersions(): AccountingPeriodVersion[] {
        return this.get('AllVersions');
    }

    AddAllVersion(value: AccountingPeriodVersion) {
        return this.add('AllVersions', value);
    }

    RemoveAllVersion(value: AccountingPeriodVersion) {
        return this.remove('AllVersions', value);
    }

    set AllVersions(value: AccountingPeriodVersion[]) {
