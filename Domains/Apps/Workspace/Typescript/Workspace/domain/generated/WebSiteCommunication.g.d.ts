...
export declare class WebSiteCommunication extends SessionObject implements CommunicationEvent {
    ...
    CurrentVersion: WebSiteCommunicationVersion;
    readonly CanReadAllVersions: boolean;
    readonly CanWriteAllVersions: boolean;
    AllVersions: WebSiteCommunicationVersion[];
    AddAllVersion(value: WebSiteCommunicationVersion): void;
    RemoveAllVersion(value: WebSiteCommunicationVersion): void;
