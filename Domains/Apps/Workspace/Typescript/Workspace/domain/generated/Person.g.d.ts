...
export declare class Person extends SessionObject implements User, Party, Deletable {
    ...
    CurrentVersion: PersonVersion;
    readonly CanReadAllVersions: boolean;
    readonly CanWriteAllVersions: boolean;
    AllVersions: PersonVersion[];
    AddAllVersion(value: PersonVersion): void;
    RemoveAllVersion(value: PersonVersion): void;
