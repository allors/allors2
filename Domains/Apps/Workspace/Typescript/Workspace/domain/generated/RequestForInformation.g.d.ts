...
export declare class RequestForInformation extends SessionObject implements Request {
    readonly CanReadCurrentVersion: boolean;
    readonly CanWriteCurrentVersion: boolean;
    CurrentVersion: RequestForInformationVersion;
    readonly CanReadAllVersions: boolean;
    readonly CanWriteAllVersions: boolean;
    AllVersions: RequestForInformationVersion[];
    AddAllVersion(value: RequestForInformationVersion): void;
    RemoveAllVersion(value: RequestForInformationVersion): void;
