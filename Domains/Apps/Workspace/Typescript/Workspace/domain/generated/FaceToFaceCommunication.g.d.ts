...
export declare class FaceToFaceCommunication extends SessionObject implements CommunicationEvent {
    readonly CanReadParticipants: boolean;
    readonly CanWriteParticipants: boolean;
    Participants: Party[];
    AddParticipant(value: Party): void;
    RemoveParticipant(value: Party): void;
    readonly CanReadLocation: boolean;
    readonly CanWriteLocation: boolean;
    Location: string;
    readonly CanReadCurrentVersion: boolean;
    readonly CanWriteCurrentVersion: boolean;
    CurrentVersion: FaceToFaceCommunicationVersion;
    readonly CanReadAllVersions: boolean;
    readonly CanWriteAllVersions: boolean;
    AllVersions: FaceToFaceCommunicationVersion[];
    AddAllVersion(value: FaceToFaceCommunicationVersion): void;
    RemoveAllVersion(value: FaceToFaceCommunicationVersion): void;
