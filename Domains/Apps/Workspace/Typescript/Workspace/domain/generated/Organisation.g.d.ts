...
export declare class Organisation extends SessionObject implements Party, Deletable {
    readonly CanReadCurrentVersion: boolean;
    readonly CanWriteCurrentVersion: boolean;
    CurrentVersion: OrganisationVersion;
    readonly CanReadAllVersions: boolean;
    readonly CanWriteAllVersions: boolean;
    AllVersions: OrganisationVersion[];
    AddAllVersion(value: OrganisationVersion): void;
    RemoveAllVersion(value: OrganisationVersion): void;
