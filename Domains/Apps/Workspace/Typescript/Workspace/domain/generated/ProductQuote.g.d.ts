...
export declare class ProductQuote extends SessionObject implements Quote {
    readonly CanReadCurrentVersion: boolean;
    readonly CanWriteCurrentVersion: boolean;
    CurrentVersion: ProductQuoteVersion;
    readonly CanReadAllVersions: boolean;
    readonly CanWriteAllVersions: boolean;
    AllVersions: ProductQuoteVersion[];
    AddAllVersion(value: ProductQuoteVersion): void;
    RemoveAllVersion(value: ProductQuoteVersion): void;
    ...
    Comment: string;
    readonly CanExecuteOrder: boolean;
    readonly Order: Method;
