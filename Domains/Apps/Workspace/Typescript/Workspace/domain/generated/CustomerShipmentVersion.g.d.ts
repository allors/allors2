...
export declare class CustomerShipmentVersion extends SessionObject implements ShipmentVersion {
    ...
    readonly CanReadReleasedManually: boolean;
    readonly CanWriteReleasedManually: boolean;
    ReleasedManually: boolean;
    readonly CanReadPaymentMethod: boolean;
    readonly CanWritePaymentMethod: boolean;
    PaymentMethod: PaymentMethod;
    readonly CanReadWithoutCharges: boolean;
    readonly CanWriteWithoutCharges: boolean;
    WithoutCharges: boolean;
    readonly CanReadHeldManually: boolean;
    readonly CanWriteHeldManually: boolean;
    HeldManually: boolean;
    readonly CanReadShipmentValue: boolean;
