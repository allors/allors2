...
export declare class StatementOfWork extends SessionObject implements Quote {
    readonly CanReadCurrentVersion: boolean;
    readonly CanWriteCurrentVersion: boolean;
    CurrentVersion: StatementOfWorkVersion;
    readonly CanReadAllVersions: boolean;
    readonly CanWriteAllVersions: boolean;
    AllVersions: StatementOfWorkVersion[];
    AddAllVersion(value: StatementOfWorkVersion): void;
    RemoveAllVersion(value: StatementOfWorkVersion): void;
