...
export class RequestForProposal extends SessionObject implements Request {
    ...
    get CurrentVersion(): RequestForProposalVersion {
        return this.get('CurrentVersion');
    }

    set CurrentVersion(value: RequestForProposalVersion) {
    ...
    get AllVersions(): RequestForProposalVersion[] {
        return this.get('AllVersions');
    }

    AddAllVersion(value: RequestForProposalVersion) {
        return this.add('AllVersions', value);
    }

    RemoveAllVersion(value: RequestForProposalVersion) {
        return this.remove('AllVersions', value);
    }

    set AllVersions(value: RequestForProposalVersion[]) {
