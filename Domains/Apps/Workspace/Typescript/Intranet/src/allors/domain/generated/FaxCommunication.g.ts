...
export class FaxCommunication extends SessionObject implements CommunicationEvent {
    ...
    get CanReadOutgoingFaxNumber(): boolean {
        return this.canRead('OutgoingFaxNumber');
    }

    get CanWriteOutgoingFaxNumber(): boolean {
        return this.canWrite('OutgoingFaxNumber');
    }

    get OutgoingFaxNumber(): TelecommunicationsNumber {
        return this.get('OutgoingFaxNumber');
    }

    set OutgoingFaxNumber(value: TelecommunicationsNumber) {
        this.set('OutgoingFaxNumber', value);
    }
    ...
    get CurrentVersion(): FaxCommunicationVersion {
        return this.get('CurrentVersion');
    }

    set CurrentVersion(value: FaxCommunicationVersion) {
    ...
    get AllVersions(): FaxCommunicationVersion[] {
        return this.get('AllVersions');
    }

    AddAllVersion(value: FaxCommunicationVersion) {
        return this.add('AllVersions', value);
    }

    RemoveAllVersion(value: FaxCommunicationVersion) {
        return this.remove('AllVersions', value);
    }

    set AllVersions(value: FaxCommunicationVersion[]) {
