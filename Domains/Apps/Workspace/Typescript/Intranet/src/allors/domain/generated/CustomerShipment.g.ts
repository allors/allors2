...
export class CustomerShipment extends SessionObject implements Shipment {
    ...
    get CurrentVersion(): CustomerShipmentVersion {
        return this.get('CurrentVersion');
    }

    set CurrentVersion(value: CustomerShipmentVersion) {
    ...
    get AllVersions(): CustomerShipmentVersion[] {
        return this.get('AllVersions');
    }

    AddAllVersion(value: CustomerShipmentVersion) {
        return this.add('AllVersions', value);
    }

    RemoveAllVersion(value: CustomerShipmentVersion) {
        return this.remove('AllVersions', value);
    }

    set AllVersions(value: CustomerShipmentVersion[]) {
