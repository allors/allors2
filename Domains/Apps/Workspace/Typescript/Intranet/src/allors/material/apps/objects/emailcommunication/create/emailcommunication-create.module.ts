...
import { EmailCommunicationCreateComponent } from './emailcommunication-create.component';
export { EmailCommunicationCreateComponent } from './emailcommunication-create.component';
...
export class EmailCommunicationCreateModule { }
