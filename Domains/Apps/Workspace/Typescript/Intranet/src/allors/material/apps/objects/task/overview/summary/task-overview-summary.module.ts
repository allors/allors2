...
import { TaskOverviewSummaryComponent } from './task-overview-summary.component';
export { TaskOverviewSummaryComponent } from './task-overview-summary.component';

@NgModule({
  declarations: [
    TaskOverviewSummaryComponent,
  ],
  exports: [
    TaskOverviewSummaryComponent,
  ],
