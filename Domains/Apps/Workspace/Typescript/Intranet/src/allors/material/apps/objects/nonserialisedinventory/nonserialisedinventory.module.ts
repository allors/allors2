...
import { AllorsMaterialTableModule } from '../../../../material';

import { NonSerialisedInventoryComponent } from './nonserialisedinventory.component';
export { NonSerialisedInventoryComponent } from './nonserialisedinventory.component';

@NgModule({
  declarations: [
    NonSerialisedInventoryComponent,
  ],
  exports: [
    NonSerialisedInventoryComponent,
  ],
...
export class NonSerialisedInventoryComponentInventoryModule { }
