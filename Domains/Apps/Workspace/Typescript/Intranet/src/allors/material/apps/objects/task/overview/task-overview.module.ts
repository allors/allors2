...
import { PersonOverviewSummaryModule } from './summary/task-overview-summary.module';
import { PersonOverviewDetailModule } from './detail/task-overview-detail.module';

import { TaskOverviewComponent } from './task-overview.component';
export { TaskOverviewComponent } from './task-overview.component';
