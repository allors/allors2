...
import { NonSerialisedInventoryComponent } from './nonserialisedinventoryitem-embed.component';
export { NonSerialisedInventoryComponent } from './nonserialisedinventoryitem-embed.component';
...
export class NonSerialisedInventoryEmbedModule { }
