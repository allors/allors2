...
import { EditFaceToFaceCommunicationComponent } from './facetofacecommunication-edit.component';
export { EditFaceToFaceCommunicationComponent } from './facetofacecommunication-edit.component';

@NgModule({
  declarations: [
    EditFaceToFaceCommunicationComponent,
  ],
  exports: [
    EditFaceToFaceCommunicationComponent,
  ],
...
export class FaceToFaceCommunicationModule { }
