...
import { PartyRateEditComponent } from './partyrate-edit.component';
export { PartyRateEditComponent } from './partyrate-edit.component';
...
export class PartyRateEditModule { }
