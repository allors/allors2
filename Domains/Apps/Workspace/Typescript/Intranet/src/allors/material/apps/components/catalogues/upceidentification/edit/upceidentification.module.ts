...
import { EditUpceIdentificationComponent } from './upceidentification-edit.component';
export { EditUpceIdentificationComponent } from './upceidentification-edit.component';

@NgModule({
  declarations: [
    EditUpceIdentificationComponent,
  ],
  exports: [
    EditUpceIdentificationComponent,
  ],
...
export class UpceIdentificationModule { }
