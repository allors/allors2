...
import { FaceToFaceCommunicationOverviewDetailComponent } from './facetofacecommunication-overview-detail.component';
export { FaceToFaceCommunicationOverviewDetailComponent } from './facetofacecommunication-overview-detail.component';

@NgModule({
  declarations: [
    FaceToFaceCommunicationOverviewDetailComponent,
  ],
  exports: [
    FaceToFaceCommunicationOverviewDetailComponent,
  ],
...
export class FaceToFaceCommunicationOverviewDetailModule { }
