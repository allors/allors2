...
import { LetterCorrespondenceEditComponent } from './lettercorrespondence-edit.component';
export { LetterCorrespondenceEditComponent } from './lettercorrespondence-edit.component';
...
export class LetterCorrespondenceEditModule { }
