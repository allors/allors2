...
import { EditUpcaIdentificationComponent } from './upcaidentification-edit.component';
export { EditUpcaIdentificationComponent } from './upcaidentification-edit.component';

@NgModule({
  declarations: [
    EditUpcaIdentificationComponent,
  ],
  exports: [
    EditUpcaIdentificationComponent,
  ],
...
export class UpcaIdentificationModule { }
