...
import { EditManufacturerIdentificationComponent } from './manufactureridentification-edit.component';
export { EditManufacturerIdentificationComponent } from './manufactureridentification-edit.component';

@NgModule({
  declarations: [
    EditManufacturerIdentificationComponent,
  ],
  exports: [
    EditManufacturerIdentificationComponent,
  ],
...
export class ManufacturerIdentificationModule { }
