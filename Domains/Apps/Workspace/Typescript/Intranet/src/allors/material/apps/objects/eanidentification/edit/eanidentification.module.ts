...
import { EditEanIdentificationComponent } from './eanidentification-edit.component';
export { EditEanIdentificationComponent } from './eanidentification-edit.component';

@NgModule({
  declarations: [
    EditEanIdentificationComponent,
  ],
  exports: [
    EditEanIdentificationComponent,
  ],
...
export class EanIdentificationModule { }
