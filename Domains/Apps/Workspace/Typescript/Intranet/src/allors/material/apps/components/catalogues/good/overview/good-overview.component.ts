...
import { ContactMechanism, InternalOrganisation, Organisation, PartyContactMechanism, Good, GoodIdentification } from '../../../../../../domain';
...
export class GoodOverviewComponent implements OnInit, OnDestroy {
  ...
  public deleteGoodIdentification(goodIdentification: GoodIdentification): void {
