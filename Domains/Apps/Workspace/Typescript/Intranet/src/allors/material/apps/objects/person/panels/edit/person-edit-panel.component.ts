...
import { ErrorService, Saved, SessionService, NavigationService, AllorsPanelService } from '../../../../../../angular';
...
@Component({
  ...
  selector: 'person-edit-panel',
  templateUrl: './person-edit-panel.component.html',
  providers: [AllorsPanelService, SessionService]
})
export class PersonEditPanelComponent implements OnInit, OnDestroy {
