...
import { EditSkuIdentificationComponent } from './skuidentification-edit.component';
export { EditSkuIdentificationComponent } from './skuidentification-edit.component';

@NgModule({
  declarations: [
    EditSkuIdentificationComponent,
  ],
  exports: [
    EditSkuIdentificationComponent,
  ],
...
export class SkuIdentificationModule { }
