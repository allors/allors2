...
import { EmailAddress, Enumeration, Organisation, PartyContactMechanism } from "@allors";
import { AllorsService, ErrorService, Loaded, Saved, Scope } from "@allors";

@Component({
  templateUrl: "./form.component.html",
})
export class PartyContactMechanismEditEmailAddressComponent implements OnInit, AfterViewInit, OnDestroy {
