...
import { PersonInlineModule } from "./apps/relations/person/person-inline.module";
...
import { WorkTaskInlineModule } from "./apps/workefforts/worktask/worktask-inline.module";
