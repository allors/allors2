...
import { Brand, Catalogue, CatScope, ContactMechanism, Currency, Enumeration, Facility, Good, InventoryItemKind,
  ...
  SalesOrder, SalesOrderItem, Singleton, TelecommunicationsNumber, VarianceReason, VatRate, VatRegime, CommunicationEvent, WorkEffortAssignment, WorkEffort } from "../../../../domain";
