...
import { MetaDomain, SalesOrder, SalesInvoice, Good, SalesInvoiceItem, PartyContactMechanism, WebAddress, Enumeration, ContactMechanismPurpose, Person } from "@allors/workspace";
