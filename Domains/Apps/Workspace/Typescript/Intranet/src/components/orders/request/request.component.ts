...
import { ContactMechanism, MetaDomain, SalesOrder, SalesInvoice, Good, SalesInvoiceItem, RequestForQuote, ProductQuote, QuoteItem, Person, Organisation, Currency, Party, OrganisationRole, OrganisationContactRelationship, PartyContactMechanism } from "@allors/workspace";
import { Scope, WorkspaceService, Saved, ErrorService, Loaded, Invoked, Filter } from "@allors/base-angular";
import { Fetch, TreeNode, Path, Query, PullRequest, And, Predicate, Like, ContainedIn, Page, Sort, Contains } from "@allors/framework";
