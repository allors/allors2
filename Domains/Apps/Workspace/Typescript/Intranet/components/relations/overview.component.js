...
let OverviewComponent = class OverviewComponent {
    constructor(media, changeDetectorRef, activatedRoute, menu) {
        this.media = media;
...
`,
    ...
    __metadata("design:paramtypes", [core_2.TdMediaService, core_1.ChangeDetectorRef, router_1.ActivatedRoute, base_angular_1.MenuService])
], OverviewComponent);
