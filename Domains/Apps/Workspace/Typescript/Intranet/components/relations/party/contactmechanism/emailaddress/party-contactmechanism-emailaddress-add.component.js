...
let PartyContactMechanismEmailAddressAddComponent = class PartyContactMechanismEmailAddressAddComponent {
    constructor(workspaceService, errorService, route, media, changeDetectorRef) {
        ...
        this.subTitle = "add email address";
    ...
    ngOnInit() {
        this.subscription = this.route.url
            ...
            if (!this.contactMechanism) {
                this.contactMechanism = this.scope.session.create("EmailAddress");
            }
...
PartyContactMechanismEmailAddressAddComponent = __decorate([
    core_1.Component({
...
exports.PartyContactMechanismEmailAddressAddComponent = PartyContactMechanismEmailAddressAddComponent;
