...
let PartyContactMechanismPostalAddressAddComponent = class PartyContactMechanismPostalAddressAddComponent {
    constructor(workspaceService, errorService, route, media, changeDetectorRef) {
        ...
        this.subTitle = "add postal address";
    ...
    ngOnInit() {
        this.subscription = this.route.url
            ...
            if (!this.contactMechanism) {
                this.contactMechanism = this.scope.session.create("PostalAddress");
...
exports.PartyContactMechanismPostalAddressAddComponent = PartyContactMechanismPostalAddressAddComponent;
