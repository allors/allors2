...
import { MetaDomain, PartyContactMechanism, Enumeration, Party, EmailAddress } from "@allors/workspace";
import { WorkspaceService, ErrorService } from "@allors/base-angular";
export declare class PartyContactMechanismEmailAddressAddComponent implements OnInit, AfterViewInit, OnDestroy {
