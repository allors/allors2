...
let PartyContactMechanismEditWebAddressComponent = class PartyContactMechanismEditWebAddressComponent {
    constructor(workspaceService, errorService, route, media, changeDetectorRef) {
        ...
        this.subTitle = "edit web address";
...
PartyContactMechanismEditWebAddressComponent = __decorate([
    core_1.Component({
...
exports.PartyContactMechanismEditWebAddressComponent = PartyContactMechanismEditWebAddressComponent;
