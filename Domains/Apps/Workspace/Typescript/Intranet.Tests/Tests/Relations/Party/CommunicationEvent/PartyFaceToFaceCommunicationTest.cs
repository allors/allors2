namespace Intranet.Tests.RelationsPartyCommunicationEvent
{
    ...
    public class PartyFaceToFaceCommunicationTest : Test
    {
        private readonly Sidenav sideNav;

        public PartyFaceToFaceCommunicationTest(TestFixture fixture)
            : base(fixture)
        {
        ...
        public void Title()
        {
            ...
            var email = (FaceToFaceCommunication)person.CommunicationEventsWhereInvolvedParty.First(v => v is FaceToFaceCommunication);
        ...
        public void Edit()
        {
            ...
            var page = new PartyFaceToFaceCommunicationPage(this.Driver);
