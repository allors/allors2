...
import {
  CommunicationEventPurpose, ContactMechanism, LetterCorrespondence, Organisation, OrganisationContactRelationship,
  Party, PartyContactMechanism, Person, PostalAddress, Singleton,
} from "@allors";
