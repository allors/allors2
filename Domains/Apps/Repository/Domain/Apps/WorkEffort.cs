namespace Allors.Repository
{
    ...
    #endregion
    public partial interface WorkEffort : AccessControlledObject, Transitional, UniquelyIdentifiable, Deletable, Auditable 
    {
        #region Allors
        ...
        [Derived]
        [Indexed]
        WorkEffortStatus CurrentWorkEffortStatus { get; set; }
        ...
        [Derived]
        [Indexed]
        WorkEffortStatus[] WorkEffortStatuses { get; set; }
