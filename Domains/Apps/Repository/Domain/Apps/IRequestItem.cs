namespace Allors.Repository
{
    ...
    #region Allors
    [Id("8045703A-1A3A-48F6-BFE4-808FB3A264C8")]
    #endregion
    public partial interface IRequestItem : Object
    {
        #region Allors
        ...
        [Indexed]
        [Workspace]
        Requirement[] Requirements { get; set; }
        ...
        [Indexed]
        [Workspace]
        NeededSkill NeededSkill { get; set; }
        ...
        [Scale(2)]
        [Workspace]
        decimal MaximumAllowedPrice { get; set; }
        ...
        [Required]
        [Workspace]
        RequestItemObjectState CurrentObjectState { get; set; }
    }
}