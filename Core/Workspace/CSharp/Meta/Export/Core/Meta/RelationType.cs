    ...
    public sealed partial class RelationType : DomainObject, IRelationType, IComparable
    {
        ...
        public bool ExistExclusiveClasses
        {
            get
            {
                ...
                {
                    return ((Composite)this.AssociationType.ObjectType).ExistExclusiveClass && this.RoleType.ObjectType is Composite roleCompositeType && roleCompositeType.ExistExclusiveClass;
                }
