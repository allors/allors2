...
namespace ExcelAddIn
{
    ...
    {   
        ...
        private async void ThisAddIn_Startup(object sender, System.EventArgs e) => AsyncContext.Run(async () =>
        {
        ...
        private async void ThisAddIn_Shutdown(object sender, System.EventArgs e) => AsyncContext.Run(async () =>
        {
