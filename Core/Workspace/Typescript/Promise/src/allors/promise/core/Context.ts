import { InvokeResponse, ISession, ISessionObject, Method, PullResponse, PushRequest, PushRequestObject, PushResponse, Session, SyncRequest, SyncResponse, Workspace, Pull, PullRequest } from '../../framework';
...
export class Context {
    ...
    public invoke(methodOrService: Method | string, args?: any): Promise<Invoked> {
        return this.database.invoke(methodOrService as any, args).then((invokeResponse: InvokeResponse) => new Invoked(this.session, invokeResponse));
    }
}
