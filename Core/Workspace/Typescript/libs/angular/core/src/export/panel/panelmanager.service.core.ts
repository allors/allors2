...
import { Context, PanelService, PanelManagerService, DatabaseService, WorkspaceService, Loaded } from '@allors/angular/services/core';

@Injectable()
export class PanelManagerServiceCore extends PanelManagerService {
  context: Context;
