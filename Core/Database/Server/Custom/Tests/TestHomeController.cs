// <copyright file="TestHomeController.cs" company="PlaceholderCompany">
...
namespace Allors.Server.Controllers
{
    ...
    {
        public TestHomeController(ISessionService sessionService) => this.Session = sessionService.Session;
