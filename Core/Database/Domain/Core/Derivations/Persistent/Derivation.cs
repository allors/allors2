// <copyright file="Derivation.cs" company="Allors bv">
    ...
    public class Derivation : IDerivation
    {
        ...
        public IValidation Derive()
        {
            ...
            try
            {
                ...
                this.Cycles = this.Cycles.Append(this.Cycle).ToArray();
