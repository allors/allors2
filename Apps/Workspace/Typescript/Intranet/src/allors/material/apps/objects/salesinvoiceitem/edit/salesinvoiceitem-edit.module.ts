...
import { SalesInvoiceItemEditComponent } from './salesinvoiceitem-edit.component';
export { SalesInvoiceItemEditComponent } from './salesinvoiceitem-edit.component';
...
export class SalesInvoiceItemEditModule { }
