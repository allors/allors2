...
import { EmailAddressCreateComponent } from './emailaddress-create.component';
export { EmailAddressCreateComponent } from './emailaddress-create.component';
...
export class EmailAddressCreateModule { }
