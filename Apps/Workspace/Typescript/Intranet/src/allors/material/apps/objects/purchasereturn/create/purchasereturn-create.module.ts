...
import { PurchaseReturnCreateComponent } from './purchasereturn-create.component';
export { PurchaseReturnCreateComponent } from './purchasereturn-create.component';
...
export class PurchaseReturnCreateModule { }
