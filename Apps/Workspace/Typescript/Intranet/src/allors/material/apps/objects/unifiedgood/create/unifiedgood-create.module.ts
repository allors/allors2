...
import { UnifiedGoodCreateComponent } from './unifiedgood-create.component';
export { UnifiedGoodCreateComponent } from './unifiedgood-create.component';
...
export class UnifiedGoodCreateModule { }
