...
import { PurchaseInvoiceApprovalEditComponent } from './purchaseinvoiceapproval-edit.component';
export { PurchaseInvoiceApprovalEditComponent } from './purchaseinvoiceapproval-edit.component';
...
export class PurchaseInvoiceApprovalEditModule { }
