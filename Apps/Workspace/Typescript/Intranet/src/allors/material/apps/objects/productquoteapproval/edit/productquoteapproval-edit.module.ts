...
import { ProductQuoteApprovalEditComponent } from './productquoteapproval-edit.component';
export { ProductQuoteApprovalEditComponent } from './productquoteapproval-edit.component';
...
export class ProductQuoteApprovalEditModule { }
