...
import { UnifiedGoodOverviewSummaryComponent } from './unifiedgood-overview-summary.component';
export { UnifiedGoodOverviewSummaryComponent } from './unifiedgood-overview-summary.component';
...
export class UnifiedGoodOverviewSummaryModule { }
