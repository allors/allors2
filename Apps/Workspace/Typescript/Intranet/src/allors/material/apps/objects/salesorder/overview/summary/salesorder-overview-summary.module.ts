...
import { SalesOrderOverviewSummaryComponent } from './salesorder-overview-summary.component';
export { SalesOrderOverviewSummaryComponent } from './salesorder-overview-summary.component';
...
export class SalesOrderOverviewSummaryModule { }
