...
import { FacilityInlineComponent } from './facility-inline.component';
export { FacilityInlineComponent } from './facility-inline.component';
...
export class FacilityInlineModule { }
