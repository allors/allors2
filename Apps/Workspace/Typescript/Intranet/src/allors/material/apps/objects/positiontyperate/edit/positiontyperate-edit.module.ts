...
import { PositionTypeRateEditComponent } from './positiontyperate-edit.component';
export { PositionTypeRateEditComponent } from './positiontyperate-edit.component';
...
export class PositionTypeRateEditModule { }
