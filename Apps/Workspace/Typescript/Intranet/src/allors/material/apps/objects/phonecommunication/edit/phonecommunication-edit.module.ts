...
import { PhoneCommunicationEditComponent } from './phonecommunication-edit.component';
export { PhoneCommunicationEditComponent } from './phonecommunication-edit.component';
...
export class PhoneCommunicationEditModule { }
