...
namespace Allors.Domain
{
    ...
    public partial class AssetAssignmentStatuses
    {
        ...
        public AssetAssignmentStatus Requested => this.Cache.Get(RequestedId);

        public AssetAssignmentStatus Assigned => this.Cache.Get(AssignedId);

        private UniquelyIdentifiableCache<AssetAssignmentStatus> Cache => this.cache ?? (this.cache = new UniquelyIdentifiableCache<AssetAssignmentStatus>(this.Session));
