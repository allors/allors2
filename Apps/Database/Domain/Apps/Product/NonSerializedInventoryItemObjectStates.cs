...
namespace Allors.Domain
{
    ...
    public partial class NonSerializedInventoryItemObjectStates
    {
        ...
        public NonSerializedInventoryItemObjectState Good => this.StateCache.Get(GoodId);

        public NonSerializedInventoryItemObjectState BeingRepared => this.StateCache.Get(BeingReparedId);

        public NonSerializedInventoryItemObjectState SlightlyDamaged => this.StateCache.Get(SlightlyDamagedId);

        public NonSerializedInventoryItemObjectState Defective => this.StateCache.Get(DefectiveId);

        public NonSerializedInventoryItemObjectState Scrap => this.StateCache.Get(ScrapId);

        private UniquelyIdentifiableCache<NonSerializedInventoryItemObjectState> StateCache => this.stateCache ?? (this.stateCache = new UniquelyIdentifiableCache<NonSerializedInventoryItemObjectState>(this.Session));
        ...
        protected override void AppsSetup(Setup setup)
        {
            ...
            new NonSerializedInventoryItemObjectStateBuilder(this.Session)
                .WithUniqueId(GoodId)
                .WithName("Good")
                .Build();
